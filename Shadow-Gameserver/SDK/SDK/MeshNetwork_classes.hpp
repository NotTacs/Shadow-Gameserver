...
public:
	...
	bool                                          bConnectedToRoot;                                  // 0x02E8(0x0001)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2E9[0x7];                                      // 0x02E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDateTime                              MeshPingTime;                                      // 0x02F0(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class FString>                         ParentIds;                                         // 0x02F8(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMeshBeaconClient) == 0x000318, "Wrong size on AMeshBeaconClient");
static_assert(offsetof(AMeshBeaconClient, bConnectedToRoot) == 0x0002E8, "Member 'AMeshBeaconClient::bConnectedToRoot' has a wrong offset!");
static_assert(offsetof(AMeshBeaconClient, MeshPingTime) == 0x0002F0, "Member 'AMeshBeaconClient::MeshPingTime' has a wrong offset!");
static_assert(offsetof(AMeshBeaconClient, ParentIds) == 0x0002F8, "Member 'AMeshBeaconClient::ParentIds' has a wrong offset!");
...
static_assert(sizeof(AMeshBeaconHostObject) == 0x000258, "Wrong size on AMeshBeaconHostObject");
...
static_assert(sizeof(UMeshConnection) == 0x001A90, "Wrong size on UMeshConnection");
...
public:
	...
	TSet<class FName>                             NoAggregationFunctions;                            // 0x0108(0x0050)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FNoAggregationParameters> NoAggregationParameters;                           // 0x0158(0x0050)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FString, struct FAggregatedFunction> AggregatedFunctions;                               // 0x01A8(0x0050)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
{
public:
	FMulticastInlineDelegateProperty_             OnMeshNodeTypeChanged;                             // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnConnectedToRootChanged;                          // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnGameServerNodeTypeChanged;                       // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMeshMetaDataUpdated;                             // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMeshPlayerRequested;                             // 0x0070(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
