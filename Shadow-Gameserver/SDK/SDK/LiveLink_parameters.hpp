...
public:
	...
	struct FLiveLinkBasicBlueprintData            BasicBlueprintData;                                // 0x0018(0x0098)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(LiveLinkBlueprintLibrary_GetBasicData) == 0x0000B0, "Wrong size on LiveLinkBlueprintLibrary_GetBasicData");
...
static_assert(offsetof(LiveLinkBlueprintLibrary_GetLiveLinkSubjects, bIncludeDisal) == 0x000001, "Member 'LiveLinkBlueprintLibrary_GetLiveLinkSubjects::bIncludeDisal' has a wrong offset!");
...
{
public:
	struct FLiveLinkBasicBlueprintData            BasicData;                                         // 0x0000(0x0098)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
static_assert(offsetof(LiveLinkBlueprintLibrary_GetPropertyValue, PropertyName) == 0x000098, "Member 'LiveLinkBlueprintLibrary_GetPropertyValue::PropertyName' has a wrong offset!");
static_assert(offsetof(LiveLinkBlueprintLibrary_GetPropertyValue, Value) == 0x0000A0, "Member 'LiveLinkBlueprintLibrary_GetPropertyValue::Value' has a wrong offset!");
static_assert(offsetof(LiveLinkBlueprintLibrary_GetPropertyValue, ReturnValue) == 0x0000A4, "Member 'LiveLinkBlueprintLibrary_GetPropertyValue::ReturnValue' has a wrong offset!");
