...
static_assert(sizeof(UMovieSceneLiveLinkSection) == 0x000220, "Wrong size on UMovieSceneLiveLinkSection");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectPreset) == 0x0000E0, "Member 'UMovieSceneLiveLinkSection::SubjectPreset' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, ChannelMask) == 0x000118, "Member 'UMovieSceneLiveLinkSection::ChannelMask' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubSections) == 0x000128, "Member 'UMovieSceneLiveLinkSection::SubSections' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectName) == 0x000148, "Member 'UMovieSceneLiveLinkSection::SubjectName' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, TemplateToPush) == 0x000150, "Member 'UMovieSceneLiveLinkSection::TemplateToPush' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, RefSkeleton) == 0x0001E0, "Member 'UMovieSceneLiveLinkSection::RefSkeleton' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, CurveNames) == 0x000200, "Member 'UMovieSceneLiveLinkSection::CurveNames' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, PropertyFloatChannels) == 0x000210, "Member 'UMovieSceneLiveLinkSection::PropertyFloatChannels' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLiveLinkTrack) == 0x000090, "Wrong size on UMovieSceneLiveLinkTrack");
static_assert(offsetof(UMovieSceneLiveLinkTrack, TrackRole) == 0x000088, "Member 'UMovieSceneLiveLinkTrack::TrackRole' has a wrong offset!");
