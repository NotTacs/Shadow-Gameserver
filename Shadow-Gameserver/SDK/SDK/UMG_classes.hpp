...
public:
	...
	uint8                                         Pad_144[0x14];                                     // 0x0144(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UTextBlock, TextTransformPolicy) == 0x00028E, "Member 'UTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(UTextBlock, bSimpleTextMode) == 0x00028F, "Member 'UTextBlock::bSimpleTextMode' has a wrong offset!");
...
static_assert(offsetof(UMenuAnchor, bFitInWindow) == 0x000139, "Member 'UMenuAnchor::bFitInWindow' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, ShouldDeferPaintingAfterWindowContent) == 0x00013A, "Member 'UMenuAnchor::ShouldDeferPaintingAfterWindowContent' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, UseApplicationMenuStack) == 0x00013B, "Member 'UMenuAnchor::UseApplicationMenuStack' has a wrong offset!");
...
static_assert(sizeof(UMovieScene2DTransformTrack) == 0x000088, "Wrong size on UMovieScene2DTransformTrack");
...
public:
	...
	uint8                                         Pad_3CD[0x26B];                                    // 0x03CD(0x026B)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URichTextBlock) == 0x000668, "Wrong size on URichTextBlock");
...
static_assert(offsetof(URichTextBlock, MinDesiredWidth) == 0x0003C8, "Member 'URichTextBlock::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(URichTextBlock, TextTransformPolicy) == 0x0003CC, "Member 'URichTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(URichTextBlock, InstanceDecorators) == 0x000638, "Member 'URichTextBlock::InstanceDecorators' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_DA8[0x50];                                     // 0x0DA8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UComboBoxString) == 0x000DF8, "Wrong size on UComboBoxString");
...
static_assert(offsetof(UComboBoxString, ForegroundColor) == 0x000D48, "Member 'UComboBoxString::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxString, bIsFocusable) == 0x000D70, "Member 'UComboBoxString::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnGenerateWidgetEvent) == 0x000D74, "Member 'UComboBoxString::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnSelectionChanged) == 0x000D88, "Member 'UComboBoxString::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnOpening) == 0x000D98, "Member 'UComboBoxString::OnOpening' has a wrong offset!");
...
static_assert(offsetof(UEditableText, VirtualKeyboardTrigger) == 0x000418, "Member 'UEditableText::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableText, VirtualKeyboardDismissAction) == 0x000419, "Member 'UEditableText::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableText, Justification) == 0x00041A, "Member 'UEditableText::Justification' has a wrong offset!");
static_assert(offsetof(UEditableText, ShapedTextOptions) == 0x00041B, "Member 'UEditableText::ShapedTextOptions' has a wrong offset!");
...
static_assert(offsetof(UEditableTextBox, VirtualKeyboardTrigger) == 0x0009F0, "Member 'UEditableTextBox::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardDismissAction) == 0x0009F1, "Member 'UEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Justification) == 0x0009F2, "Member 'UEditableTextBox::Justification' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x0009F3, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMarginTrack) == 0x000088, "Wrong size on UMovieSceneMarginTrack");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnValueChanged;                                    // 0x04A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueCommitted;                                  // 0x04B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBeginSliderMovement;                             // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEndSliderMovement;                               // 0x04D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_410[0x380];                                    // 0x0410(0x0380)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUMGSequencePlayer) == 0x000790, "Wrong size on UUMGSequencePlayer");
static_assert(offsetof(UUMGSequencePlayer, Animation) == 0x000408, "Member 'UUMGSequencePlayer::Animation' has a wrong offset!");
...
{
public:
	class UWidgetTree*                            WidgetTree;                                        // 0x0340(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bAllowTemplate : 1;                                // 0x0348(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowDynamicCreation : 1;                         // 0x0348(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bValidTemplate : 1;                                // 0x0348(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bTemplateInitialized : 1;                          // 0x0348(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bCookedTemplate : 1;                               // 0x0348(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bClassRequiresNativeTick : 1;                      // 0x0348(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_349[0x7];                                      // 0x0349(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDelegateRuntimeBinding>        Bindings;                                          // 0x0350(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UWidgetAnimation*>               Animations;                                        // 0x0360(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           NamedSlots;                                        // 0x0370(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UUserWidget>             TemplateAsset;                                     // 0x0380(0x0028)(ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UWidgetBlueprintGeneratedClass) == 0x0003B0, "Wrong size on UWidgetBlueprintGeneratedClass");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, WidgetTree) == 0x000340, "Member 'UWidgetBlueprintGeneratedClass::WidgetTree' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Bindings) == 0x000350, "Member 'UWidgetBlueprintGeneratedClass::Bindings' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Animations) == 0x000360, "Member 'UWidgetBlueprintGeneratedClass::Animations' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, NamedSlots) == 0x000370, "Member 'UWidgetBlueprintGeneratedClass::NamedSlots' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, TemplateAsset) == 0x000380, "Member 'UWidgetBlueprintGeneratedClass::TemplateAsset' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Template) == 0x0003A8, "Member 'UWidgetBlueprintGeneratedClass::Template' has a wrong offset!");
...
{
public:
	EWidgetSpace                                  Space;                                             // 0x0410(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWidgetTimingPolicy                           TimingPolicy;                                      // 0x0411(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_412[0x6];                                      // 0x0412(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UUserWidget>                WidgetClass;                                       // 0x0418(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FIntPoint                              DrawSize;                                          // 0x0420(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bManuallyRedraw;                                   // 0x0428(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRedrawRequested;                                  // 0x0429(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_42A[0x2];                                      // 0x042A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RedrawTime;                                        // 0x042C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_430[0x8];                                      // 0x0430(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntPoint                              CurrentDrawSize;                                   // 0x0438(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawAtDesiredSize;                                // 0x0440(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_441[0x3];                                      // 0x0441(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Pivot;                                             // 0x0444(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bReceiveHardwareInput;                             // 0x044C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bWindowFocusable;                                  // 0x044D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWindowVisibility                             WindowVisibility;                                  // 0x044E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bApplyGammaCorrection;                             // 0x044F(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULocalPlayer*                           OwnerPlayer;                                       // 0x0450(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           BackgroundColor;                                   // 0x0458(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           TintColorAndOpacity;                               // 0x0468(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         OpacityFromTexture;                                // 0x0478(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWidgetBlendMode                              BlendMode;                                         // 0x047C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsTwoSided;                                       // 0x047D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          TickWhenOffscreen;                                 // 0x047E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_47F[0x1];                                      // 0x047F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class UUserWidget*                            Widget;                                            // 0x0480(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_488[0x20];                                     // 0x0488(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class UBodySetup*                             BodySetup;                                         // 0x04A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     TranslucentMaterial;                               // 0x04B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     TranslucentMaterial_OneSided;                      // 0x04B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     OpaqueMaterial;                                    // 0x04C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     OpaqueMaterial_OneSided;                           // 0x04C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     MaskedMaterial;                                    // 0x04D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     MaskedMaterial_OneSided;                           // 0x04D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTextureRenderTarget2D*                 RenderTarget;                                      // 0x04E0(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               MaterialInstance;                                  // 0x04E8(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAddedToScreen;                                    // 0x04F0(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEditTimeUsable;                                   // 0x04F1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4F2[0x2];                                      // 0x04F2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SharedLayerName;                                   // 0x04F4(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LayerZOrder;                                       // 0x04FC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWidgetGeometryMode                           GeometryMode;                                      // 0x0500(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_501[0x3];                                      // 0x0501(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CylinderArcAngle;                                  // 0x0504(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWidgetComponent) == 0x000530, "Wrong size on UWidgetComponent");
static_assert(offsetof(UWidgetComponent, Space) == 0x000410, "Member 'UWidgetComponent::Space' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TimingPolicy) == 0x000411, "Member 'UWidgetComponent::TimingPolicy' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WidgetClass) == 0x000418, "Member 'UWidgetComponent::WidgetClass' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, DrawSize) == 0x000420, "Member 'UWidgetComponent::DrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bManuallyRedraw) == 0x000428, "Member 'UWidgetComponent::bManuallyRedraw' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bRedrawRequested) == 0x000429, "Member 'UWidgetComponent::bRedrawRequested' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RedrawTime) == 0x00042C, "Member 'UWidgetComponent::RedrawTime' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CurrentDrawSize) == 0x000438, "Member 'UWidgetComponent::CurrentDrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bDrawAtDesiredSize) == 0x000440, "Member 'UWidgetComponent::bDrawAtDesiredSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Pivot) == 0x000444, "Member 'UWidgetComponent::Pivot' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bReceiveHardwareInput) == 0x00044C, "Member 'UWidgetComponent::bReceiveHardwareInput' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bWindowFocusable) == 0x00044D, "Member 'UWidgetComponent::bWindowFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WindowVisibility) == 0x00044E, "Member 'UWidgetComponent::WindowVisibility' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bApplyGammaCorrection) == 0x00044F, "Member 'UWidgetComponent::bApplyGammaCorrection' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OwnerPlayer) == 0x000450, "Member 'UWidgetComponent::OwnerPlayer' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BackgroundColor) == 0x000458, "Member 'UWidgetComponent::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TintColorAndOpacity) == 0x000468, "Member 'UWidgetComponent::TintColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpacityFromTexture) == 0x000478, "Member 'UWidgetComponent::OpacityFromTexture' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BlendMode) == 0x00047C, "Member 'UWidgetComponent::BlendMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bIsTwoSided) == 0x00047D, "Member 'UWidgetComponent::bIsTwoSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickWhenOffscreen) == 0x00047E, "Member 'UWidgetComponent::TickWhenOffscreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Widget) == 0x000480, "Member 'UWidgetComponent::Widget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BodySetup) == 0x0004A8, "Member 'UWidgetComponent::BodySetup' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial) == 0x0004B0, "Member 'UWidgetComponent::TranslucentMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial_OneSided) == 0x0004B8, "Member 'UWidgetComponent::TranslucentMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial) == 0x0004C0, "Member 'UWidgetComponent::OpaqueMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial_OneSided) == 0x0004C8, "Member 'UWidgetComponent::OpaqueMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial) == 0x0004D0, "Member 'UWidgetComponent::MaskedMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial_OneSided) == 0x0004D8, "Member 'UWidgetComponent::MaskedMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RenderTarget) == 0x0004E0, "Member 'UWidgetComponent::RenderTarget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaterialInstance) == 0x0004E8, "Member 'UWidgetComponent::MaterialInstance' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bAddedToScreen) == 0x0004F0, "Member 'UWidgetComponent::bAddedToScreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bEditTimeUsable) == 0x0004F1, "Member 'UWidgetComponent::bEditTimeUsable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, SharedLayerName) == 0x0004F4, "Member 'UWidgetComponent::SharedLayerName' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x0004FC, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x000500, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x000504, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_234[0x7C];                                     // 0x0234(0x007C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CustomHitResult;                                   // 0x02B0(0x008C)(Transient, IsPlainOldData, NoDestructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FVector2D                              LocalHitLocation;                                  // 0x033C(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector2D                              LastLocalHitLocation;                              // 0x0344(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_34C[0x4];                                      // 0x034C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWidgetComponent*                       HoveredWidgetComponent;                            // 0x0350(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FHitResult                             LastHitResult;                                     // 0x0358(0x008C)(Transient, IsPlainOldData, NoDestructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetInteractable;                      // 0x03E4(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetFocusable;                         // 0x03E5(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetHitTestVisible;                    // 0x03E6(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3E7[0x9];                                      // 0x03E7(0x0009)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWidgetInteractionComponent, OnHoveredWidgetChanged) == 0x0001F0, "Member 'UWidgetInteractionComponent::OnHoveredWidgetChanged' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, VirtualUserIndex) == 0x000210, "Member 'UWidgetInteractionComponent::VirtualUserIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, PointerIndex) == 0x000214, "Member 'UWidgetInteractionComponent::PointerIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, TraceChannel) == 0x000218, "Member 'UWidgetInteractionComponent::TraceChannel' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionDistance) == 0x00021C, "Member 'UWidgetInteractionComponent::InteractionDistance' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionSource) == 0x000220, "Member 'UWidgetInteractionComponent::InteractionSource' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bEnableHitTesting) == 0x000221, "Member 'UWidgetInteractionComponent::bEnableHitTesting' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bShowDebug) == 0x000222, "Member 'UWidgetInteractionComponent::bShowDebug' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugColor) == 0x000224, "Member 'UWidgetInteractionComponent::DebugColor' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, CustomHitResult) == 0x0002B0, "Member 'UWidgetInteractionComponent::CustomHitResult' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LocalHitLocation) == 0x00033C, "Member 'UWidgetInteractionComponent::LocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastLocalHitLocation) == 0x000344, "Member 'UWidgetInteractionComponent::LastLocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, HoveredWidgetComponent) == 0x000350, "Member 'UWidgetInteractionComponent::HoveredWidgetComponent' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastHitResult) == 0x000358, "Member 'UWidgetInteractionComponent::LastHitResult' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetInteractable) == 0x0003E4, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetInteractable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetFocusable) == 0x0003E5, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetHitTestVisible) == 0x0003E6, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetHitTestVisible' has a wrong offset!");
