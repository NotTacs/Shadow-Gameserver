...
public:
	...
	class USphereComponent*                       ProximityTrigger;                                  // 0x0BA0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAudioComponent*                        Target_Move_Loop_Cue;                              // 0x0BA8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAudioComponent*                        Target_Move_Stop_Cue;                              // 0x0BB0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAudioComponent*                        Target_Move_Start_Cue;                             // 0x0BB8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class USceneComponent*                        TargetAttachPoint;                                 // 0x0BC8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_Target_Track;                                   // 0x0BD0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	float                                         TargetMovement_NewTrack_0_9F61BF394D22B10B7DAB4683CA4746AC; // 0x0BD8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ETimelineDirection                            TargetMovement__Direction_9F61BF394D22B10B7DAB4683CA4746AC; // 0x0BDC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_BDD[0x3];                                      // 0x0BDD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UTimelineComponent*                     TargetMovement;                                    // 0x0BE0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AB_TargetTrack_C, UberGraphFrame) == 0x000B98, "Member 'AB_TargetTrack_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, ProximityTrigger) == 0x000BA0, "Member 'AB_TargetTrack_C::ProximityTrigger' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, Target_Move_Loop_Cue) == 0x000BA8, "Member 'AB_TargetTrack_C::Target_Move_Loop_Cue' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, Target_Move_Stop_Cue) == 0x000BB0, "Member 'AB_TargetTrack_C::Target_Move_Stop_Cue' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, Target_Move_Start_Cue) == 0x000BB8, "Member 'AB_TargetTrack_C::Target_Move_Start_Cue' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, ToyOptionsComponent) == 0x000BC0, "Member 'AB_TargetTrack_C::ToyOptionsComponent' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, TargetAttachPoint) == 0x000BC8, "Member 'AB_TargetTrack_C::TargetAttachPoint' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, SM_Target_Track) == 0x000BD0, "Member 'AB_TargetTrack_C::SM_Target_Track' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, TargetMovement_NewTrack_0_9F61BF394D22B10B7DAB4683CA4746AC) == 0x000BD8, "Member 'AB_TargetTrack_C::TargetMovement_NewTrack_0_9F61BF394D22B10B7DAB4683CA4746AC' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, TargetMovement__Direction_9F61BF394D22B10B7DAB4683CA4746AC) == 0x000BDC, "Member 'AB_TargetTrack_C::TargetMovement__Direction_9F61BF394D22B10B7DAB4683CA4746AC' has a wrong offset!");
static_assert(offsetof(AB_TargetTrack_C, TargetMovement) == 0x000BE0, "Member 'AB_TargetTrack_C::TargetMovement' has a wrong offset!");
