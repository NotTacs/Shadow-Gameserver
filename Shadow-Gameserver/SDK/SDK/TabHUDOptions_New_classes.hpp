...
static_assert(sizeof(UTabHUDOptions_New_C) == 0x000328, "Wrong size on UTabHUDOptions_New_C");
static_assert(offsetof(UTabHUDOptions_New_C, UberGraphFrame) == 0x000320, "Member 'UTabHUDOptions_New_C::UberGraphFrame' has a wrong offset!");
