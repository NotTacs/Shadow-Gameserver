...
static_assert(sizeof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry) == 0x0001E8, "Wrong size on AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry");
...
static_assert(offsetof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry, CallFunc_IsUsingGamepad_Return_Value) == 0x000004, "Member 'AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry::CallFunc_IsUsingGamepad_Return_Value' has a wrong offset!");
...
static_assert(offsetof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry, CallFunc_IsUsingTouch_ReturnValue) == 0x0001DC, "Member 'AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry::CallFunc_IsUsingTouch_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry, CallFunc_IsUsingTouch_ReturnValue_1) == 0x0001DD, "Member 'AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry::CallFunc_IsUsingTouch_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry, CallFunc_IsUsingGamepad_Return_Value_1) == 0x0001DE, "Member 'AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry::CallFunc_IsUsingGamepad_Return_Value_1' has a wrong offset!");
static_assert(offsetof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry, CallFunc_BooleanOR_ReturnValue) == 0x0001DF, "Member 'AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry, CallFunc_BooleanOR_ReturnValue_1) == 0x0001E0, "Member 'AthenaChallengePageEntry_C_ExecuteUbergraph_AthenaChallengePageEntry::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
