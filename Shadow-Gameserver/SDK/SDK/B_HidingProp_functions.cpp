...
void AB_HidingProp_C::FadeToBlack(class APawn* Target)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_HidingProp_C", "FadeToBlack");

	Params::B_HidingProp_C_FadeToBlack Parms{};
...
void AB_HidingProp_C::FadeToBlackTimeLine__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_HidingProp_C", "FadeToBlackTimeLine__UpdateFunc");
...
void AB_HidingProp_C::FadeToBlackTimeLine__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_HidingProp_C", "FadeToBlackTimeLine__FinishedFunc");
...
void AB_HidingProp_C::GetOutOfSnowmanIfExists(class AActor* PlayerPawn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_HidingProp_C", "GetOutOfSnowmanIfExists");

	Params::B_HidingProp_C_GetOutOfSnowmanIfExists Parms{};
...
void AB_HidingProp_C::AllowCosmeticsForPawn(class AFortPawn* Pawn, bool* Allow)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_HidingProp_C", "AllowCosmeticsForPawn");

	Params::B_HidingProp_C_AllowCosmeticsForPawn Parms{};
