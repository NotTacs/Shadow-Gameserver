...
// Package: S12_Elevator_ToHenchmanRoom
...
class S12_Elevator_ToHenchmanRoom::USequenceDirector_C final : public ULevelSequenceDirector
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BlueprintGeneratedClass S12_Elevator_ToHenchmanRoom.SequenceDirector_C", true, "SequenceDirector_C">();
	}
	static class S12_Elevator_ToHenchmanRoom::USequenceDirector_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<S12_Elevator_ToHenchmanRoom::USequenceDirector_C>();
	}
};
static_assert(alignof(S12_Elevator_ToHenchmanRoom::USequenceDirector_C) == 0x000008, "Wrong alignment on S12_Elevator_ToHenchmanRoom::USequenceDirector_C");
static_assert(sizeof(S12_Elevator_ToHenchmanRoom::USequenceDirector_C) == 0x000038, "Wrong size on S12_Elevator_ToHenchmanRoom::USequenceDirector_C");
static_assert(offsetof(S12_Elevator_ToHenchmanRoom::USequenceDirector_C, UberGraphFrame) == 0x000030, "Member 'S12_Elevator_ToHenchmanRoom::USequenceDirector_C::UberGraphFrame' has a wrong offset!");
