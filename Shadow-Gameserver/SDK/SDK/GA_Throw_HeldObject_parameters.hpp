...
public:
	...
	TArray<class AActor*>                         CallFunc_FilterArray_FilteredArray;                // 0x0020(0x0010)(ZeroConstructor, ReferenceParm)
...
static_assert(sizeof(GA_Throw_HeldObject_C_PrethrowSetup) == 0x000098, "Wrong size on GA_Throw_HeldObject_C_PrethrowSetup");
...
static_assert(offsetof(GA_Throw_HeldObject_C_PrethrowSetup, K2Node_DynamicCast_AsFort_Player_Pawn) == 0x000088, "Member 'GA_Throw_HeldObject_C_PrethrowSetup::K2Node_DynamicCast_AsFort_Player_Pawn' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_PrethrowSetup, K2Node_DynamicCast_bSuccess_1) == 0x000090, "Member 'GA_Throw_HeldObject_C_PrethrowSetup::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
public:
	...
	TArray<struct FVector>                        CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints; // 0x0178(0x0010)(ZeroConstructor, ReferenceParm)
	TArray<struct FVector>                        CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents; // 0x0188(0x0010)(ZeroConstructor, ReferenceParm)
};
...
static_assert(sizeof(GA_Throw_HeldObject_C_GetOwningPlayer) == 0x000060, "Wrong size on GA_Throw_HeldObject_C_GetOwningPlayer");
...
static_assert(offsetof(GA_Throw_HeldObject_C_GetOwningPlayer, K2Node_DynamicCast_AsFort_Player_Pawn) == 0x000050, "Member 'GA_Throw_HeldObject_C_GetOwningPlayer::K2Node_DynamicCast_AsFort_Player_Pawn' has a wrong offset!");
static_assert(offsetof(GA_Throw_HeldObject_C_GetOwningPlayer, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'GA_Throw_HeldObject_C_GetOwningPlayer::K2Node_DynamicCast_bSuccess' has a wrong offset!");
