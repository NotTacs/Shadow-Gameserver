...
// class FText                             Param_BonusText                                        (Parm, OutParm)

void UStoreMain_MTXOffer_C::GetBonusText(class UFortStoreFrontOfferInfo* OfferInfo, class FText* Param_BonusText)
{
	...
	if (Param_BonusText != nullptr)
		*Param_BonusText = std::move(Parms.Param_BonusText);
}
