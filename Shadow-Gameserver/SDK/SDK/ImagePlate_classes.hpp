...
static_assert(sizeof(AImagePlate) == 0x000220, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x000218, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
