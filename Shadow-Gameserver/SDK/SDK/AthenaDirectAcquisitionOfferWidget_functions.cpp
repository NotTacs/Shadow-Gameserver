...
// Function AthenaDirectAcquisitionOfferWidget.AthenaDirectAcquisitionOfferWidget_C.PreviewNextCarouselOffer
// (Event, Protected, BlueprintEvent)

void UAthenaDirectAcquisitionOfferWidget_C::PreviewNextCarouselOffer()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaDirectAcquisitionOfferWidget_C", "PreviewNextCarouselOffer");
...
void UAthenaDirectAcquisitionOfferWidget_C::UpdateCarousel(float InDeltaTime)
{
	...
	Params::AthenaDirectAcquisitionOfferWidget_C_UpdateCarousel Parms{};
...
void UAthenaDirectAcquisitionOfferWidget_C::SetupThumbnailRenderer(class UFortItemThumbnailRenderer* InThumbnailRenderer)
{
	...
	Params::AthenaDirectAcquisitionOfferWidget_C_SetupThumbnailRenderer Parms{};
...
void UAthenaDirectAcquisitionOfferWidget_C::OnOfferTileBrushLoaded(const struct FSlateBrush& OfferBrush)
{
	static class UFunction* Func = nullptr;
	...
	Params::AthenaDirectAcquisitionOfferWidget_C_OnOfferTileBrushLoaded Parms{};
