...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_B_PlayerShieldDamage_CameraLensEffect_C; // 0x02D8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AB_PlayerShieldDamage_CameraLensEffect_C) == 0x0002E0, "Wrong size on AB_PlayerShieldDamage_CameraLensEffect_C");
static_assert(offsetof(AB_PlayerShieldDamage_CameraLensEffect_C, UberGraphFrame_B_PlayerShieldDamage_CameraLensEffect_C) == 0x0002D8, "Member 'AB_PlayerShieldDamage_CameraLensEffect_C::UberGraphFrame_B_PlayerShieldDamage_CameraLensEffect_C' has a wrong offset!");
