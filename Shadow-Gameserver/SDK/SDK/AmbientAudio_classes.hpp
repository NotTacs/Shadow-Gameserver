...
public:
	...
	float                                         CrossfadeTime;                                     // 0x025C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bEnabled : 1;                                      // 0x0260(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, Net, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bGlobal : 1;                                       // 0x0260(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(AAmbientVolume) == 0x000268, "Wrong size on AAmbientVolume");
...
static_assert(offsetof(AAmbientVolume, CrossfadeTime) == 0x00025C, "Member 'AAmbientVolume::CrossfadeTime' has a wrong offset!");
