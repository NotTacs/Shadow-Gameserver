...
static_assert(sizeof(ULeavePartyConfirmationMenu_C) == 0x000330, "Wrong size on ULeavePartyConfirmationMenu_C");
static_assert(offsetof(ULeavePartyConfirmationMenu_C, UberGraphFrame) == 0x000320, "Member 'ULeavePartyConfirmationMenu_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ULeavePartyConfirmationMenu_C, Opened) == 0x000328, "Member 'ULeavePartyConfirmationMenu_C::Opened' has a wrong offset!");
