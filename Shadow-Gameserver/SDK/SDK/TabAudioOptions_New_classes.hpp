...
static_assert(sizeof(UTabAudioOptions_New_C) == 0x000328, "Wrong size on UTabAudioOptions_New_C");
static_assert(offsetof(UTabAudioOptions_New_C, UberGraphFrame) == 0x000320, "Member 'UTabAudioOptions_New_C::UberGraphFrame' has a wrong offset!");
