...
static_assert(offsetof(GCL_BoostJumpPack_FuelRegen_C_ResetBlink, Param_PlayerPawn) == 0x000000, "Member 'GCL_BoostJumpPack_FuelRegen_C_ResetBlink::Param_PlayerPawn' has a wrong offset!");
