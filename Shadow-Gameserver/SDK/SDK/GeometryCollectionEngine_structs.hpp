...
public:
	...
	int32                                         ParticleIndex;                                     // 0x001C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FChaosBreakingEventData) == 0x000004, "Wrong alignment on FChaosBreakingEventData");
static_assert(sizeof(FChaosBreakingEventData) == 0x000020, "Wrong size on FChaosBreakingEventData");
...
static_assert(offsetof(FChaosBreakingEventData, ParticleIndex) == 0x00001C, "Member 'FChaosBreakingEventData::ParticleIndex' has a wrong offset!");
