...
void UAthenaLocker_ItemInfo_C::Overide_Item_Info(const class FText& Param_Name, const class FText& Type, const class FText& Description, EFortRarity Rarity, bool Hide_Rarity)
{
	static class UFunction* Func = nullptr;
