...
public:
	...
	TArray<struct FPlaylistUIExtension>           UIExtensions;                                      // 0x0138(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TMap<struct FGameplayTag, TSoftClassPtr<class UClass>> TaggedUIExtensions;                                // 0x0148(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AFortWeapon_EventMode) == 0x000B88, "Wrong size on AFortWeapon_EventMode");
