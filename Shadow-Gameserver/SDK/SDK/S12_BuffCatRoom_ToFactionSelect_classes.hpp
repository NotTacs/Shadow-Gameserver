...
// BlueprintGeneratedClass S12_BuffCatRoom_ToFactionSelect.SequenceDirector_C
// 0x0008 (0x0038 - 0x0030)
class S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C final : public ULevelSequenceDirector
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BlueprintGeneratedClass S12_BuffCatRoom_ToFactionSelect.SequenceDirector_C", true, "SequenceDirector_C">();
	}
	static class S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C>();
	}
};
static_assert(alignof(S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C) == 0x000008, "Wrong alignment on S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C");
static_assert(sizeof(S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C) == 0x000038, "Wrong size on S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C");
static_assert(offsetof(S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C, UberGraphFrame) == 0x000030, "Member 'S12_BuffCatRoom_ToFactionSelect::USequenceDirector_C::UberGraphFrame' has a wrong offset!");
