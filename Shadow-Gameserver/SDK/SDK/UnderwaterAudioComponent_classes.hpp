...
public:
	...
	bool                                          bIsUnderWater;                                     // 0x00E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_E1[0x7];                                       // 0x00E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundMix*                              CamUnderwaterSoundMixFritter;                      // 0x00E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_UnderwaterAudioComponent(int32 EntryPoint);
	void On_Camera_Underwater_State_Changed(bool Param_bIsUnderWater, float DepthUnderwater);
...
static_assert(sizeof(UUnderwaterAudioComponent_C) == 0x0000F0, "Wrong size on UUnderwaterAudioComponent_C");
...
static_assert(offsetof(UUnderwaterAudioComponent_C, bIsUnderWater) == 0x0000E0, "Member 'UUnderwaterAudioComponent_C::bIsUnderWater' has a wrong offset!");
static_assert(offsetof(UUnderwaterAudioComponent_C, CamUnderwaterSoundMixFritter) == 0x0000E8, "Member 'UUnderwaterAudioComponent_C::CamUnderwaterSoundMixFritter' has a wrong offset!");
