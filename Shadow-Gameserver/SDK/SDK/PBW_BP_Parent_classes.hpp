...
public:
	...
	TArray<class UStaticMesh*>                    StaticMeshAlternateArray;                          // 0x0CE0(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
...
static_assert(sizeof(APBW_BP_Parent_C) == 0x000CF0, "Wrong size on APBW_BP_Parent_C");
static_assert(offsetof(APBW_BP_Parent_C, UberGraphFrame) == 0x000CD8, "Member 'APBW_BP_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APBW_BP_Parent_C, StaticMeshAlternateArray) == 0x000CE0, "Member 'APBW_BP_Parent_C::StaticMeshAlternateArray' has a wrong offset!");
