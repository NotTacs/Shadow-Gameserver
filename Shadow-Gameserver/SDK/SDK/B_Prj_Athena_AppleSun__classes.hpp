...
public:
	...
	int32                                         CrashpadsBouncedOffOf;                             // 0x0900(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AB_Prj_Athena_AppleSun__C) == 0x000908, "Wrong size on AB_Prj_Athena_AppleSun__C");
...
static_assert(offsetof(AB_Prj_Athena_AppleSun__C, CrashpadsBouncedOffOf) == 0x000900, "Member 'AB_Prj_Athena_AppleSun__C::CrashpadsBouncedOffOf' has a wrong offset!");
