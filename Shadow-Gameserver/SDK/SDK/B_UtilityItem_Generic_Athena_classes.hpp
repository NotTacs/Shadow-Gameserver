...
public:
	...
	bool                                          UseThrowConsumableHudKeyActions;                   // 0x0B90(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AB_UtilityItem_Generic_Athena_C) == 0x000B98, "Wrong size on AB_UtilityItem_Generic_Athena_C");
static_assert(offsetof(AB_UtilityItem_Generic_Athena_C, UberGraphFrame) == 0x000B88, "Member 'AB_UtilityItem_Generic_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_UtilityItem_Generic_Athena_C, UseThrowConsumableHudKeyActions) == 0x000B90, "Member 'AB_UtilityItem_Generic_Athena_C::UseThrowConsumableHudKeyActions' has a wrong offset!");
