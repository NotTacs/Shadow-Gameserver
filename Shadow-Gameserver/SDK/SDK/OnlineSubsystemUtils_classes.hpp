...
public:
	...
	uint8                                         Pad_1A84[0xC];                                     // 0x1A84(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001A90, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001A80, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
{
public:
	uint8                                         LogPortUnreach : 1;                                // 0x0710(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         AllowPlayerPortUnreach : 1;                        // 0x0710(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_711[0x3];                                      // 0x0711(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxPortCountToTry;                                 // 0x0714(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_718[0xC];                                      // 0x0718(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        ServerDesiredSocketReceiveBufferBytes;             // 0x0724(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ServerDesiredSocketSendBufferBytes;                // 0x0728(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketReceiveBufferBytes;             // 0x072C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        ClientDesiredSocketSendBufferBytes;                // 0x0730(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_734[0x4];                                      // 0x0734(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        MaxSecondsInReceive;                               // 0x0738(0x0008)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NbPacketsBetweenReceiveTimeTest;                   // 0x0740(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UIpNetDriver) == 0x000760, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x000714, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x000724, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x000728, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x00072C, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x000730, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, MaxSecondsInReceive) == 0x000738, "Member 'UIpNetDriver::MaxSecondsInReceive' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, NbPacketsBetweenReceiveTimeTest) == 0x000740, "Member 'UIpNetDriver::NbPacketsBetweenReceiveTimeTest' has a wrong offset!");
...
static_assert(sizeof(AOnlineBeacon) == 0x000248, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x000220, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x000224, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x000228, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_259[0x4F];                                     // 0x0259(0x004F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconClient) == 0x0002A8, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x000248, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x000250, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x000258, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
{
public:
	int32                                         ListenPort;                                        // 0x0248(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24C[0x4];                                      // 0x024C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x0250(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_260[0xA0];                                     // 0x0260(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconHost) == 0x000300, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x000248, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x000250, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
{
public:
	class FString                                 BeaconTypeName;                                    // 0x0218(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x0228(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x000240, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x000218, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x000228, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x000230, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
public:
	...
	class FString                                 DestSessionId;                                     // 0x02D8(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_33B[0x2D];                                     // 0x033B(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APartyBeaconClient) == 0x000368, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x0002D8, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x0002E8, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x000338, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x000339, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x00033A, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_248[0x60];                                     // 0x0248(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APartyBeaconHost) == 0x0002B8, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x000240, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x0002A8, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x0002AC, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x0002B0, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(offsetof(UPartyBeaconState, bEnableRemovalRequests) == 0x000051, "Member 'UPartyBeaconState::bEnableRemovalRequests' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_363[0x2D];                                     // 0x0363(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ASpectatorBeaconClient) == 0x000390, "Wrong size on ASpectatorBeaconClient");
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x0002D8, "Member 'ASpectatorBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x0002E8, "Member 'ASpectatorBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, RequestType) == 0x000360, "Member 'ASpectatorBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bPendingReservationSent) == 0x000361, "Member 'ASpectatorBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bCancelReservation) == 0x000362, "Member 'ASpectatorBeaconClient::bCancelReservation' has a wrong offset!");
...
static_assert(sizeof(ASpectatorBeaconHost) == 0x0002B8, "Wrong size on ASpectatorBeaconHost");
static_assert(offsetof(ASpectatorBeaconHost, State) == 0x000240, "Member 'ASpectatorBeaconHost::State' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, bLogoutOnSessionTimeout) == 0x0002A8, "Member 'ASpectatorBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, SessionTimeoutSecs) == 0x0002AC, "Member 'ASpectatorBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, TravelSessionTimeoutSecs) == 0x0002B0, "Member 'ASpectatorBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x0002A8, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x000240, "Wrong size on ATestBeaconHost");
