...
static_assert(offsetof(BP_TimeSynthTrackComponent_C_SetController, Param_TimeSynthController) == 0x000000, "Member 'BP_TimeSynthTrackComponent_C_SetController::Param_TimeSynthController' has a wrong offset!");
...
{
public:
	TArray<struct FTimeSynth_TrackStemData>       Param_Clips;                                       // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
static_assert(offsetof(BP_TimeSynthTrackComponent_C_CalculateTrackLengthBeats, Param_Clips) == 0x000000, "Member 'BP_TimeSynthTrackComponent_C_CalculateTrackLengthBeats::Param_Clips' has a wrong offset!");
