...
public:
	...
	TSubclassOf<class ULiveLinkRole>              Role;                                              // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FLiveLinkBaseFrameData) == 0x000080, "Wrong size on FLiveLinkBaseFrameData");
...
static_assert(sizeof(FLiveLinkTransformFrameData) == 0x0000B0, "Wrong size on FLiveLinkTransformFrameData");
static_assert(offsetof(FLiveLinkTransformFrameData, Transform) == 0x000080, "Member 'FLiveLinkTransformFrameData::Transform' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkCameraFrameData) == 0x0000D0, "Wrong size on FLiveLinkCameraFrameData");
static_assert(offsetof(FLiveLinkCameraFrameData, FieldOfView) == 0x0000B0, "Member 'FLiveLinkCameraFrameData::FieldOfView' has a wrong offset!");
static_assert(offsetof(FLiveLinkCameraFrameData, AspectRatio) == 0x0000B4, "Member 'FLiveLinkCameraFrameData::AspectRatio' has a wrong offset!");
static_assert(offsetof(FLiveLinkCameraFrameData, FocalLength) == 0x0000B8, "Member 'FLiveLinkCameraFrameData::FocalLength' has a wrong offset!");
static_assert(offsetof(FLiveLinkCameraFrameData, Aperture) == 0x0000BC, "Member 'FLiveLinkCameraFrameData::Aperture' has a wrong offset!");
static_assert(offsetof(FLiveLinkCameraFrameData, FocusDistance) == 0x0000C0, "Member 'FLiveLinkCameraFrameData::FocusDistance' has a wrong offset!");
static_assert(offsetof(FLiveLinkCameraFrameData, ProjectionMode) == 0x0000C4, "Member 'FLiveLinkCameraFrameData::ProjectionMode' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkCameraBlueprintData) == 0x000100, "Wrong size on FLiveLinkCameraBlueprintData");
...
static_assert(sizeof(FLiveLinkAnimationFrameData) == 0x000090, "Wrong size on FLiveLinkAnimationFrameData");
static_assert(offsetof(FLiveLinkAnimationFrameData, Transforms) == 0x000080, "Member 'FLiveLinkAnimationFrameData::Transforms' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkBasicBlueprintData) == 0x000098, "Wrong size on FLiveLinkBasicBlueprintData");
...
static_assert(sizeof(FLiveLinkLightFrameData) == 0x0000E0, "Wrong size on FLiveLinkLightFrameData");
static_assert(offsetof(FLiveLinkLightFrameData, Temperature) == 0x0000B0, "Member 'FLiveLinkLightFrameData::Temperature' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, Intensity) == 0x0000B4, "Member 'FLiveLinkLightFrameData::Intensity' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, LightColor) == 0x0000B8, "Member 'FLiveLinkLightFrameData::LightColor' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, InnerConeAngle) == 0x0000BC, "Member 'FLiveLinkLightFrameData::InnerConeAngle' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, OuterConeAngle) == 0x0000C0, "Member 'FLiveLinkLightFrameData::OuterConeAngle' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, AttenuationRadius) == 0x0000C4, "Member 'FLiveLinkLightFrameData::AttenuationRadius' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, SourceRadius) == 0x0000C8, "Member 'FLiveLinkLightFrameData::SourceRadius' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, SoftSourceRadius) == 0x0000CC, "Member 'FLiveLinkLightFrameData::SoftSourceRadius' has a wrong offset!");
static_assert(offsetof(FLiveLinkLightFrameData, SourceLength) == 0x0000D0, "Member 'FLiveLinkLightFrameData::SourceLength' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkLightBlueprintData) == 0x000110, "Wrong size on FLiveLinkLightBlueprintData");
...
static_assert(sizeof(FLiveLinkSourcePreset) == 0x000018, "Wrong size on FLiveLinkSourcePreset");
...
public:
	...
	int32                                         ValidTimecodeFrame;                                // 0x001C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TimecodeFrameOffset;                               // 0x0020(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LatestOffset;                                      // 0x0024(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxNumberOfFrameToBuffered;                        // 0x0028(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FLiveLinkSourceBufferManagementSettings) == 0x000004, "Wrong alignment on FLiveLinkSourceBufferManagementSettings");
static_assert(sizeof(FLiveLinkSourceBufferManagementSettings) == 0x000030, "Wrong size on FLiveLinkSourceBufferManagementSettings");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, ValidEngineTime) == 0x000000, "Member 'FLiveLinkSourceBufferManagementSettings::ValidEngineTime' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, EngineTimeOffset) == 0x000004, "Member 'FLiveLinkSourceBufferManagementSettings::EngineTimeOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, TimecodeFrameRate) == 0x000008, "Member 'FLiveLinkSourceBufferManagementSettings::TimecodeFrameRate' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, bGenerateSubFrame) == 0x000010, "Member 'FLiveLinkSourceBufferManagementSettings::bGenerateSubFrame' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, SourceTimecodeFrameRate) == 0x000014, "Member 'FLiveLinkSourceBufferManagementSettings::SourceTimecodeFrameRate' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, ValidTimecodeFrame) == 0x00001C, "Member 'FLiveLinkSourceBufferManagementSettings::ValidTimecodeFrame' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, TimecodeFrameOffset) == 0x000020, "Member 'FLiveLinkSourceBufferManagementSettings::TimecodeFrameOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, LatestOffset) == 0x000024, "Member 'FLiveLinkSourceBufferManagementSettings::LatestOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, MaxNumberOfFrameToBuffered) == 0x000028, "Member 'FLiveLinkSourceBufferManagementSettings::MaxNumberOfFrameToBuffered' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, bKeepAtLeastOneFrame) == 0x00002C, "Member 'FLiveLinkSourceBufferManagementSettings::bKeepAtLeastOneFrame' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkTransformBlueprintData) == 0x0000D0, "Wrong size on FLiveLinkTransformBlueprintData");
