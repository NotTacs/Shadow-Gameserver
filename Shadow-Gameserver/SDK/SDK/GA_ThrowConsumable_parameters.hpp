...
public:
	...
	float                                         CallFunc_GetProjectileAdditionalThrowAngleToUse_AdditionalThrowAngleToUse; // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation) == 0x0000B0, "Wrong size on GA_ThrowConsumable_C_GetSpawnLocationAndRotation");
...
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, Temp_bool_Variable) == 0x000018, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_GetProjectileAdditionalThrowAngleToUse_AdditionalThrowAngleToUse) == 0x000048, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_GetProjectileAdditionalThrowAngleToUse_AdditionalThrowAngleToUse' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_K2_GetActorRotation_ReturnValue) == 0x00004C, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_K2_GetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_Add_FloatFloat_ReturnValue) == 0x000058, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_BreakRotator_Roll_1) == 0x00005C, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_BreakRotator_Roll_1' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_BreakRotator_Pitch_1) == 0x000060, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_BreakRotator_Pitch_1' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_BreakRotator_Yaw_1) == 0x000064, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_BreakRotator_Yaw_1' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_NormalizeAxis_ReturnValue) == 0x000068, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_NormalizeAxis_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_FMin_ReturnValue) == 0x00006C, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_FMin_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_MakeRotator_ReturnValue) == 0x000070, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_RotateAngleAxis_ReturnValue) == 0x000094, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_RotateAngleAxis_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetSpawnLocationAndRotation, CallFunc_Add_VectorVector_ReturnValue) == 0x0000A0, "Member 'GA_ThrowConsumable_C_GetSpawnLocationAndRotation::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
