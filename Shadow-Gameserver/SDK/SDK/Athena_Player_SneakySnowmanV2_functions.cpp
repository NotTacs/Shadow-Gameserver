...
void AAthena_Player_SneakySnowmanV2_C::SetMaintainingRotation_(bool Maintaining, bool HidePlayerIfTrue, const struct FVector& CrouchedLoc, bool Param_RotateToGround, bool SetPoppingOut)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<struct FHitResult>               NewParam                                               (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
