...
public:
	...
	TArray<class AFortPlayerController*>          CallFunc_GetLocalFortPlayerControllers_ReturnValue_1; // 0x0048(0x0010)(ZeroConstructor, ReferenceParm)
	...
	class AFortPlayerController*                  CallFunc_Array_Get_Item_1;                         // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerControllerAthena*            K2Node_DynamicCast_AsFort_Player_Controller_Athena_1; // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UUserWidget* UserWidget)> K2Node_CreateDelegate_OutputDelegate;              // 0x0084(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          CallFunc_NotEqual_IntInt_ReturnValue_1;            // 0x0096(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_97[0x1];                                       // 0x0097(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         K2Node_MakeArray_Array;                            // 0x0098(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	class FString                                 CallFunc_GetOptionValueNameFromValue_ReturnValue;  // 0x00A8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetOptionKey_ReturnValue;                 // 0x00B8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	TArray<class AFortPlayerController*>          CallFunc_GetLocalFortPlayerControllers_ReturnValue_2; // 0x0120(0x0010)(ZeroConstructor, ReferenceParm)
	int32                                         Temp_int_Variable;                                 // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_134[0x4];                                      // 0x0134(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPlayerController*                  CallFunc_Array_Get_Item_2;                         // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortAsyncAction_CreateWidgetAsync*     CallFunc_CreateWidgetAsync_ReturnValue;            // 0x0140(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0148(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_149[0x7];                                      // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortVolumeManager*                     CallFunc_GetVolumeManager_OutVolumeManager;        // 0x0150(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EVolumeValidityResult                         CallFunc_GetVolumeManager_OutIsValid;              // 0x0158(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_bShouldUse;                           // 0x0168(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine) == 0x000198, "Wrong size on MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine");
...
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CustomEvent_UserWidget) == 0x000008, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CustomEvent_UserWidget' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_object_Variable) == 0x000010, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_AsCommon_Activatable_Panel) == 0x000018, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_AsCommon_Activatable_Panel' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_bool_Has_Been_Initd_Variable) == 0x000021, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_bool_IsClosed_Variable) == 0x000022, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_Conv_IntToString_ReturnValue) == 0x000028, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetLocalFortPlayerControllers_ReturnValue) == 0x000038, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetLocalFortPlayerControllers_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetLocalFortPlayerControllers_ReturnValue_1) == 0x000048, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetLocalFortPlayerControllers_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_Array_Get_Item) == 0x000058, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_Array_Get_Item_1) == 0x000060, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_AsFort_Player_Controller_Athena) == 0x000068, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_AsFort_Player_Controller_Athena' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_bSuccess_1) == 0x000070, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_AsFort_Player_Controller_Athena_1) == 0x000078, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_AsFort_Player_Controller_Athena_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_DynamicCast_bSuccess_2) == 0x000080, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_HasAuthority_ReturnValue) == 0x000081, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CreateDelegate_OutputDelegate) == 0x000084, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000094, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000095, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_NotEqual_IntInt_ReturnValue_1) == 0x000096, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_NotEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_MakeArray_Array) == 0x000098, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetOptionValueNameFromValue_ReturnValue) == 0x0000A8, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetOptionValueNameFromValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetOptionKey_ReturnValue) == 0x0000B8, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetOptionKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_MakeMap_Map) == 0x0000C8, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_MakeMap_Map' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_SetPropertyOverrides_ReturnValue) == 0x000118, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_SetPropertyOverrides_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetLocalFortPlayerControllers_ReturnValue_2) == 0x000120, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetLocalFortPlayerControllers_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_int_Variable) == 0x000130, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_Array_Get_Item_2) == 0x000138, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_CreateWidgetAsync_ReturnValue) == 0x000140, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_CreateWidgetAsync_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_IsValid_ReturnValue) == 0x000148, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetVolumeManager_OutVolumeManager) == 0x000150, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetVolumeManager_OutVolumeManager' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetVolumeManager_OutIsValid) == 0x000158, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetVolumeManager_OutIsValid' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_SwitchEnum_CmpSuccess) == 0x000159, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_GetRuntimeOptions_ReturnValue) == 0x000160, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_GetRuntimeOptions_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_Event_bShouldUse) == 0x000168, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_Event_bShouldUse' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, CallFunc_BooleanAND_ReturnValue) == 0x000169, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CreateDelegate_OutputDelegate_1) == 0x00016C, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_CreateDelegate_OutputDelegate_2) == 0x00017C, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, Temp_bool_Variable) == 0x00018C, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine, K2Node_Select_Default) == 0x000190, "Member 'MinigameSettingsMachine_C_ExecuteUbergraph_MinigameSettingsMachine::K2Node_Select_Default' has a wrong offset!");

// Function MinigameSettingsMachine.MinigameSettingsMachine_C.UseSolaris
// 0x0001 (0x0001 - 0x0000)
struct MinigameSettingsMachine_C_UseSolaris final
{
public:
	bool                                          bShouldUse;                                        // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(MinigameSettingsMachine_C_UseSolaris) == 0x000001, "Wrong alignment on MinigameSettingsMachine_C_UseSolaris");
static_assert(sizeof(MinigameSettingsMachine_C_UseSolaris) == 0x000001, "Wrong size on MinigameSettingsMachine_C_UseSolaris");
static_assert(offsetof(MinigameSettingsMachine_C_UseSolaris, bShouldUse) == 0x000000, "Member 'MinigameSettingsMachine_C_UseSolaris::bShouldUse' has a wrong offset!");

// Function MinigameSettingsMachine.MinigameSettingsMachine_C.OnComplete_C895978B4EDC5073967F23BED63E6DB5
// 0x0008 (0x0008 - 0x0000)
struct MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5 final
{
public:
...
static_assert(alignof(MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5) == 0x000008, "Wrong alignment on MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5");
static_assert(sizeof(MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5) == 0x000008, "Wrong size on MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5");
static_assert(offsetof(MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5, UserWidget) == 0x000000, "Member 'MinigameSettingsMachine_C_OnComplete_C895978B4EDC5073967F23BED63E6DB5::UserWidget' has a wrong offset!");
...
public:
	...
	TArray<class UClass*>                         CallFunc_GetScoreboardStatsArray_ScoreboardStats;  // 0x0030(0x0010)(ZeroConstructor, ReferenceParm)
...
public:
	...
	TMap<class FString, class FString>            CallFunc_GetPropertyOverrides_CurrentOptions;      // 0x0020(0x0050)(ZeroConstructor)
...
struct MinigameSettingsMachine_C_ToggleScriptedGameRules final
{
public:
	bool                                          bIsScriptedGame;                                   // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSolarisPrototype                      K2Node_MakeStruct_SolarisPrototype;                // 0x0030(0x0180)()
};
static_assert(alignof(MinigameSettingsMachine_C_ToggleScriptedGameRules) == 0x000008, "Wrong alignment on MinigameSettingsMachine_C_ToggleScriptedGameRules");
static_assert(sizeof(MinigameSettingsMachine_C_ToggleScriptedGameRules) == 0x0001B0, "Wrong size on MinigameSettingsMachine_C_ToggleScriptedGameRules");
static_assert(offsetof(MinigameSettingsMachine_C_ToggleScriptedGameRules, bIsScriptedGame) == 0x000000, "Member 'MinigameSettingsMachine_C_ToggleScriptedGameRules::bIsScriptedGame' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ToggleScriptedGameRules, Temp_bool_Variable) == 0x000001, "Member 'MinigameSettingsMachine_C_ToggleScriptedGameRules::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ToggleScriptedGameRules, Temp_string_Variable) == 0x000008, "Member 'MinigameSettingsMachine_C_ToggleScriptedGameRules::Temp_string_Variable' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ToggleScriptedGameRules, CallFunc_GetCurrentMinigame_Minigame) == 0x000018, "Member 'MinigameSettingsMachine_C_ToggleScriptedGameRules::CallFunc_GetCurrentMinigame_Minigame' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ToggleScriptedGameRules, K2Node_Select_Default) == 0x000020, "Member 'MinigameSettingsMachine_C_ToggleScriptedGameRules::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(MinigameSettingsMachine_C_ToggleScriptedGameRules, K2Node_MakeStruct_SolarisPrototype) == 0x000030, "Member 'MinigameSettingsMachine_C_ToggleScriptedGameRules::K2Node_MakeStruct_SolarisPrototype' has a wrong offset!");
...
{
public:
	TArray<class UClass*>                         ScoreboardStats;                                   // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor)
	TArray<class UClass*>                         TrackedScoreboardStats;                            // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
...
{
public:
	TArray<class FString>                         K2Node_MakeArray_Array;                            // 0x0000(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	TMap<class FString, class FString>            K2Node_MakeMap_Map;                                // 0x0130(0x0050)(ConstParm, ZeroConstructor)
