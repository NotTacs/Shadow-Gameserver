...
public:
	...
	bool                                          CallFunc_HandleBackClicked_bIsHandled;             // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(GiftingScreen_C_ExecuteUbergraph_GiftingScreen, K2Node_ComponentBoundEvent_Button) == 0x000048, "Member 'GiftingScreen_C_ExecuteUbergraph_GiftingScreen::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(GiftingScreen_C_ExecuteUbergraph_GiftingScreen, CallFunc_IsMobileGame_ReturnValue) == 0x000050, "Member 'GiftingScreen_C_ExecuteUbergraph_GiftingScreen::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(GiftingScreen_C_ExecuteUbergraph_GiftingScreen, CallFunc_HandleBackClicked_bIsHandled) == 0x000051, "Member 'GiftingScreen_C_ExecuteUbergraph_GiftingScreen::CallFunc_HandleBackClicked_bIsHandled' has a wrong offset!");
static_assert(offsetof(GiftingScreen_C_ExecuteUbergraph_GiftingScreen, K2Node_Select_Default_1) == 0x000052, "Member 'GiftingScreen_C_ExecuteUbergraph_GiftingScreen::K2Node_Select_Default_1' has a wrong offset!");
...
static_assert(alignof(GiftingScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong alignment on GiftingScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature");
static_assert(sizeof(GiftingScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong size on GiftingScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature");
static_assert(offsetof(GiftingScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature, Button) == 0x000000, "Member 'GiftingScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature::Button' has a wrong offset!");
