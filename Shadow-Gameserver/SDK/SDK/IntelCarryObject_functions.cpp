...
// Parameters:
// bool                                    Is_Attacking                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AIntelCarryObject_C::Get_Is_Local_Player_Attacking(bool* Is_Attacking)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("IntelCarryObject_C", "Get Is Local Player Attacking");

	Params::IntelCarryObject_C_Get_Is_Local_Player_Attacking Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Is_Attacking != nullptr)
		*Is_Attacking = Parms.Is_Attacking;
}
