...
public:
	...
	struct FMcpBanInfo                            McpBanInfo;                                        // 0x04E0(0x0058)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                   BanType;                                           // 0x0538(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          bIsCompetitiveBan;                                 // 0x0550(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bIsTeamingWithCheaterBan;                          // 0x0551(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UPlayerBannedModal_C) == 0x000558, "Wrong size on UPlayerBannedModal_C");
...
static_assert(offsetof(UPlayerBannedModal_C, BanType) == 0x000538, "Member 'UPlayerBannedModal_C::BanType' has a wrong offset!");
static_assert(offsetof(UPlayerBannedModal_C, bIsCompetitiveBan) == 0x000550, "Member 'UPlayerBannedModal_C::bIsCompetitiveBan' has a wrong offset!");
static_assert(offsetof(UPlayerBannedModal_C, bIsTeamingWithCheaterBan) == 0x000551, "Member 'UPlayerBannedModal_C::bIsTeamingWithCheaterBan' has a wrong offset!");
