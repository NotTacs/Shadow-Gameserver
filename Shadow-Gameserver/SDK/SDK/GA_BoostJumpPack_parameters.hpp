...
public:
	...
	struct FHitResult                             K2Node_CustomEvent_Hit;                            // 0x0014(0x008C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x00A0(0x00B0)(ConstParm)
	EJumpBoostPackState                           K2Node_Event_InPreviousState;                      // 0x0150(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EJumpBoostPackState                           K2Node_Event_InCurrentState;                       // 0x0151(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack) == 0x000158, "Wrong size on GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack");
...
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_Event_InPreviousState) == 0x000150, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_Event_InPreviousState' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_Event_InCurrentState) == 0x000151, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_Event_InCurrentState' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000152, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GA_BoostJumpPack_C_OnPawnLanded) == 0x00008C, "Wrong size on GA_BoostJumpPack_C_OnPawnLanded");
...
static_assert(offsetof(GA_BoostJumpPack_C_TransitionFromBoost, CallFunc_Not_PreBool_ReturnValue) == 0x000002, "Member 'GA_BoostJumpPack_C_TransitionFromBoost::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_TransitionFromHovering, CallFunc_BooleanOR_ReturnValue_1) == 0x00000B, "Member 'GA_BoostJumpPack_C_TransitionFromHovering::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_TransitionFromFalling, CallFunc_BooleanAND_ReturnValue_1) == 0x00000A, "Member 'GA_BoostJumpPack_C_TransitionFromFalling::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_HandleHovering, CallFunc_GetTimeSeconds_ReturnValue_1) == 0x000018, "Member 'GA_BoostJumpPack_C_HandleHovering::CallFunc_GetTimeSeconds_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_HandleHovering, CallFunc_Subtract_FloatFloat_ReturnValue_1) == 0x00001C, "Member 'GA_BoostJumpPack_C_HandleHovering::CallFunc_Subtract_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_HandleHovering, CallFunc_Subtract_FloatFloat_ReturnValue_2) == 0x000020, "Member 'GA_BoostJumpPack_C_HandleHovering::CallFunc_Subtract_FloatFloat_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_HandleHovering, CallFunc_GetTimeSeconds_ReturnValue_2) == 0x000038, "Member 'GA_BoostJumpPack_C_HandleHovering::CallFunc_GetTimeSeconds_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_HandleFalling, CallFunc_Subtract_FloatFloat_ReturnValue_1) == 0x00001C, "Member 'GA_BoostJumpPack_C_HandleFalling::CallFunc_Subtract_FloatFloat_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_HandleFalling, CallFunc_GetTimeSeconds_ReturnValue_2) == 0x000024, "Member 'GA_BoostJumpPack_C_HandleFalling::CallFunc_GetTimeSeconds_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_HandleCurrentBoostStateChanged, Param_CurrentState) == 0x000001, "Member 'GA_BoostJumpPack_C_HandleCurrentBoostStateChanged::Param_CurrentState' has a wrong offset!");
...
static_assert(sizeof(GA_BoostJumpPack_C_ProcessTriggerData) == 0x000024, "Wrong size on GA_BoostJumpPack_C_ProcessTriggerData");
...
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_IsSurfaceSwimming_ReturnValue) == 0x000008, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_IsSurfaceSwimming_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesTag_ReturnValue) == 0x000009, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesTag_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_IsSwimming_ReturnValue) == 0x00000B, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_IsSwimming_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_IsMovingOnGround_ReturnValue) == 0x00000C, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_IsMovingOnGround_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Not_PreBool_ReturnValue_1) == 0x00000D, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Not_PreBool_ReturnValue_2) == 0x00000E, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue) == 0x00000F, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue_1) == 0x000010, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Subtract_IntInt_ReturnValue) == 0x000014, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Max_ReturnValue) == 0x000018, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Max_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Add_IntInt_ReturnValue) == 0x00001C, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesAnyTags_ReturnValue) == 0x000020, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesAnyTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesAnyTags_ReturnValue_1) == 0x000021, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesAnyTags_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue_2) == 0x000022, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanOR_ReturnValue) == 0x000023, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_TransitionFromIdle, CallFunc_BooleanAND_ReturnValue_1) == 0x00001A, "Member 'GA_BoostJumpPack_C_TransitionFromIdle::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
...
public:
	...
	class AFortPlayerPawnAthena*                  PlayerPawn;                                        // 0x00F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                  ExplicitExecutionTags;                             // 0x0100(0x0020)(Edit, BlueprintVisible)
...
static_assert(sizeof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent) == 0x000128, "Wrong size on GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent");
...
static_assert(offsetof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent, ReturnValue) == 0x0000F0, "Member 'GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent::ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent, PlayerPawn) == 0x0000F8, "Member 'GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent::PlayerPawn' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent, ExplicitExecutionTags) == 0x000100, "Member 'GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent::ExplicitExecutionTags' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent, CallFunc_Not_PreBool_ReturnValue) == 0x000120, "Member 'GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent, CallFunc_Not_PreBool_ReturnValue_1) == 0x000121, "Member 'GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent, CallFunc_BooleanAND_ReturnValue) == 0x000122, "Member 'GA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_IsCurrentlyDead, CallFunc_MatchesTag_ReturnValue_1) == 0x00000B, "Member 'GA_BoostJumpPack_C_IsCurrentlyDead::CallFunc_MatchesTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_IsCurrentlyDead, CallFunc_MatchesTag_ReturnValue_2) == 0x00000C, "Member 'GA_BoostJumpPack_C_IsCurrentlyDead::CallFunc_MatchesTag_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_IsCurrentlyDead, CallFunc_BooleanOR_ReturnValue_1) == 0x00000E, "Member 'GA_BoostJumpPack_C_IsCurrentlyDead::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_IsCurrentlyDead, CallFunc_BooleanOR_ReturnValue_2) == 0x00000F, "Member 'GA_BoostJumpPack_C_IsCurrentlyDead::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_MatchesTag_ReturnValue_1) == 0x00002A, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_MatchesTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_MatchesTag_ReturnValue_2) == 0x00002B, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_MatchesTag_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_BooleanOR_ReturnValue_1) == 0x000031, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_BooleanOR_ReturnValue_2) == 0x000032, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_BooleanOR_ReturnValue_3) == 0x000033, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_BooleanOR_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_BooleanOR_ReturnValue_4) == 0x000034, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_BooleanOR_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_BooleanOR_ReturnValue_5) == 0x000035, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_BooleanOR_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_BooleanOR_ReturnValue_6) == 0x000036, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_BooleanOR_ReturnValue_6' has a wrong offset!");
...
public:
	...
	class AFortPlayerControllerGameplay*          K2Node_DynamicCast_AsFort_Player_Controller_Gameplay; // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsAllowedToFly_ReturnValue;               // 0x0071(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(GA_BoostJumpPack_C_K2_CanActivateAbility) == 0x000078, "Wrong size on GA_BoostJumpPack_C_K2_CanActivateAbility");
...
static_assert(offsetof(GA_BoostJumpPack_C_K2_CanActivateAbility, RelevantTags) == 0x000040, "Member 'GA_BoostJumpPack_C_K2_CanActivateAbility::RelevantTags' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_CanActivateAbility, ReturnValue) == 0x000060, "Member 'GA_BoostJumpPack_C_K2_CanActivateAbility::ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_CanActivateAbility, K2Node_DynamicCast_AsFort_Player_Controller_Gameplay) == 0x000068, "Member 'GA_BoostJumpPack_C_K2_CanActivateAbility::K2Node_DynamicCast_AsFort_Player_Controller_Gameplay' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_CanActivateAbility, K2Node_DynamicCast_bSuccess) == 0x000070, "Member 'GA_BoostJumpPack_C_K2_CanActivateAbility::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_CanActivateAbility, CallFunc_IsAllowedToFly_ReturnValue) == 0x000071, "Member 'GA_BoostJumpPack_C_K2_CanActivateAbility::CallFunc_IsAllowedToFly_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_K2_CanActivateAbility, CallFunc_Not_PreBool_ReturnValue) == 0x000072, "Member 'GA_BoostJumpPack_C_K2_CanActivateAbility::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
