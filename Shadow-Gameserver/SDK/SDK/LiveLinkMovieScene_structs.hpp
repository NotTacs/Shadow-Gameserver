...
static_assert(offsetof(FMovieSceneLiveLinkSectionTemplate, SubjectPreset) == 0x000048, "Member 'FMovieSceneLiveLinkSectionTemplate::SubjectPreset' has a wrong offset!");
