...
static_assert(offsetof(FCatalogDynamicBundle, DiscountedBasePrice) == 0x000000, "Member 'FCatalogDynamicBundle::DiscountedBasePrice' has a wrong offset!");
static_assert(offsetof(FCatalogDynamicBundle, RegularBasePrice) == 0x000004, "Member 'FCatalogDynamicBundle::RegularBasePrice' has a wrong offset!");
static_assert(offsetof(FCatalogDynamicBundle, FloorPrice) == 0x000008, "Member 'FCatalogDynamicBundle::FloorPrice' has a wrong offset!");
static_assert(offsetof(FCatalogDynamicBundle, CurrencyType) == 0x00000C, "Member 'FCatalogDynamicBundle::CurrencyType' has a wrong offset!");
static_assert(offsetof(FCatalogDynamicBundle, CurrencySubType) == 0x000010, "Member 'FCatalogDynamicBundle::CurrencySubType' has a wrong offset!");
static_assert(offsetof(FCatalogDynamicBundle, DisplayType) == 0x000020, "Member 'FCatalogDynamicBundle::DisplayType' has a wrong offset!");
static_assert(offsetof(FCatalogDynamicBundle, BundleItems) == 0x000028, "Member 'FCatalogDynamicBundle::BundleItems' has a wrong offset!");
...
public:
	...
	TArray<struct FItemQuantity>                  ItemGrants;                                        // 0x01E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCatalogOfferRequirement>       Requirements;                                      // 0x01F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<class FString>                         DenyItemTemplateIds;                               // 0x0230(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FCatalogOffer) == 0x000008, "Wrong alignment on FCatalogOffer");
static_assert(sizeof(FCatalogOffer) == 0x000240, "Wrong size on FCatalogOffer");
...
static_assert(offsetof(FCatalogOffer, DailyLimit) == 0x000080, "Member 'FCatalogOffer::DailyLimit' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, WeeklyLimit) == 0x000084, "Member 'FCatalogOffer::WeeklyLimit' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, MonthlyLimit) == 0x000088, "Member 'FCatalogOffer::MonthlyLimit' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Categories) == 0x000090, "Member 'FCatalogOffer::Categories' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, CatalogGroup) == 0x0000A0, "Member 'FCatalogOffer::CatalogGroup' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, CatalogGroupPriority) == 0x0000B0, "Member 'FCatalogOffer::CatalogGroupPriority' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, SortPriority) == 0x0000B4, "Member 'FCatalogOffer::SortPriority' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Title) == 0x0000B8, "Member 'FCatalogOffer::Title' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, ShortDescription) == 0x0000D0, "Member 'FCatalogOffer::ShortDescription' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Description) == 0x0000E8, "Member 'FCatalogOffer::Description' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, AppStoreId) == 0x000100, "Member 'FCatalogOffer::AppStoreId' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, MetaAssetInfo) == 0x0001A0, "Member 'FCatalogOffer::MetaAssetInfo' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DisplayAssetPath) == 0x0001D0, "Member 'FCatalogOffer::DisplayAssetPath' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, ItemGrants) == 0x0001E0, "Member 'FCatalogOffer::ItemGrants' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Requirements) == 0x0001F0, "Member 'FCatalogOffer::Requirements' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, GiftInfo) == 0x000200, "Member 'FCatalogOffer::GiftInfo' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Refundable) == 0x000228, "Member 'FCatalogOffer::Refundable' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DenyItemTemplateIds) == 0x000230, "Member 'FCatalogOffer::DenyItemTemplateIds' has a wrong offset!");
