...
void UAthenaLockerTab_C::Update_Solo_Button(bool Using_Gamepad)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLockerTab_C", "Update Solo Button");

	Params::AthenaLockerTab_C_Update_Solo_Button Parms{};
...
void UAthenaLockerTab_C::OkToReshowOnHover(EAthenaCustomizationCategory Type, int32 Param_Index, bool* Ok)
{
	static class UFunction* Func = nullptr;
