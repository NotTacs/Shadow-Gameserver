...
public:
	...
	uint8                                         Pad_7A8[0x68];                                     // 0x07A8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                    // 0x0820(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_830[0x40];                                     // 0x0830(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x000870, "Wrong size on UMovieSceneSequencePlayer");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPlay) == 0x000408, "Member 'UMovieSceneSequencePlayer::OnPlay' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPlayReverse) == 0x000418, "Member 'UMovieSceneSequencePlayer::OnPlayReverse' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnStop) == 0x000428, "Member 'UMovieSceneSequencePlayer::OnStop' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPause) == 0x000438, "Member 'UMovieSceneSequencePlayer::OnPause' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnFinished) == 0x000448, "Member 'UMovieSceneSequencePlayer::OnFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Status) == 0x000458, "Member 'UMovieSceneSequencePlayer::Status' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Sequence) == 0x000460, "Member 'UMovieSceneSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, StartTime) == 0x000468, "Member 'UMovieSceneSequencePlayer::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, DurationFrames) == 0x00046C, "Member 'UMovieSceneSequencePlayer::DurationFrames' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x000470, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x000488, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x0004A0, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x000810, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x000820, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSequence, bPlayableDirectly) == 0x000342, "Member 'UMovieSceneSequence::bPlayableDirectly' has a wrong offset!");
