...
static_assert(sizeof(FControlRigExecuteContext) == 0x000008, "Wrong size on FControlRigExecuteContext");
...
{
public:
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0020(0x0008)(Transient, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnitMutable) == 0x000008, "Wrong alignment on FRigUnitMutable");
static_assert(sizeof(FRigUnitMutable) == 0x000028, "Wrong size on FRigUnitMutable");
...
static_assert(sizeof(FRigUnit_HighlevelBaseMutable) == 0x000028, "Wrong size on FRigUnit_HighlevelBaseMutable");
...
public:
	...
	TMap<class FName, uint16>                     ControlRigBoneMapping;                             // 0x0068(0x0050)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, uint16>                     ControlRigCurveMapping;                            // 0x00B8(0x0050)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, uint16>                     InputToCurveMappingUIDs;                           // 0x0108(0x0050)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	...
	bool                                          bUpdateInput;                                      // 0x0160(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bExecute;                                          // 0x0161(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FAnimNode_ControlRigBase) == 0x000168, "Wrong size on FAnimNode_ControlRigBase");
...
static_assert(offsetof(FAnimNode_ControlRigBase, bUpdateInput) == 0x000160, "Member 'FAnimNode_ControlRigBase::bUpdateInput' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, bExecute) == 0x000161, "Member 'FAnimNode_ControlRigBase::bExecute' has a wrong offset!");

// ScriptStruct ControlRig.AnimNode_ControlRig
// 0x01E0 (0x0348 - 0x0168)
...
public:
	...
	float                                         Alpha;                                             // 0x0178(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAnimAlphaInputType                           AlphaInputType;                                    // 0x017C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bAlphaBoolEnabled : 1;                             // 0x017D(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_17E[0x2];                                      // 0x017E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x0180(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	struct FInputAlphaBoolBlend                   AlphaBoolBlend;                                    // 0x0188(0x0048)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	class FName                                   AlphaCurveName;                                    // 0x01D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FInputScaleBiasClamp                   AlphaScaleBiasClamp;                               // 0x01D8(0x0030)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	TMap<class FName, class FName>                InputMapping;                                      // 0x0208(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, class FName>                OutputMapping;                                     // 0x0258(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A8[0xA0];                                     // 0x02A8(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_ControlRig) == 0x000008, "Wrong alignment on FAnimNode_ControlRig");
static_assert(sizeof(FAnimNode_ControlRig) == 0x000348, "Wrong size on FAnimNode_ControlRig");
static_assert(offsetof(FAnimNode_ControlRig, ControlRigClass) == 0x000168, "Member 'FAnimNode_ControlRig::ControlRigClass' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, ControlRig) == 0x000170, "Member 'FAnimNode_ControlRig::ControlRig' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, Alpha) == 0x000178, "Member 'FAnimNode_ControlRig::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaInputType) == 0x00017C, "Member 'FAnimNode_ControlRig::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaScaleBias) == 0x000180, "Member 'FAnimNode_ControlRig::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaBoolBlend) == 0x000188, "Member 'FAnimNode_ControlRig::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaCurveName) == 0x0001D0, "Member 'FAnimNode_ControlRig::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaScaleBiasClamp) == 0x0001D8, "Member 'FAnimNode_ControlRig::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, InputMapping) == 0x000208, "Member 'FAnimNode_ControlRig::InputMapping' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, OutputMapping) == 0x000258, "Member 'FAnimNode_ControlRig::OutputMapping' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRig_ExternalSource) == 0x000170, "Wrong size on FAnimNode_ControlRig_ExternalSource");
static_assert(offsetof(FAnimNode_ControlRig_ExternalSource, ControlRig) == 0x000168, "Member 'FAnimNode_ControlRig_ExternalSource::ControlRig' has a wrong offset!");
...
{
public:
	class FName                                   Joint;                                             // 0x0028(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAimMode                                      AimMode;                                           // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAimMode                                      UpMode;                                            // 0x0031(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_32[0x2];                                       // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                AimVector;                                         // 0x0034(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                UpVector;                                          // 0x0040(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAimTarget>                     AimTargets;                                        // 0x0050(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FAimTarget>                     UpTargets;                                         // 0x0060(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_70[0x10];                                      // 0x0070(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_AimConstraint) == 0x000008, "Wrong alignment on FRigUnit_AimConstraint");
static_assert(sizeof(FRigUnit_AimConstraint) == 0x000080, "Wrong size on FRigUnit_AimConstraint");
static_assert(offsetof(FRigUnit_AimConstraint, Joint) == 0x000028, "Member 'FRigUnit_AimConstraint::Joint' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, AimMode) == 0x000030, "Member 'FRigUnit_AimConstraint::AimMode' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, UpMode) == 0x000031, "Member 'FRigUnit_AimConstraint::UpMode' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, AimVector) == 0x000034, "Member 'FRigUnit_AimConstraint::AimVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, UpVector) == 0x000040, "Member 'FRigUnit_AimConstraint::UpVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, AimTargets) == 0x000050, "Member 'FRigUnit_AimConstraint::AimTargets' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, UpTargets) == 0x000060, "Member 'FRigUnit_AimConstraint::UpTargets' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneControlRigParameterTemplate) == 0x000060, "Wrong size on FMovieSceneControlRigParameterTemplate");
...
{
public:
	class FName                                   ParentName;                                        // 0x0018(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FTransform                             InitialTransform;                                  // 0x0030(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             GlobalTransform;                                   // 0x0060(0x0030)(Edit, Transient, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             LocalTransform;                                    // 0x0090(0x0030)(Edit, Transient, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 Dependents;                                        // 0x00C0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	ERigBoneType                                  Type;                                              // 0x00D0(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigBone>                       Bones;                                             // 0x0008(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, int32>                      NameToIndexMapping;                                // 0x0018(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FRigBoneHierarchy) == 0x000008, "Wrong alignment on FRigBoneHierarchy");
static_assert(sizeof(FRigBoneHierarchy) == 0x000068, "Wrong size on FRigBoneHierarchy");
...
{
public:
	ERigControlType                               ControlType;                                       // 0x0018(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   ParentName;                                        // 0x001C(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FName                                   SpaceName;                                         // 0x0028(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SpaceIndex;                                        // 0x0030(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0xC];                                       // 0x0034(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigControlValue                       InitialValue;                                      // 0x0040(0x0030)(Edit, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	struct FRigControlValue                       Value;                                             // 0x0070(0x0030)(Edit, Transient, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 Dependents;                                        // 0x00A0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigControl) == 0x000010, "Wrong alignment on FRigControl");
static_assert(sizeof(FRigControl) == 0x0000B0, "Wrong size on FRigControl");
...
static_assert(offsetof(FRigControl, Dependents) == 0x0000A0, "Member 'FRigControl::Dependents' has a wrong offset!");
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigControl>                    Controls;                                          // 0x0008(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, int32>                      NameToIndexMapping;                                // 0x0018(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
...
{
public:
	float                                         Value;                                             // 0x0018(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigCurve>                      Curves;                                            // 0x0008(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, int32>                      NameToIndexMapping;                                // 0x0018(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FRigCurveContainer) == 0x000008, "Wrong alignment on FRigCurveContainer");
static_assert(sizeof(FRigCurveContainer) == 0x000068, "Wrong size on FRigCurveContainer");
...
public:
	class FName                                   Space;                                             // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBoneGetterSetterMode                         SpaceType;                                         // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Transform;                                         // 0x0030(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         CachedSpaceIndex;                                  // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_GetSpaceTransform, Space) == 0x000020, "Member 'FRigUnit_GetSpaceTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetSpaceTransform, SpaceType) == 0x000028, "Member 'FRigUnit_GetSpaceTransform::SpaceType' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetSpaceTransform, Transform) == 0x000030, "Member 'FRigUnit_GetSpaceTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetSpaceTransform, CachedSpaceIndex) == 0x000060, "Member 'FRigUnit_GetSpaceTransform::CachedSpaceIndex' has a wrong offset!");
...
{
public:
	ERigSpaceType                                 SpaceType;                                         // 0x0018(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   ParentName;                                        // 0x001C(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ParentIndex;                                       // 0x0024(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigSpace>                      Spaces;                                            // 0x0008(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, int32>                      NameToIndexMapping;                                // 0x0018(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FRigBoneHierarchy                      BoneHierarchy;                                     // 0x0000(0x0068)(NativeAccessSpecifierPublic)
	struct FRigSpaceHierarchy                     SpaceHierarchy;                                    // 0x0068(0x0068)(NativeAccessSpecifierPublic)
	struct FRigControlHierarchy                   ControlHierarchy;                                  // 0x00D0(0x0068)(NativeAccessSpecifierPublic)
	struct FRigCurveContainer                     CurveContainer;                                    // 0x0138(0x0068)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigHierarchyContainer) == 0x000008, "Wrong alignment on FRigHierarchyContainer");
static_assert(sizeof(FRigHierarchyContainer) == 0x0001A0, "Wrong size on FRigHierarchyContainer");
...
static_assert(offsetof(FRigHierarchyContainer, SpaceHierarchy) == 0x000068, "Member 'FRigHierarchyContainer::SpaceHierarchy' has a wrong offset!");
static_assert(offsetof(FRigHierarchyContainer, ControlHierarchy) == 0x0000D0, "Member 'FRigHierarchyContainer::ControlHierarchy' has a wrong offset!");
static_assert(offsetof(FRigHierarchyContainer, CurveContainer) == 0x000138, "Member 'FRigHierarchyContainer::CurveContainer' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_AddBoneTransform, Bone) == 0x000028, "Member 'FRigUnit_AddBoneTransform::Bone' has a wrong offset!");
...
public:
	class FName                                   Bone;                                              // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigUnit_AimBone_Target                Primary;                                           // 0x0030(0x0028)(NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_AimBone_Target                Secondary;                                         // 0x0058(0x0028)(NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FRigUnit_AimBone_DebugSettings         DebugSettings;                                     // 0x0090(0x0040)(NoDestructor, NativeAccessSpecifierPublic)
	int32                                         BoneIndex;                                         // 0x00D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PrimaryCachedSpaceName;                            // 0x00D4(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PrimaryCachedSpaceIndex;                           // 0x00DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SecondaryCachedSpaceName;                          // 0x00E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SecondaryCachedSpaceIndex;                         // 0x00E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_EC[0x4];                                       // 0x00EC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_AimBone) == 0x000010, "Wrong alignment on FRigUnit_AimBone");
static_assert(sizeof(FRigUnit_AimBone) == 0x0000F0, "Wrong size on FRigUnit_AimBone");
static_assert(offsetof(FRigUnit_AimBone, Bone) == 0x000028, "Member 'FRigUnit_AimBone::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, Primary) == 0x000030, "Member 'FRigUnit_AimBone::Primary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, Secondary) == 0x000058, "Member 'FRigUnit_AimBone::Secondary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, bPropagateToChildren) == 0x000080, "Member 'FRigUnit_AimBone::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, DebugSettings) == 0x000090, "Member 'FRigUnit_AimBone::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, BoneIndex) == 0x0000D0, "Member 'FRigUnit_AimBone::BoneIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, PrimaryCachedSpaceName) == 0x0000D4, "Member 'FRigUnit_AimBone::PrimaryCachedSpaceName' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, PrimaryCachedSpaceIndex) == 0x0000DC, "Member 'FRigUnit_AimBone::PrimaryCachedSpaceIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, SecondaryCachedSpaceName) == 0x0000E0, "Member 'FRigUnit_AimBone::SecondaryCachedSpaceName' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, SecondaryCachedSpaceIndex) == 0x0000E8, "Member 'FRigUnit_AimBone::SecondaryCachedSpaceIndex' has a wrong offset!");
...
public:
	float                                         Value;                                             // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMapRange;                                         // 0x0024(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClampResult;                                      // 0x0025(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bInterpResult;                                     // 0x0026(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_27[0x1];                                       // 0x0027(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInputRange                            InRange;                                           // 0x0028(0x0008)(NoDestructor, NativeAccessSpecifierPublic)
	struct FInputRange                            OutRange;                                          // 0x0030(0x0008)(NoDestructor, NativeAccessSpecifierPublic)
	float                                         Scale;                                             // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Bias;                                              // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         InterpSpeedIncreasing;                             // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InterpSpeedDecreasing;                             // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_AlphaInterp) == 0x000088, "Wrong size on FRigUnit_AlphaInterp");
static_assert(offsetof(FRigUnit_AlphaInterp, Value) == 0x000020, "Member 'FRigUnit_AlphaInterp::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, bMapRange) == 0x000024, "Member 'FRigUnit_AlphaInterp::bMapRange' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, bClampResult) == 0x000025, "Member 'FRigUnit_AlphaInterp::bClampResult' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, bInterpResult) == 0x000026, "Member 'FRigUnit_AlphaInterp::bInterpResult' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, InRange) == 0x000028, "Member 'FRigUnit_AlphaInterp::InRange' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, OutRange) == 0x000030, "Member 'FRigUnit_AlphaInterp::OutRange' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, Scale) == 0x000038, "Member 'FRigUnit_AlphaInterp::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, Bias) == 0x00003C, "Member 'FRigUnit_AlphaInterp::Bias' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, ClampMin) == 0x000040, "Member 'FRigUnit_AlphaInterp::ClampMin' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, ClampMax) == 0x000044, "Member 'FRigUnit_AlphaInterp::ClampMax' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, InterpSpeedIncreasing) == 0x000048, "Member 'FRigUnit_AlphaInterp::InterpSpeedIncreasing' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, InterpSpeedDecreasing) == 0x00004C, "Member 'FRigUnit_AlphaInterp::InterpSpeedDecreasing' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, Result) == 0x000050, "Member 'FRigUnit_AlphaInterp::Result' has a wrong offset!");
static_assert(offsetof(FRigUnit_AlphaInterp, ScaleBiasClamp) == 0x000054, "Member 'FRigUnit_AlphaInterp::ScaleBiasClamp' has a wrong offset!");
...
{
public:
	class FName                                   Joint;                                             // 0x0028(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             Transform;                                         // 0x0030(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_ApplyFK, Joint) == 0x000028, "Member 'FRigUnit_ApplyFK::Joint' has a wrong offset!");
...
{
public:
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0020(0x0008)(Edit, Transient, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_BeginExecution) == 0x000008, "Wrong alignment on FRigUnit_BeginExecution");
static_assert(sizeof(FRigUnit_BeginExecution) == 0x000028, "Wrong size on FRigUnit_BeginExecution");
...
{
public:
	TArray<struct FRigUnit_BoneHarmonics_BoneTarget> Bones;                                             // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FVector                                WaveSpeed;                                         // 0x0038(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WaveFrequency;                                     // 0x0044(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WaveAmplitude;                                     // 0x0050(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WaveOffset;                                        // 0x005C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                WaveNoise;                                         // 0x0068(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControlRigAnimEasingType                     WaveEase;                                          // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WaveMinimum;                                       // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WaveMaximum;                                       // 0x007C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControlRigRotationOrder                      RotationOrder;                                     // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FRigUnit_BoneHarmonics_WorkData        WorkData;                                          // 0x0088(0x0020)(Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_BoneHarmonics) == 0x000008, "Wrong alignment on FRigUnit_BoneHarmonics");
static_assert(sizeof(FRigUnit_BoneHarmonics) == 0x0000A8, "Wrong size on FRigUnit_BoneHarmonics");
static_assert(offsetof(FRigUnit_BoneHarmonics, Bones) == 0x000028, "Member 'FRigUnit_BoneHarmonics::Bones' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveSpeed) == 0x000038, "Member 'FRigUnit_BoneHarmonics::WaveSpeed' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveFrequency) == 0x000044, "Member 'FRigUnit_BoneHarmonics::WaveFrequency' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveAmplitude) == 0x000050, "Member 'FRigUnit_BoneHarmonics::WaveAmplitude' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveOffset) == 0x00005C, "Member 'FRigUnit_BoneHarmonics::WaveOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveNoise) == 0x000068, "Member 'FRigUnit_BoneHarmonics::WaveNoise' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveEase) == 0x000074, "Member 'FRigUnit_BoneHarmonics::WaveEase' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveMinimum) == 0x000078, "Member 'FRigUnit_BoneHarmonics::WaveMinimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveMaximum) == 0x00007C, "Member 'FRigUnit_BoneHarmonics::WaveMaximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, RotationOrder) == 0x000080, "Member 'FRigUnit_BoneHarmonics::RotationOrder' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, bPropagateToChildren) == 0x000081, "Member 'FRigUnit_BoneHarmonics::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WorkData) == 0x000088, "Member 'FRigUnit_BoneHarmonics::WorkData' has a wrong offset!");
...
public:
	...
	TArray<float>                                 RotationLimitsPerBone;                             // 0x0030(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	class FName                                   StartBone;                                         // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FTransform                             EffectorTransform;                                 // 0x0040(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Precision;                                         // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Weight;                                            // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxIterations;                                     // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStartFromTail;                                    // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7D[0x3];                                       // 0x007D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         BaseRotationLimit;                                 // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigUnit_CCDIK_RotationLimit>   RotationLimits;                                    // 0x0088(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	struct FRigUnit_CCDIK_WorkData                WorkData;                                          // 0x00A0(0x0048)(Transient, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_CCDIK, StartBone) == 0x000028, "Member 'FRigUnit_CCDIK::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, EffectorBone) == 0x000030, "Member 'FRigUnit_CCDIK::EffectorBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, EffectorTransform) == 0x000040, "Member 'FRigUnit_CCDIK::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, Precision) == 0x000070, "Member 'FRigUnit_CCDIK::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, Weight) == 0x000074, "Member 'FRigUnit_CCDIK::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, MaxIterations) == 0x000078, "Member 'FRigUnit_CCDIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, bStartFromTail) == 0x00007C, "Member 'FRigUnit_CCDIK::bStartFromTail' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, BaseRotationLimit) == 0x000080, "Member 'FRigUnit_CCDIK::BaseRotationLimit' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, RotationLimits) == 0x000088, "Member 'FRigUnit_CCDIK::RotationLimits' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, bPropagateToChildren) == 0x000098, "Member 'FRigUnit_CCDIK::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, WorkData) == 0x0000A0, "Member 'FRigUnit_CCDIK::WorkData' has a wrong offset!");
...
public:
	...
	TArray<int32>                                 Bones;                                             // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	class FName                                   ChainRoot;                                         // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Speed;                                             // 0x0030(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigUnit_ChainHarmonics_Reach          Reach;                                             // 0x003C(0x0028)(NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_ChainHarmonics_Wave           Wave;                                              // 0x0064(0x0040)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_A4[0x4];                                       // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     WaveCurve;                                         // 0x00A8(0x0088)(NativeAccessSpecifierPublic)
	struct FRigUnit_ChainHarmonics_Pendulum       Pendulum;                                          // 0x0130(0x003C)(NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bDrawDebug;                                        // 0x016C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_ChainHarmonics, ChainRoot) == 0x000028, "Member 'FRigUnit_ChainHarmonics::ChainRoot' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Speed) == 0x000030, "Member 'FRigUnit_ChainHarmonics::Speed' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Reach) == 0x00003C, "Member 'FRigUnit_ChainHarmonics::Reach' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Wave) == 0x000064, "Member 'FRigUnit_ChainHarmonics::Wave' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, WaveCurve) == 0x0000A8, "Member 'FRigUnit_ChainHarmonics::WaveCurve' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Pendulum) == 0x000130, "Member 'FRigUnit_ChainHarmonics::Pendulum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, bDrawDebug) == 0x00016C, "Member 'FRigUnit_ChainHarmonics::bDrawDebug' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugBaseMutable) == 0x000028, "Wrong size on FRigUnit_DebugBaseMutable");
...
{
public:
	struct FCRFourPointBezier                     Bezier;                                            // 0x0028(0x0030)(NoDestructor, NativeAccessSpecifierPublic)
	float                                         MinimumU;                                          // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumU;                                          // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         Detail;                                            // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Space;                                             // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_DebugBezier, Bezier) == 0x000028, "Member 'FRigUnit_DebugBezier::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, MinimumU) == 0x000058, "Member 'FRigUnit_DebugBezier::MinimumU' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, MaximumU) == 0x00005C, "Member 'FRigUnit_DebugBezier::MaximumU' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Color) == 0x000060, "Member 'FRigUnit_DebugBezier::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Thickness) == 0x000070, "Member 'FRigUnit_DebugBezier::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Detail) == 0x000074, "Member 'FRigUnit_DebugBezier::Detail' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Space) == 0x000078, "Member 'FRigUnit_DebugBezier::Space' has a wrong offset!");
...
{
public:
	EControlRigDrawHierarchyMode                  Mode;                                              // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FRigUnit_DebugHierarchy) == 0x000090, "Wrong size on FRigUnit_DebugHierarchy");
static_assert(offsetof(FRigUnit_DebugHierarchy, Mode) == 0x000028, "Member 'FRigUnit_DebugHierarchy::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, Scale) == 0x00002C, "Member 'FRigUnit_DebugHierarchy::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, Color) == 0x000030, "Member 'FRigUnit_DebugHierarchy::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, Thickness) == 0x000040, "Member 'FRigUnit_DebugHierarchy::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, WorldOffset) == 0x000050, "Member 'FRigUnit_DebugHierarchy::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, bEnabled) == 0x000080, "Member 'FRigUnit_DebugHierarchy::bEnabled' has a wrong offset!");
...
{
public:
	struct FVector                                A;                                                 // 0x0028(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                B;                                                 // 0x0034(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FName                                   Space;                                             // 0x0054(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_DebugLine, A) == 0x000028, "Member 'FRigUnit_DebugLine::A' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, B) == 0x000034, "Member 'FRigUnit_DebugLine::B' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, Color) == 0x000040, "Member 'FRigUnit_DebugLine::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, Thickness) == 0x000050, "Member 'FRigUnit_DebugLine::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, Space) == 0x000054, "Member 'FRigUnit_DebugLine::Space' has a wrong offset!");
...
{
public:
	TArray<struct FVector>                        Points;                                            // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_DebugLineStrip) == 0x0000A0, "Wrong size on FRigUnit_DebugLineStrip");
static_assert(offsetof(FRigUnit_DebugLineStrip, Points) == 0x000028, "Member 'FRigUnit_DebugLineStrip::Points' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, Color) == 0x000038, "Member 'FRigUnit_DebugLineStrip::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, Thickness) == 0x000048, "Member 'FRigUnit_DebugLineStrip::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, Space) == 0x00004C, "Member 'FRigUnit_DebugLineStrip::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, WorldOffset) == 0x000060, "Member 'FRigUnit_DebugLineStrip::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, bEnabled) == 0x000090, "Member 'FRigUnit_DebugLineStrip::bEnabled' has a wrong offset!");
...
{
public:
	struct FVector                                Vector;                                            // 0x0028(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERigUnitDebugPointMode                        Mode;                                              // 0x0034(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         Thickness;                                         // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Space;                                             // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_DebugPointMutable) == 0x0000A0, "Wrong size on FRigUnit_DebugPointMutable");
static_assert(offsetof(FRigUnit_DebugPointMutable, Vector) == 0x000028, "Member 'FRigUnit_DebugPointMutable::Vector' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Mode) == 0x000034, "Member 'FRigUnit_DebugPointMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Color) == 0x000038, "Member 'FRigUnit_DebugPointMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Scale) == 0x000048, "Member 'FRigUnit_DebugPointMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Thickness) == 0x00004C, "Member 'FRigUnit_DebugPointMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Space) == 0x000050, "Member 'FRigUnit_DebugPointMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, WorldOffset) == 0x000060, "Member 'FRigUnit_DebugPointMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, bEnabled) == 0x000090, "Member 'FRigUnit_DebugPointMutable::bEnabled' has a wrong offset!");
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0030(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FLinearColor                           Color;                                             // 0x0060(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Radius;                                            // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinimumDegrees;                                    // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumDegrees;                                    // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         Detail;                                            // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Space;                                             // 0x0084(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_DebugArc) == 0x0000D0, "Wrong size on FRigUnit_DebugArc");
static_assert(offsetof(FRigUnit_DebugArc, Transform) == 0x000030, "Member 'FRigUnit_DebugArc::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Color) == 0x000060, "Member 'FRigUnit_DebugArc::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Radius) == 0x000070, "Member 'FRigUnit_DebugArc::Radius' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, MinimumDegrees) == 0x000074, "Member 'FRigUnit_DebugArc::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, MaximumDegrees) == 0x000078, "Member 'FRigUnit_DebugArc::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Thickness) == 0x00007C, "Member 'FRigUnit_DebugArc::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Detail) == 0x000080, "Member 'FRigUnit_DebugArc::Detail' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Space) == 0x000084, "Member 'FRigUnit_DebugArc::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, WorldOffset) == 0x000090, "Member 'FRigUnit_DebugArc::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, bEnabled) == 0x0000C0, "Member 'FRigUnit_DebugArc::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugRectangle) == 0x0000C0, "Wrong size on FRigUnit_DebugRectangle");
static_assert(offsetof(FRigUnit_DebugRectangle, Transform) == 0x000030, "Member 'FRigUnit_DebugRectangle::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Color) == 0x000060, "Member 'FRigUnit_DebugRectangle::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Scale) == 0x000070, "Member 'FRigUnit_DebugRectangle::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Thickness) == 0x000074, "Member 'FRigUnit_DebugRectangle::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Space) == 0x000078, "Member 'FRigUnit_DebugRectangle::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, WorldOffset) == 0x000080, "Member 'FRigUnit_DebugRectangle::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, bEnabled) == 0x0000B0, "Member 'FRigUnit_DebugRectangle::bEnabled' has a wrong offset!");
...
public:
	...
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         Thickness;                                         // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Scale;                                             // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Space;                                             // 0x0054(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             WorldOffset;                                       // 0x0060(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bEnabled;                                          // 0x0090(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Transforms) == 0x000028, "Member 'FRigUnit_DebugTransformArrayMutable::Transforms' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Mode) == 0x000038, "Member 'FRigUnit_DebugTransformArrayMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Color) == 0x00003C, "Member 'FRigUnit_DebugTransformArrayMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Thickness) == 0x00004C, "Member 'FRigUnit_DebugTransformArrayMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Scale) == 0x000050, "Member 'FRigUnit_DebugTransformArrayMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Space) == 0x000054, "Member 'FRigUnit_DebugTransformArrayMutable::Space' has a wrong offset!");
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Transform;                                         // 0x0030(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           Color;                                             // 0x0064(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Scale;                                             // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Space;                                             // 0x007C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_DebugTransformMutable) == 0x0000D0, "Wrong size on FRigUnit_DebugTransformMutable");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Transform) == 0x000030, "Member 'FRigUnit_DebugTransformMutable::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Mode) == 0x000060, "Member 'FRigUnit_DebugTransformMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Color) == 0x000064, "Member 'FRigUnit_DebugTransformMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Thickness) == 0x000074, "Member 'FRigUnit_DebugTransformMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Scale) == 0x000078, "Member 'FRigUnit_DebugTransformMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Space) == 0x00007C, "Member 'FRigUnit_DebugTransformMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, WorldOffset) == 0x000090, "Member 'FRigUnit_DebugTransformMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, bEnabled) == 0x0000C0, "Member 'FRigUnit_DebugTransformMutable::bEnabled' has a wrong offset!");
...
public:
	struct FVector                                Value;                                             // 0x0020(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAxis                                         Axis;                                              // 0x002C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControlRigClampSpatialMode                   Type;                                              // 0x002D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E[0x2];                                       // 0x002E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Minimum;                                           // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Maximum;                                           // 0x0034(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Space;                                             // 0x0040(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bDrawDebug;                                        // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           DebugColor;                                        // 0x0074(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DebugThickness;                                    // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Result;                                            // 0x0088(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_MathVectorClampSpatially) == 0x0000A0, "Wrong size on FRigUnit_MathVectorClampSpatially");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Value) == 0x000020, "Member 'FRigUnit_MathVectorClampSpatially::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Axis) == 0x00002C, "Member 'FRigUnit_MathVectorClampSpatially::Axis' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Type) == 0x00002D, "Member 'FRigUnit_MathVectorClampSpatially::Type' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Minimum) == 0x000030, "Member 'FRigUnit_MathVectorClampSpatially::Minimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Maximum) == 0x000034, "Member 'FRigUnit_MathVectorClampSpatially::Maximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Space) == 0x000040, "Member 'FRigUnit_MathVectorClampSpatially::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, bDrawDebug) == 0x000070, "Member 'FRigUnit_MathVectorClampSpatially::bDrawDebug' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, DebugColor) == 0x000074, "Member 'FRigUnit_MathVectorClampSpatially::DebugColor' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, DebugThickness) == 0x000084, "Member 'FRigUnit_MathVectorClampSpatially::DebugThickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampSpatially, Result) == 0x000088, "Member 'FRigUnit_MathVectorClampSpatially::Result' has a wrong offset!");
...
public:
	TArray<int32>                                 BoneIndices;                                       // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BoneRotationA;                                     // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BoneRotationB;                                     // 0x0020(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 BoneRotationT;                                     // 0x0030(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	class FName                                   StartBone;                                         // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   EndBone;                                           // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FRigUnit_DistributeRotation_Rotation> Rotations;                                         // 0x0038(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	EControlRigAnimEasingType                     RotationEaseType;                                  // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPropagateToChildren;                              // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4A[0x6];                                       // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_DistributeRotation_WorkData   WorkData;                                          // 0x0050(0x0050)(Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_DistributeRotation) == 0x000008, "Wrong alignment on FRigUnit_DistributeRotation");
static_assert(sizeof(FRigUnit_DistributeRotation) == 0x0000A0, "Wrong size on FRigUnit_DistributeRotation");
static_assert(offsetof(FRigUnit_DistributeRotation, StartBone) == 0x000028, "Member 'FRigUnit_DistributeRotation::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, EndBone) == 0x000030, "Member 'FRigUnit_DistributeRotation::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, Rotations) == 0x000038, "Member 'FRigUnit_DistributeRotation::Rotations' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, RotationEaseType) == 0x000048, "Member 'FRigUnit_DistributeRotation::RotationEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, bPropagateToChildren) == 0x000049, "Member 'FRigUnit_DistributeRotation::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, WorkData) == 0x000050, "Member 'FRigUnit_DistributeRotation::WorkData' has a wrong offset!");
...
public:
	...
	float                                         Precision;                                         // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Weight;                                            // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPropagateToChildren;                              // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_79[0x3];                                       // 0x0079(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxIterations;                                     // 0x007C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigUnit_FABRIK_WorkData               WorkData;                                          // 0x0080(0x0028)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_FABRIK) == 0x000010, "Wrong alignment on FRigUnit_FABRIK");
static_assert(sizeof(FRigUnit_FABRIK) == 0x0000B0, "Wrong size on FRigUnit_FABRIK");
static_assert(offsetof(FRigUnit_FABRIK, StartBone) == 0x000028, "Member 'FRigUnit_FABRIK::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, EffectorBone) == 0x000030, "Member 'FRigUnit_FABRIK::EffectorBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, EffectorTransform) == 0x000040, "Member 'FRigUnit_FABRIK::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, Precision) == 0x000070, "Member 'FRigUnit_FABRIK::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, Weight) == 0x000074, "Member 'FRigUnit_FABRIK::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, bPropagateToChildren) == 0x000078, "Member 'FRigUnit_FABRIK::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, MaxIterations) == 0x00007C, "Member 'FRigUnit_FABRIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, WorkData) == 0x000080, "Member 'FRigUnit_FABRIK::WorkData' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_MathVectorSetLength, Value) == 0x000020, "Member 'FRigUnit_MathVectorSetLength::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorSetLength, Length) == 0x00002C, "Member 'FRigUnit_MathVectorSetLength::Length' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorSetLength, Result) == 0x000030, "Member 'FRigUnit_MathVectorSetLength::Result' has a wrong offset!");
...
public:
	...
	TArray<struct FVector>                        BonePositions;                                     // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 BoneSegments;                                      // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<int32>                                 BoneIndices;                                       // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BoneRotationA;                                     // 0x0058(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BoneRotationB;                                     // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 BoneRotationT;                                     // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     BoneLocalTransforms;                               // 0x0088(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	EControlRigCurveAlignment                     Alignment;                                         // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_69[0x3];                                       // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Minimum;                                           // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Maximum;                                           // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SamplingPrecision;                                 // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FVector                                PoleVectorPosition;                                // 0x0090(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigUnit_FitChainToCurve_Rotation> Rotations;                                         // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	EControlRigAnimEasingType                     RotationEaseType;                                  // 0x00B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPropagateToChildren;                              // 0x00B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B2[0xE];                                       // 0x00B2(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                                     // 0x00C0(0x0060)(NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_FitChainToCurve_WorkData      WorkData;                                          // 0x0120(0x0098)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_FitChainToCurve) == 0x0001C0, "Wrong size on FRigUnit_FitChainToCurve");
static_assert(offsetof(FRigUnit_FitChainToCurve, StartBone) == 0x000028, "Member 'FRigUnit_FitChainToCurve::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, EndBone) == 0x000030, "Member 'FRigUnit_FitChainToCurve::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Bezier) == 0x000038, "Member 'FRigUnit_FitChainToCurve::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Alignment) == 0x000068, "Member 'FRigUnit_FitChainToCurve::Alignment' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Minimum) == 0x00006C, "Member 'FRigUnit_FitChainToCurve::Minimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Maximum) == 0x000070, "Member 'FRigUnit_FitChainToCurve::Maximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, SamplingPrecision) == 0x000074, "Member 'FRigUnit_FitChainToCurve::SamplingPrecision' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, PrimaryAxis) == 0x000078, "Member 'FRigUnit_FitChainToCurve::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, SecondaryAxis) == 0x000084, "Member 'FRigUnit_FitChainToCurve::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, PoleVectorPosition) == 0x000090, "Member 'FRigUnit_FitChainToCurve::PoleVectorPosition' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Rotations) == 0x0000A0, "Member 'FRigUnit_FitChainToCurve::Rotations' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, RotationEaseType) == 0x0000B0, "Member 'FRigUnit_FitChainToCurve::RotationEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, bPropagateToChildren) == 0x0000B1, "Member 'FRigUnit_FitChainToCurve::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, DebugSettings) == 0x0000C0, "Member 'FRigUnit_FitChainToCurve::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, WorkData) == 0x000120, "Member 'FRigUnit_FitChainToCurve::WorkData' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Transform;                                         // 0x0030(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         CachedControlIndex;                                // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0xC];                                       // 0x0064(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FRigUnit_GetControlInitialTransform, Control) == 0x000020, "Member 'FRigUnit_GetControlInitialTransform::Control' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetControlInitialTransform, Space) == 0x000028, "Member 'FRigUnit_GetControlInitialTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetControlInitialTransform, Transform) == 0x000030, "Member 'FRigUnit_GetControlInitialTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetControlInitialTransform, CachedControlIndex) == 0x000060, "Member 'FRigUnit_GetControlInitialTransform::CachedControlIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_GetControlTransform) == 0x000070, "Wrong size on FRigUnit_GetControlTransform");
static_assert(offsetof(FRigUnit_GetControlTransform, Control) == 0x000020, "Member 'FRigUnit_GetControlTransform::Control' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetControlTransform, Space) == 0x000028, "Member 'FRigUnit_GetControlTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetControlTransform, Transform) == 0x000030, "Member 'FRigUnit_GetControlTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetControlTransform, CachedControlIndex) == 0x000060, "Member 'FRigUnit_GetControlTransform::CachedControlIndex' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_GetCurveValue, Curve) == 0x000020, "Member 'FRigUnit_GetCurveValue::Curve' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetCurveValue, Value) == 0x000028, "Member 'FRigUnit_GetCurveValue::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetCurveValue, CachedCurveIndex) == 0x00002C, "Member 'FRigUnit_GetCurveValue::CachedCurveIndex' has a wrong offset!");
...
{
public:
	class FName                                   Joint;                                             // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETransformGetterType                          Type;                                              // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETransformSpaceMode                           TransformSpace;                                    // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32[0xE];                                       // 0x0032(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             BaseTransform;                                     // 0x0040(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	class FName                                   BaseJoint;                                         // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_78[0x8];                                       // 0x0078(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Output;                                            // 0x0080(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_GetJointTransform) == 0x000010, "Wrong alignment on FRigUnit_GetJointTransform");
static_assert(sizeof(FRigUnit_GetJointTransform) == 0x0000B0, "Wrong size on FRigUnit_GetJointTransform");
static_assert(offsetof(FRigUnit_GetJointTransform, Joint) == 0x000028, "Member 'FRigUnit_GetJointTransform::Joint' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, Type) == 0x000030, "Member 'FRigUnit_GetJointTransform::Type' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, TransformSpace) == 0x000031, "Member 'FRigUnit_GetJointTransform::TransformSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, BaseTransform) == 0x000040, "Member 'FRigUnit_GetJointTransform::BaseTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, BaseJoint) == 0x000070, "Member 'FRigUnit_GetJointTransform::BaseJoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, Output) == 0x000080, "Member 'FRigUnit_GetJointTransform::Output' has a wrong offset!");
...
public:
	struct FTransform                             Value;                                             // 0x0020(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	EAxis                                         Axis;                                              // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControlRigClampSpatialMode                   Type;                                              // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_52[0x2];                                       // 0x0052(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Minimum;                                           // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Maximum;                                           // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Space;                                             // 0x0060(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_MathTransformClampSpatially) == 0x0000E0, "Wrong size on FRigUnit_MathTransformClampSpatially");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Value) == 0x000020, "Member 'FRigUnit_MathTransformClampSpatially::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Axis) == 0x000050, "Member 'FRigUnit_MathTransformClampSpatially::Axis' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Type) == 0x000051, "Member 'FRigUnit_MathTransformClampSpatially::Type' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Minimum) == 0x000054, "Member 'FRigUnit_MathTransformClampSpatially::Minimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Maximum) == 0x000058, "Member 'FRigUnit_MathTransformClampSpatially::Maximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Space) == 0x000060, "Member 'FRigUnit_MathTransformClampSpatially::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, bDrawDebug) == 0x000090, "Member 'FRigUnit_MathTransformClampSpatially::bDrawDebug' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, DebugColor) == 0x000094, "Member 'FRigUnit_MathTransformClampSpatially::DebugColor' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, DebugThickness) == 0x0000A4, "Member 'FRigUnit_MathTransformClampSpatially::DebugThickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformClampSpatially, Result) == 0x0000B0, "Member 'FRigUnit_MathTransformClampSpatially::Result' has a wrong offset!");
...
{
public:
	struct FTransform                             Local;                                             // 0x0020(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             Parent;                                            // 0x0050(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             Global;                                            // 0x0080(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_MathTransformMakeAbsolute) == 0x000010, "Wrong alignment on FRigUnit_MathTransformMakeAbsolute");
static_assert(sizeof(FRigUnit_MathTransformMakeAbsolute) == 0x0000B0, "Wrong size on FRigUnit_MathTransformMakeAbsolute");
static_assert(offsetof(FRigUnit_MathTransformMakeAbsolute, Local) == 0x000020, "Member 'FRigUnit_MathTransformMakeAbsolute::Local' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformMakeAbsolute, Parent) == 0x000050, "Member 'FRigUnit_MathTransformMakeAbsolute::Parent' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathTransformMakeAbsolute, Global) == 0x000080, "Member 'FRigUnit_MathTransformMakeAbsolute::Global' has a wrong offset!");
...
public:
	struct FVector                                Value;                                             // 0x0020(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinimumLength;                                     // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumLength;                                     // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Result;                                            // 0x0034(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FRigUnit_MathVectorClampLength, Value) == 0x000020, "Member 'FRigUnit_MathVectorClampLength::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampLength, MinimumLength) == 0x00002C, "Member 'FRigUnit_MathVectorClampLength::MinimumLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampLength, MaximumLength) == 0x000030, "Member 'FRigUnit_MathVectorClampLength::MaximumLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathVectorClampLength, Result) == 0x000034, "Member 'FRigUnit_MathVectorClampLength::Result' has a wrong offset!");
...
{
public:
	TArray<int32>                                 CachedBoneIndices;                                 // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FRigUnit_ModifyBoneTransforms_PerBone> BoneToModify;                                      // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         Weight;                                            // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WeightMinimum;                                     // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WeightMaximum;                                     // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControlRigModifyBoneMode                     Mode;                                              // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_ModifyBoneTransforms_WorkData WorkData;                                          // 0x0048(0x0010)(Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_ModifyBoneTransforms) == 0x000008, "Wrong alignment on FRigUnit_ModifyBoneTransforms");
static_assert(sizeof(FRigUnit_ModifyBoneTransforms) == 0x000058, "Wrong size on FRigUnit_ModifyBoneTransforms");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, BoneToModify) == 0x000028, "Member 'FRigUnit_ModifyBoneTransforms::BoneToModify' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, Weight) == 0x000038, "Member 'FRigUnit_ModifyBoneTransforms::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, WeightMinimum) == 0x00003C, "Member 'FRigUnit_ModifyBoneTransforms::WeightMinimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, WeightMaximum) == 0x000040, "Member 'FRigUnit_ModifyBoneTransforms::WeightMaximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, Mode) == 0x000044, "Member 'FRigUnit_ModifyBoneTransforms::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, WorkData) == 0x000048, "Member 'FRigUnit_ModifyBoneTransforms::WorkData' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SimBaseMutable) == 0x000028, "Wrong size on FRigUnit_SimBaseMutable");
...
public:
	...
	TArray<int32>                                 BoneIndices;                                       // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FCRSimPoint>                    Points;                                            // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCRSimLinearSpring>             Links;                                             // 0x0038(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCRSimPointForce>               Forces;                                            // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCRSimSoftCollision>            CollisionVolumes;                                  // 0x0058(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         SimulatedStepsPerSecond;                           // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECRSimPointIntegrateType                      IntegratorType;                                    // 0x006C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D[0x3];                                       // 0x006D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VerletBlend;                                       // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigUnit_PointSimulation_BoneTarget> BoneTargets;                                       // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bLimitLocalPosition;                               // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPropagateToChildren;                              // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8A[0x2];                                       // 0x008A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                PrimaryAimAxis;                                    // 0x008C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SecondaryAimAxis;                                  // 0x0098(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A4[0xC];                                       // 0x00A4(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_PointSimulation_DebugSettings DebugSettings;                                     // 0x00B0(0x0050)(NoDestructor, NativeAccessSpecifierPublic)
	struct FCRFourPointBezier                     Bezier;                                            // 0x0100(0x0030)(NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_PointSimulation_WorkData      WorkData;                                          // 0x0130(0x0088)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_PointSimulation) == 0x000010, "Wrong alignment on FRigUnit_PointSimulation");
static_assert(sizeof(FRigUnit_PointSimulation) == 0x0001C0, "Wrong size on FRigUnit_PointSimulation");
static_assert(offsetof(FRigUnit_PointSimulation, Points) == 0x000028, "Member 'FRigUnit_PointSimulation::Points' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, Links) == 0x000038, "Member 'FRigUnit_PointSimulation::Links' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, Forces) == 0x000048, "Member 'FRigUnit_PointSimulation::Forces' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, CollisionVolumes) == 0x000058, "Member 'FRigUnit_PointSimulation::CollisionVolumes' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, SimulatedStepsPerSecond) == 0x000068, "Member 'FRigUnit_PointSimulation::SimulatedStepsPerSecond' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, IntegratorType) == 0x00006C, "Member 'FRigUnit_PointSimulation::IntegratorType' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, VerletBlend) == 0x000070, "Member 'FRigUnit_PointSimulation::VerletBlend' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, BoneTargets) == 0x000078, "Member 'FRigUnit_PointSimulation::BoneTargets' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, bLimitLocalPosition) == 0x000088, "Member 'FRigUnit_PointSimulation::bLimitLocalPosition' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, bPropagateToChildren) == 0x000089, "Member 'FRigUnit_PointSimulation::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, PrimaryAimAxis) == 0x00008C, "Member 'FRigUnit_PointSimulation::PrimaryAimAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, SecondaryAimAxis) == 0x000098, "Member 'FRigUnit_PointSimulation::SecondaryAimAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, DebugSettings) == 0x0000B0, "Member 'FRigUnit_PointSimulation::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, Bezier) == 0x000100, "Member 'FRigUnit_PointSimulation::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, WorkData) == 0x000130, "Member 'FRigUnit_PointSimulation::WorkData' has a wrong offset!");
...
{
public:
	int32                                         NumberOfMeasurements;                              // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Prefix;                                            // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AccumulatedTime;                                   // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MeasurementsLeft;                                  // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_EndProfilingTimer) == 0x000008, "Wrong alignment on FRigUnit_EndProfilingTimer");
static_assert(sizeof(FRigUnit_EndProfilingTimer) == 0x000048, "Wrong size on FRigUnit_EndProfilingTimer");
static_assert(offsetof(FRigUnit_EndProfilingTimer, NumberOfMeasurements) == 0x000028, "Member 'FRigUnit_EndProfilingTimer::NumberOfMeasurements' has a wrong offset!");
static_assert(offsetof(FRigUnit_EndProfilingTimer, Prefix) == 0x000030, "Member 'FRigUnit_EndProfilingTimer::Prefix' has a wrong offset!");
static_assert(offsetof(FRigUnit_EndProfilingTimer, AccumulatedTime) == 0x000040, "Member 'FRigUnit_EndProfilingTimer::AccumulatedTime' has a wrong offset!");
static_assert(offsetof(FRigUnit_EndProfilingTimer, MeasurementsLeft) == 0x000044, "Member 'FRigUnit_EndProfilingTimer::MeasurementsLeft' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_StartProfilingTimer) == 0x000028, "Wrong size on FRigUnit_StartProfilingTimer");
...
static_assert(offsetof(FRigUnit_SetBoneRotation, Bone) == 0x000028, "Member 'FRigUnit_SetBoneRotation::Bone' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_SetBoneTransform, Bone) == 0x000028, "Member 'FRigUnit_SetBoneTransform::Bone' has a wrong offset!");
...
public:
	class FName                                   Bone;                                              // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Translation;                                       // 0x0030(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBoneGetterSetterMode                         Space;                                             // 0x003C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Weight;                                            // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPropagateToChildren;                              // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CachedBoneIndex;                                   // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_SetBoneTranslation) == 0x000008, "Wrong alignment on FRigUnit_SetBoneTranslation");
static_assert(sizeof(FRigUnit_SetBoneTranslation) == 0x000050, "Wrong size on FRigUnit_SetBoneTranslation");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Bone) == 0x000028, "Member 'FRigUnit_SetBoneTranslation::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Translation) == 0x000030, "Member 'FRigUnit_SetBoneTranslation::Translation' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Space) == 0x00003C, "Member 'FRigUnit_SetBoneTranslation::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Weight) == 0x000040, "Member 'FRigUnit_SetBoneTranslation::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, bPropagateToChildren) == 0x000044, "Member 'FRigUnit_SetBoneTranslation::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, CachedBoneIndex) == 0x000048, "Member 'FRigUnit_SetBoneTranslation::CachedBoneIndex' has a wrong offset!");
...
{
public:
	class FName                                   Control;                                           // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             Transform;                                         // 0x0030(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	EBoneGetterSetterMode                         Space;                                             // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(FRigUnit_SetControlTransform, Control) == 0x000028, "Member 'FRigUnit_SetControlTransform::Control' has a wrong offset!");
...
{
public:
	class FName                                   Curve;                                             // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Value;                                             // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CachedCurveIndex;                                  // 0x0034(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FRigUnit_SetCurveValue) == 0x000008, "Wrong alignment on FRigUnit_SetCurveValue");
static_assert(sizeof(FRigUnit_SetCurveValue) == 0x000038, "Wrong size on FRigUnit_SetCurveValue");
static_assert(offsetof(FRigUnit_SetCurveValue, Curve) == 0x000028, "Member 'FRigUnit_SetCurveValue::Curve' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetCurveValue, Value) == 0x000030, "Member 'FRigUnit_SetCurveValue::Value' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetCurveValue, CachedCurveIndex) == 0x000034, "Member 'FRigUnit_SetCurveValue::CachedCurveIndex' has a wrong offset!");
...
public:
	...
	bool                                          bPropagateToChildren;                              // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CachedBoneIndex;                                   // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CachedSpaceIndex;                                  // 0x007C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_SetRelativeBoneTransform) == 0x000010, "Wrong alignment on FRigUnit_SetRelativeBoneTransform");
static_assert(sizeof(FRigUnit_SetRelativeBoneTransform) == 0x000080, "Wrong size on FRigUnit_SetRelativeBoneTransform");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Bone) == 0x000028, "Member 'FRigUnit_SetRelativeBoneTransform::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Space) == 0x000030, "Member 'FRigUnit_SetRelativeBoneTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Transform) == 0x000040, "Member 'FRigUnit_SetRelativeBoneTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Weight) == 0x000070, "Member 'FRigUnit_SetRelativeBoneTransform::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, bPropagateToChildren) == 0x000074, "Member 'FRigUnit_SetRelativeBoneTransform::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, CachedBoneIndex) == 0x000078, "Member 'FRigUnit_SetRelativeBoneTransform::CachedBoneIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, CachedSpaceIndex) == 0x00007C, "Member 'FRigUnit_SetRelativeBoneTransform::CachedSpaceIndex' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_SetSpaceTransform, Space) == 0x000028, "Member 'FRigUnit_SetSpaceTransform::Space' has a wrong offset!");
...
public:
	float                                         ChainLength;                                       // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 BoneSegments;                                      // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 BoneIndices;                                       // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     Transforms;                                        // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	class FName                                   StartBone;                                         // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   EndBone;                                           // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SlideAmount;                                       // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_SlideChain_WorkData           WorkData;                                          // 0x0040(0x0048)(Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_SlideChain) == 0x000008, "Wrong alignment on FRigUnit_SlideChain");
static_assert(sizeof(FRigUnit_SlideChain) == 0x000088, "Wrong size on FRigUnit_SlideChain");
static_assert(offsetof(FRigUnit_SlideChain, StartBone) == 0x000028, "Member 'FRigUnit_SlideChain::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, EndBone) == 0x000030, "Member 'FRigUnit_SlideChain::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, SlideAmount) == 0x000038, "Member 'FRigUnit_SlideChain::SlideAmount' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, bPropagateToChildren) == 0x00003C, "Member 'FRigUnit_SlideChain::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, WorkData) == 0x000040, "Member 'FRigUnit_SlideChain::WorkData' has a wrong offset!");
...
public:
	class FName                                   StartBone;                                         // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   EndBone;                                           // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HierarchyStrength;                                 // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EffectorStrength;                                  // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EffectorRatio;                                     // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RootStrength;                                      // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RootRatio;                                         // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Damping;                                           // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PoleVector;                                        // 0x0050(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlipPolePlane;                                    // 0x005C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControlRigVectorKind                         PoleVectorKind;                                    // 0x005D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5E[0x2];                                       // 0x005E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   PoleVectorSpace;                                   // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PrimaryAxis;                                       // 0x0068(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                SecondaryAxis;                                     // 0x0074(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLiveSimulation;                                   // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Iterations;                                        // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLimitLocalPosition;                               // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPropagateToChildren;                              // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_SpringIK, StartBone) == 0x000028, "Member 'FRigUnit_SpringIK::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, EndBone) == 0x000030, "Member 'FRigUnit_SpringIK::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, HierarchyStrength) == 0x000038, "Member 'FRigUnit_SpringIK::HierarchyStrength' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, EffectorStrength) == 0x00003C, "Member 'FRigUnit_SpringIK::EffectorStrength' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, EffectorRatio) == 0x000040, "Member 'FRigUnit_SpringIK::EffectorRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, RootStrength) == 0x000044, "Member 'FRigUnit_SpringIK::RootStrength' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, RootRatio) == 0x000048, "Member 'FRigUnit_SpringIK::RootRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, Damping) == 0x00004C, "Member 'FRigUnit_SpringIK::Damping' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, PoleVector) == 0x000050, "Member 'FRigUnit_SpringIK::PoleVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, bFlipPolePlane) == 0x00005C, "Member 'FRigUnit_SpringIK::bFlipPolePlane' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, PoleVectorKind) == 0x00005D, "Member 'FRigUnit_SpringIK::PoleVectorKind' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, PoleVectorSpace) == 0x000060, "Member 'FRigUnit_SpringIK::PoleVectorSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, PrimaryAxis) == 0x000068, "Member 'FRigUnit_SpringIK::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, SecondaryAxis) == 0x000074, "Member 'FRigUnit_SpringIK::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, bLiveSimulation) == 0x000080, "Member 'FRigUnit_SpringIK::bLiveSimulation' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, Iterations) == 0x000084, "Member 'FRigUnit_SpringIK::Iterations' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, bLimitLocalPosition) == 0x000088, "Member 'FRigUnit_SpringIK::bLimitLocalPosition' has a wrong offset!");
static_assert(offsetof(FRigUnit_SpringIK, bPropagateToChildren) == 0x000089, "Member 'FRigUnit_SpringIK::bPropagateToChildren' has a wrong offset!");
...
public:
	...
	int32                                         UpperBound;                                        // 0x00B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_TimeOffsetTransform, UpperBound) == 0x0000B4, "Member 'FRigUnit_TimeOffsetTransform::UpperBound' has a wrong offset!");
...
public:
	...
	int32                                         UpperBound;                                        // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FRigUnit_TimeOffsetFloat, UpperBound) == 0x00005C, "Member 'FRigUnit_TimeOffsetFloat::UpperBound' has a wrong offset!");
...
public:
	...
	TMap<int32, int32>                            ConstraintDataToTargets;                           // 0x0010(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	ETransformSpaceMode                           BaseTransformSpace;                                // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0xF];                                       // 0x0031(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             BaseTransform;                                     // 0x0040(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	class FName                                   BaseBone;                                          // 0x0070(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConstraintTarget>              Targets;                                           // 0x0078(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bUseInitialTransforms;                             // 0x0088(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigUnit_TransformConstraint_WorkData  WorkData;                                          // 0x0090(0x0060)(Transient, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FRigUnit_TransformConstraint) == 0x000010, "Wrong alignment on FRigUnit_TransformConstraint");
static_assert(sizeof(FRigUnit_TransformConstraint) == 0x0000F0, "Wrong size on FRigUnit_TransformConstraint");
static_assert(offsetof(FRigUnit_TransformConstraint, Bone) == 0x000028, "Member 'FRigUnit_TransformConstraint::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, BaseTransformSpace) == 0x000030, "Member 'FRigUnit_TransformConstraint::BaseTransformSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, BaseTransform) == 0x000040, "Member 'FRigUnit_TransformConstraint::BaseTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, BaseBone) == 0x000070, "Member 'FRigUnit_TransformConstraint::BaseBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, Targets) == 0x000078, "Member 'FRigUnit_TransformConstraint::Targets' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, bUseInitialTransforms) == 0x000088, "Member 'FRigUnit_TransformConstraint::bUseInitialTransforms' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, WorkData) == 0x000090, "Member 'FRigUnit_TransformConstraint::WorkData' has a wrong offset!");
...
{
public:
	class FName                                   StartJoint;                                        // 0x0028(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   EndJoint;                                          // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PoleTarget;                                        // 0x0038(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Spin;                                              // 0x0044(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             EndEffector;                                       // 0x0050(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         IKBlend;                                           // 0x0080(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_84[0xC];                                       // 0x0084(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             StartJointFKTransform;                             // 0x0090(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             MidJointFKTransform;                               // 0x00C0(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             EndJointFKTransform;                               // 0x00F0(0x0030)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRigUnit_TwoBoneIKFK) == 0x0001E0, "Wrong size on FRigUnit_TwoBoneIKFK");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJoint) == 0x000028, "Member 'FRigUnit_TwoBoneIKFK::StartJoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJoint) == 0x000030, "Member 'FRigUnit_TwoBoneIKFK::EndJoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, PoleTarget) == 0x000038, "Member 'FRigUnit_TwoBoneIKFK::PoleTarget' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, Spin) == 0x000044, "Member 'FRigUnit_TwoBoneIKFK::Spin' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndEffector) == 0x000050, "Member 'FRigUnit_TwoBoneIKFK::EndEffector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, IKBlend) == 0x000080, "Member 'FRigUnit_TwoBoneIKFK::IKBlend' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJointFKTransform) == 0x000090, "Member 'FRigUnit_TwoBoneIKFK::StartJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, MidJointFKTransform) == 0x0000C0, "Member 'FRigUnit_TwoBoneIKFK::MidJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJointFKTransform) == 0x0000F0, "Member 'FRigUnit_TwoBoneIKFK::EndJointFKTransform' has a wrong offset!");
...
{
public:
	struct FTransform                             Root;                                              // 0x0020(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                PoleVector;                                        // 0x0050(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         SecondaryAxisWeight;                               // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableStretch;                                    // 0x00AC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_AD[0x3];                                       // 0x00AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StretchStartRatio;                                 // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StretchMaximumRatio;                               // 0x00B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BoneALength;                                       // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BoneBLength;                                       // 0x00BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             Elbow;                                             // 0x00C0(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_TwoBoneIKSimpleTransforms) == 0x000010, "Wrong alignment on FRigUnit_TwoBoneIKSimpleTransforms");
static_assert(sizeof(FRigUnit_TwoBoneIKSimpleTransforms) == 0x0000F0, "Wrong size on FRigUnit_TwoBoneIKSimpleTransforms");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, Root) == 0x000020, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::Root' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, PoleVector) == 0x000050, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::PoleVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, Effector) == 0x000060, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::Effector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, PrimaryAxis) == 0x000090, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, SecondaryAxis) == 0x00009C, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, SecondaryAxisWeight) == 0x0000A8, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::SecondaryAxisWeight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, bEnableStretch) == 0x0000AC, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::bEnableStretch' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, StretchStartRatio) == 0x0000B0, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::StretchStartRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, StretchMaximumRatio) == 0x0000B4, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::StretchMaximumRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, BoneALength) == 0x0000B8, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::BoneALength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, BoneBLength) == 0x0000BC, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::BoneBLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleTransforms, Elbow) == 0x0000C0, "Member 'FRigUnit_TwoBoneIKSimpleTransforms::Elbow' has a wrong offset!");
...
{
public:
	struct FVector                                Root;                                              // 0x0020(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                PoleVector;                                        // 0x002C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Effector;                                          // 0x0038(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableStretch;                                    // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StretchStartRatio;                                 // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StretchMaximumRatio;                               // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BoneALength;                                       // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BoneBLength;                                       // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Elbow;                                             // 0x0058(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_TwoBoneIKSimpleVectors) == 0x000008, "Wrong alignment on FRigUnit_TwoBoneIKSimpleVectors");
static_assert(sizeof(FRigUnit_TwoBoneIKSimpleVectors) == 0x000068, "Wrong size on FRigUnit_TwoBoneIKSimpleVectors");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, Root) == 0x000020, "Member 'FRigUnit_TwoBoneIKSimpleVectors::Root' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, PoleVector) == 0x00002C, "Member 'FRigUnit_TwoBoneIKSimpleVectors::PoleVector' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, bEnableStretch) == 0x000044, "Member 'FRigUnit_TwoBoneIKSimpleVectors::bEnableStretch' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, StretchStartRatio) == 0x000048, "Member 'FRigUnit_TwoBoneIKSimpleVectors::StretchStartRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, StretchMaximumRatio) == 0x00004C, "Member 'FRigUnit_TwoBoneIKSimpleVectors::StretchMaximumRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, BoneALength) == 0x000050, "Member 'FRigUnit_TwoBoneIKSimpleVectors::BoneALength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, BoneBLength) == 0x000054, "Member 'FRigUnit_TwoBoneIKSimpleVectors::BoneBLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimpleVectors, Elbow) == 0x000058, "Member 'FRigUnit_TwoBoneIKSimpleVectors::Elbow' has a wrong offset!");
...
{
public:
	class FName                                   BoneA;                                             // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   BoneB;                                             // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   EffectorBone;                                      // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, BoneA) == 0x000028, "Member 'FRigUnit_TwoBoneIKSimple::BoneA' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, BoneB) == 0x000030, "Member 'FRigUnit_TwoBoneIKSimple::BoneB' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, EffectorBone) == 0x000038, "Member 'FRigUnit_TwoBoneIKSimple::EffectorBone' has a wrong offset!");
