...
{
public:
	TArray<class USceneComponent*>                CallFunc_Get_Visibility_Components_Components;     // 0x0000(0x0010)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
};
...
{
public:
	TArray<class USceneComponent*>                Scene_Components;                                  // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TArray<ECollisionEnabled>                     Local_Collision_List;                              // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
};
...
{
public:
	TMap<class USceneComponent*, ECollisionEnabled> Collision_Overrides;                               // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, ContainsInstancedReference)
	TArray<class USceneComponent*>                CallFunc_Map_Keys_Keys;                            // 0x0050(0x0010)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
};
...
{
public:
	TArray<class USceneComponent*>                Array;                                             // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
