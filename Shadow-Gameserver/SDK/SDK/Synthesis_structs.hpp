...
static_assert(alignof(FSourceEffectBitCrusherSettings) == 0x000004, "Wrong alignment on FSourceEffectBitCrusherSettings");
static_assert(sizeof(FSourceEffectBitCrusherSettings) == 0x000008, "Wrong size on FSourceEffectBitCrusherSettings");
...
static_assert(offsetof(FSourceEffectBitCrusherSettings, CrushedBits) == 0x000004, "Member 'FSourceEffectBitCrusherSettings::CrushedBits' has a wrong offset!");
...
static_assert(alignof(FSourceEffectChorusSettings) == 0x000004, "Wrong alignment on FSourceEffectChorusSettings");
static_assert(sizeof(FSourceEffectChorusSettings) == 0x000018, "Wrong size on FSourceEffectChorusSettings");
...
static_assert(sizeof(FSourceEffectMidSideSpreaderSettings) == 0x00000C, "Wrong size on FSourceEffectMidSideSpreaderSettings");
static_assert(offsetof(FSourceEffectMidSideSpreaderSettings, InputMode) == 0x000000, "Member 'FSourceEffectMidSideSpreaderSettings::InputMode' has a wrong offset!");
static_assert(offsetof(FSourceEffectMidSideSpreaderSettings, SpreadAmount) == 0x000004, "Member 'FSourceEffectMidSideSpreaderSettings::SpreadAmount' has a wrong offset!");
static_assert(offsetof(FSourceEffectMidSideSpreaderSettings, OutputMode) == 0x000008, "Member 'FSourceEffectMidSideSpreaderSettings::OutputMode' has a wrong offset!");
static_assert(offsetof(FSourceEffectMidSideSpreaderSettings, bEqualPower) == 0x000009, "Member 'FSourceEffectMidSideSpreaderSettings::bEqualPower' has a wrong offset!");
