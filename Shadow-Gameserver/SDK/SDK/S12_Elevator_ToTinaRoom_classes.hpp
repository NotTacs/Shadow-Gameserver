...
// Package: S12_Elevator_ToTinaRoom
...
// BlueprintGeneratedClass S12_Elevator_ToTinaRoom.SequenceDirector_C
// 0x0008 (0x0038 - 0x0030)
class S12_Elevator_ToTinaRoom::USequenceDirector_C final : public ULevelSequenceDirector
{
public:
...
public:
	...
	void Audio_Camera_Move_Back_Event_(class USoundBase* Sound);
	...
	void SequenceEvent__ENTRYPOINTSequenceDirector_1(class ABP_Battlepass_LightSwitcher_C* BP_Battlepass_LightSwitcher_TNTINA);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BlueprintGeneratedClass S12_Elevator_ToTinaRoom.SequenceDirector_C", true, "SequenceDirector_C">();
	}
	static class S12_Elevator_ToTinaRoom::USequenceDirector_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<S12_Elevator_ToTinaRoom::USequenceDirector_C>();
	}
};
static_assert(alignof(S12_Elevator_ToTinaRoom::USequenceDirector_C) == 0x000008, "Wrong alignment on S12_Elevator_ToTinaRoom::USequenceDirector_C");
static_assert(sizeof(S12_Elevator_ToTinaRoom::USequenceDirector_C) == 0x000038, "Wrong size on S12_Elevator_ToTinaRoom::USequenceDirector_C");
static_assert(offsetof(S12_Elevator_ToTinaRoom::USequenceDirector_C, UberGraphFrame) == 0x000030, "Member 'S12_Elevator_ToTinaRoom::USequenceDirector_C::UberGraphFrame' has a wrong offset!");
