...
{
public:
	uint8                                         Pad_6E0[0x250];                                    // 0x06E0(0x0250)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000930, "Wrong size on FAnimSequencerInstanceProxy");
...
public:
	...
	uint8                                         Pad_1A[0x126];                                     // 0x001A(0x0126)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_CopyPoseFromMesh) == 0x000008, "Wrong alignment on FAnimNode_CopyPoseFromMesh");
static_assert(sizeof(FAnimNode_CopyPoseFromMesh) == 0x000140, "Wrong size on FAnimNode_CopyPoseFromMesh");
...
static_assert(sizeof(FAnimNode_PoseHandler) == 0x000078, "Wrong size on FAnimNode_PoseHandler");
...
static_assert(sizeof(FAnimNode_PoseBlendNode) == 0x000098, "Wrong size on FAnimNode_PoseBlendNode");
static_assert(offsetof(FAnimNode_PoseBlendNode, SourcePose) == 0x000078, "Member 'FAnimNode_PoseBlendNode::SourcePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseBlendNode, BlendOption) == 0x000088, "Member 'FAnimNode_PoseBlendNode::BlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseBlendNode, CustomCurve) == 0x000090, "Member 'FAnimNode_PoseBlendNode::CustomCurve' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseByName) == 0x000090, "Wrong size on FAnimNode_PoseByName");
static_assert(offsetof(FAnimNode_PoseByName, PoseName) == 0x000078, "Member 'FAnimNode_PoseByName::PoseName' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseByName, PoseWeight) == 0x000080, "Member 'FAnimNode_PoseByName::PoseWeight' has a wrong offset!");
...
static_assert(sizeof(FRBFParams) == 0x000028, "Wrong size on FRBFParams");
...
static_assert(offsetof(FRBFParams, NormalizeMethod) == 0x000010, "Member 'FRBFParams::NormalizeMethod' has a wrong offset!");
static_assert(offsetof(FRBFParams, MedianReference) == 0x000014, "Member 'FRBFParams::MedianReference' has a wrong offset!");
static_assert(offsetof(FRBFParams, MedianMin) == 0x000020, "Member 'FRBFParams::MedianMin' has a wrong offset!");
static_assert(offsetof(FRBFParams, MedianMax) == 0x000024, "Member 'FRBFParams::MedianMax' has a wrong offset!");
...
public:
	...
	uint8                                         bOnlyDriveSelectedBones : 1;                       // 0x0122(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x000128, "Wrong size on FAnimNode_PoseDriver");
static_assert(offsetof(FAnimNode_PoseDriver, SourcePose) == 0x000078, "Member 'FAnimNode_PoseDriver::SourcePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, SourceBones) == 0x000088, "Member 'FAnimNode_PoseDriver::SourceBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, OnlyDriveBones) == 0x000098, "Member 'FAnimNode_PoseDriver::OnlyDriveBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, PoseTargets) == 0x0000A8, "Member 'FAnimNode_PoseDriver::PoseTargets' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, EvalSpaceBone) == 0x0000E8, "Member 'FAnimNode_PoseDriver::EvalSpaceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x0000F8, "Member 'FAnimNode_PoseDriver::RBFParams' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveSource) == 0x000120, "Member 'FAnimNode_PoseDriver::DriveSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveOutput) == 0x000121, "Member 'FAnimNode_PoseDriver::DriveOutput' has a wrong offset!");
...
public:
	...
	float                                         WorldSpaceMinimumScale;                            // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSolverIterations                      OverrideSolverIterations;                          // 0x01C4(0x001C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E0[0x3C0];                                    // 0x01E0(0x03C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_RigidBody, CachedBoundsScale) == 0x0001A4, "Member 'FAnimNode_RigidBody::CachedBoundsScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, BaseBoneRef) == 0x0001A8, "Member 'FAnimNode_RigidBody::BaseBoneRef' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x0001B8, "Member 'FAnimNode_RigidBody::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x0001B9, "Member 'FAnimNode_RigidBody::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bForceDisableCollisionBetweenConstraintBodies) == 0x0001BA, "Member 'FAnimNode_RigidBody::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, WorldSpaceMinimumScale) == 0x0001C0, "Member 'FAnimNode_RigidBody::WorldSpaceMinimumScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, OverrideSolverIterations) == 0x0001C4, "Member 'FAnimNode_RigidBody::OverrideSolverIterations' has a wrong offset!");
...
public:
	...
	struct FSolverIterations                      OverrideSolverIterations;                          // 0x0124(0x001C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_140[0x460];                                    // 0x0140(0x0460)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody_Chaos) == 0x000010, "Wrong alignment on FAnimNode_RigidBody_Chaos");
static_assert(sizeof(FAnimNode_RigidBody_Chaos) == 0x0005A0, "Wrong size on FAnimNode_RigidBody_Chaos");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, OverridePhysicsAsset) == 0x0000C8, "Member 'FAnimNode_RigidBody_Chaos::OverridePhysicsAsset' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, OverrideWorldGravity) == 0x0000D0, "Member 'FAnimNode_RigidBody_Chaos::OverrideWorldGravity' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, ExternalForce) == 0x0000DC, "Member 'FAnimNode_RigidBody_Chaos::ExternalForce' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, ComponentLinearAccScale) == 0x0000E8, "Member 'FAnimNode_RigidBody_Chaos::ComponentLinearAccScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, ComponentLinearVelScale) == 0x0000F4, "Member 'FAnimNode_RigidBody_Chaos::ComponentLinearVelScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, ComponentAppliedLinearAccClamp) == 0x000100, "Member 'FAnimNode_RigidBody_Chaos::ComponentAppliedLinearAccClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, CachedBoundsScale) == 0x00010C, "Member 'FAnimNode_RigidBody_Chaos::CachedBoundsScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, BaseBoneRef) == 0x000110, "Member 'FAnimNode_RigidBody_Chaos::BaseBoneRef' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, OverlapChannel) == 0x000120, "Member 'FAnimNode_RigidBody_Chaos::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, SimulationSpace) == 0x000121, "Member 'FAnimNode_RigidBody_Chaos::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, bForceDisableCollisionBetweenConstraintBodies) == 0x000122, "Member 'FAnimNode_RigidBody_Chaos::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody_Chaos, OverrideSolverIterations) == 0x000124, "Member 'FAnimNode_RigidBody_Chaos::OverrideSolverIterations' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SplineIK) == 0x000260, "Wrong size on FAnimNode_SplineIK");
