...
static_assert(alignof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner) == 0x000004, "Wrong alignment on PlayerBanner_C_ExecuteUbergraph_PlayerBanner");
static_assert(sizeof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner) == 0x000038, "Wrong size on PlayerBanner_C_ExecuteUbergraph_PlayerBanner");
...
static_assert(offsetof(PlayerBanner_C_ExecuteUbergraph_PlayerBanner, K2Node_CustomEvent_NewInfo) == 0x000004, "Member 'PlayerBanner_C_ExecuteUbergraph_PlayerBanner::K2Node_CustomEvent_NewInfo' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_SetBannerOwner) == 0x000048, "Wrong size on PlayerBanner_C_SetBannerOwner");
...
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, CallFunc_GetContext_ReturnValue) == 0x000038, "Member 'PlayerBanner_C_SetBannerOwner::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, CallFunc_IsValid_UniqueNetIdRepl_ReturnValue) == 0x000040, "Member 'PlayerBanner_C_SetBannerOwner::CallFunc_IsValid_UniqueNetIdRepl_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_SetBannerIconAndColorFromProfile) == 0x000108, "Wrong size on PlayerBanner_C_SetBannerIconAndColorFromProfile");
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetLoadoutForPlayer_ReturnValue) == 0x000008, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetLoadoutForPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue) == 0x0000F8, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue_1) == 0x000100, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_UnbindDelegates) == 0x000018, "Wrong size on PlayerBanner_C_UnbindDelegates");
