...
static_assert(sizeof(UNormalBangWrapper_C) == 0x000310, "Wrong size on UNormalBangWrapper_C");
static_assert(offsetof(UNormalBangWrapper_C, UberGraphFrame) == 0x000278, "Member 'UNormalBangWrapper_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, IntroSuperBang) == 0x000280, "Member 'UNormalBangWrapper_C::IntroSuperBang' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, Intro) == 0x000288, "Member 'UNormalBangWrapper_C::Intro' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, TutorialGlow) == 0x000290, "Member 'UNormalBangWrapper_C::TutorialGlow' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, BangBox) == 0x000298, "Member 'UNormalBangWrapper_C::BangBox' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, BigBang) == 0x0002A0, "Member 'UNormalBangWrapper_C::BigBang' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, BigBangCount) == 0x0002A8, "Member 'UNormalBangWrapper_C::BigBangCount' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, CommonTextBlock_0) == 0x0002B0, "Member 'UNormalBangWrapper_C::CommonTextBlock_0' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, Content) == 0x0002B8, "Member 'UNormalBangWrapper_C::Content' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, CountText) == 0x0002C0, "Member 'UNormalBangWrapper_C::CountText' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, ModeSwitcher) == 0x0002C8, "Member 'UNormalBangWrapper_C::ModeSwitcher' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, NoMinusCount) == 0x0002D0, "Member 'UNormalBangWrapper_C::NoMinusCount' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, NoMinusCountMinus1) == 0x0002D8, "Member 'UNormalBangWrapper_C::NoMinusCountMinus1' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, SmallBang) == 0x0002E0, "Member 'UNormalBangWrapper_C::SmallBang' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, SmallBangCount) == 0x0002E8, "Member 'UNormalBangWrapper_C::SmallBangCount' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, SuperBang) == 0x0002F0, "Member 'UNormalBangWrapper_C::SuperBang' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, TutorialBorder) == 0x0002F8, "Member 'UNormalBangWrapper_C::TutorialBorder' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, UseSmallVersion) == 0x000300, "Member 'UNormalBangWrapper_C::UseSmallVersion' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, Count) == 0x000304, "Member 'UNormalBangWrapper_C::Count' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, bUseSuperBangNoCount) == 0x000308, "Member 'UNormalBangWrapper_C::bUseSuperBangNoCount' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, ShouldSuppressBang) == 0x000309, "Member 'UNormalBangWrapper_C::ShouldSuppressBang' has a wrong offset!");
