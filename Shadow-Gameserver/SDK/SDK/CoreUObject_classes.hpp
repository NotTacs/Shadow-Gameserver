...
public:
	...
	static UEType* FindObject(const std::string& Name, EClassCastFlags RequiredType = EClassCastFlags::None) //FullName
	{
		return static_cast<UEType*>(FindObjectImpl(Name, RequiredType));
	}
	template<typename UEType = UObject>
	static UEType* FindObjectFast(const std::string& Name, EClassCastFlags RequiredType = EClassCastFlags::None) //Object Name Only
	{
...
static_assert(sizeof(UStruct) == 0x0000C8, "Wrong size on UStruct");
...
public:
	...
	enum class EClassCastFlags                    CastFlags;                                         // 0x00E8(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_F0[0x40];                                      // 0x00F0(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                DefaultObject;                                     // 0x0130(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_138[0x110];                                    // 0x0138(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UClass) == 0x000248, "Wrong size on UClass");
static_assert(offsetof(UClass, CastFlags) == 0x0000E8, "Member 'UClass::CastFlags' has a wrong offset!");
static_assert(offsetof(UClass, DefaultObject) == 0x000130, "Member 'UClass::DefaultObject' has a wrong offset!");
...
static_assert(sizeof(UScriptStruct) == 0x0000D8, "Wrong size on UScriptStruct");
...
public:
	...
	uint32                                        FunctionFlags;                                     // 0x00C8(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_D0[0x20];                                      // 0x00D0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FNativeFuncPtr                                ExecFunction;                                      // 0x00F0(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UFunction) == 0x0000F8, "Wrong size on UFunction");
static_assert(offsetof(UFunction, FunctionFlags) == 0x0000C8, "Member 'UFunction::FunctionFlags' has a wrong offset!");
static_assert(offsetof(UFunction, ExecFunction) == 0x0000F0, "Member 'UFunction::ExecFunction' has a wrong offset!");
...
static_assert(sizeof(UDelegateFunction) == 0x0000F8, "Wrong size on UDelegateFunction");
...
static_assert(sizeof(USparseDelegateFunction) == 0x000108, "Wrong size on USparseDelegateFunction");
...
static_assert(sizeof(UDynamicClass) == 0x0002C8, "Wrong size on UDynamicClass");
...
{
public:
	uint8                                         Pad_248[0x1B8];                                    // 0x0248(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderClass) == 0x000400, "Wrong size on ULinkerPlaceholderClass");
...
{
public:
	uint8                                         Pad_F8[0x1B8];                                     // 0x00F8(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x0002B0, "Wrong size on ULinkerPlaceholderFunction");
