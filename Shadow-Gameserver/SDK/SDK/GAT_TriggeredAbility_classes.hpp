...
public:
	...
	struct FGameplayTag                           TC_AbilitiesGenericTriggeredAbilityActivate;       // 0x0A38(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          bPlayerHolsterState;                               // 0x0A40(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UGAT_TriggeredAbility_C) == 0x000A48, "Wrong size on UGAT_TriggeredAbility_C");
static_assert(offsetof(UGAT_TriggeredAbility_C, UberGraphFrame) == 0x000A30, "Member 'UGAT_TriggeredAbility_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAT_TriggeredAbility_C, TC_AbilitiesGenericTriggeredAbilityActivate) == 0x000A38, "Member 'UGAT_TriggeredAbility_C::TC_AbilitiesGenericTriggeredAbilityActivate' has a wrong offset!");
static_assert(offsetof(UGAT_TriggeredAbility_C, bPlayerHolsterState) == 0x000A40, "Member 'UGAT_TriggeredAbility_C::bPlayerHolsterState' has a wrong offset!");
