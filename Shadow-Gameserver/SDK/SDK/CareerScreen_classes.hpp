...
static_assert(sizeof(UCareerScreen_C) == 0x0004D8, "Wrong size on UCareerScreen_C");
static_assert(offsetof(UCareerScreen_C, UberGraphFrame) == 0x000488, "Member 'UCareerScreen_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, FeatDisplaySwitcher) == 0x000490, "Member 'UCareerScreen_C::FeatDisplaySwitcher' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, GradOvr) == 0x000498, "Member 'UCareerScreen_C::GradOvr' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, NoAchievementMessage) == 0x0004A0, "Member 'UCareerScreen_C::NoAchievementMessage' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, SeasonHeadingTextLabel) == 0x0004A8, "Member 'UCareerScreen_C::SeasonHeadingTextLabel' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, Switcher) == 0x0004B0, "Member 'UCareerScreen_C::Switcher' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, Input_ReplayCinematic) == 0x0004B8, "Member 'UCareerScreen_C::Input_ReplayCinematic' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, ActivatableMovieWidget) == 0x0004C8, "Member 'UCareerScreen_C::ActivatableMovieWidget' has a wrong offset!");
static_assert(offsetof(UCareerScreen_C, AutoPlayVideo) == 0x0004D0, "Member 'UCareerScreen_C::AutoPlayVideo' has a wrong offset!");
