...
static_assert(offsetof(AbilitySystemBlueprintLibrary_AbilityTargetDataFromHitResult, ReturnValue) == 0x000090, "Member 'AbilitySystemBlueprintLibrary_AbilityTargetDataFromHitResult::ReturnValue' has a wrong offset!");
...
public:
	...
	int32                                         GameplayEffectLevel;                               // 0x0160(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AbilityLevel;                                      // 0x0164(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters) == 0x000170, "Wrong size on AbilitySystemBlueprintLibrary_BreakGameplayCueParameters");
...
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, NormalizedMagnitude) == 0x0000B8, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::NormalizedMagnitude' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, RawMagnitude) == 0x0000BC, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::RawMagnitude' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, EffectContext) == 0x0000C0, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::EffectContext' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, MatchedTagName) == 0x0000D8, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::MatchedTagName' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, OriginalTag) == 0x0000E0, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::OriginalTag' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, AggregatedSourceTags) == 0x0000E8, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::AggregatedSourceTags' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, AggregatedTargetTags) == 0x000108, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::AggregatedTargetTags' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, Location) == 0x000128, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::Location' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, Normal) == 0x000134, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::Normal' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, Instigator) == 0x000140, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::Instigator' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, EffectCauser) == 0x000148, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::EffectCauser' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, SourceObject) == 0x000150, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::SourceObject' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, PhysicalMaterial) == 0x000158, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::PhysicalMaterial' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, GameplayEffectLevel) == 0x000160, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::GameplayEffectLevel' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, AbilityLevel) == 0x000164, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::AbilityLevel' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, TargetAttachComponent) == 0x000168, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::TargetAttachComponent' has a wrong offset!");
...
static_assert(offsetof(AbilitySystemBlueprintLibrary_EffectContextAddHitResult, bReset) == 0x0000A4, "Member 'AbilitySystemBlueprintLibrary_EffectContextAddHitResult::bReset' has a wrong offset!");
...
static_assert(sizeof(AbilitySystemBlueprintLibrary_EffectContextGetHitResult) == 0x0000A8, "Wrong size on AbilitySystemBlueprintLibrary_EffectContextGetHitResult");
...
static_assert(offsetof(AbilitySystemBlueprintLibrary_GetActorByIndex, Param_Index) == 0x0000B8, "Member 'AbilitySystemBlueprintLibrary_GetActorByIndex::Param_Index' has a wrong offset!");
...
static_assert(sizeof(AbilitySystemBlueprintLibrary_MakeGameplayCueParameters) == 0x000170, "Wrong size on AbilitySystemBlueprintLibrary_MakeGameplayCueParameters");
...
static_assert(offsetof(AbilitySystemBlueprintLibrary_MakeGameplayCueParameters, ReturnValue) == 0x0000B8, "Member 'AbilitySystemBlueprintLibrary_MakeGameplayCueParameters::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPredictionKey                         AbilityOriginalPredictionKey;                      // 0x0008(0x0018)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPredictionKey                         CurrentPredictionKey;                              // 0x0020(0x0018)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector_NetQuantize100                 VectorPayload;                                     // 0x0038(0x000C)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AbilityTask_ApplyRootMotionJumpForce_OnLandedCallback) == 0x00008C, "Wrong size on AbilityTask_ApplyRootMotionJumpForce_OnLandedCallback");
...
public:
	struct FGameplayAbilityActorInfo              ActorInfo;                                         // 0x0000(0x0040)(Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FGameplayEventData                     Payload;                                           // 0x0040(0x00B0)(Parm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameplayAbility_K2_ShouldAbilityRespondToEvent) == 0x0000F8, "Wrong size on GameplayAbility_K2_ShouldAbilityRespondToEvent");
...
static_assert(offsetof(GameplayAbility_K2_ShouldAbilityRespondToEvent, ReturnValue) == 0x0000F0, "Member 'GameplayAbility_K2_ShouldAbilityRespondToEvent::ReturnValue' has a wrong offset!");
