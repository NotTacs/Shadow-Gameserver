...
public:
	...
	struct FSourceEffectBitCrusherSettings        Settings;                                          // 0x0098(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USourceEffectBitCrusherPreset) == 0x0000A0, "Wrong size on USourceEffectBitCrusherPreset");
static_assert(offsetof(USourceEffectBitCrusherPreset, Settings) == 0x000098, "Member 'USourceEffectBitCrusherPreset::Settings' has a wrong offset!");
...
public:
	...
	struct FSourceEffectChorusSettings            Settings;                                          // 0x00A8(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USourceEffectChorusPreset) == 0x0000C0, "Wrong size on USourceEffectChorusPreset");
static_assert(offsetof(USourceEffectChorusPreset, Settings) == 0x0000A8, "Member 'USourceEffectChorusPreset::Settings' has a wrong offset!");
...
public:
	uint8                                         Pad_68[0x34];                                      // 0x0068(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSourceEffectMidSideSpreaderSettings   Settings;                                          // 0x009C(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USourceEffectMidSideSpreaderPreset, Settings) == 0x00009C, "Member 'USourceEffectMidSideSpreaderPreset::Settings' has a wrong offset!");
