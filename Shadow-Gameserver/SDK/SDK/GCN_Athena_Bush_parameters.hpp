...
public:
	...
	TArray<class UParticleSystemComponent*>       K2Node_Event_ParticleComponents_1;                 // 0x01E8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TArray<class UAudioComponent*>                K2Node_Event_AudioComponents_1;                    // 0x01F8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	...
	TArray<class UParticleSystemComponent*>       K2Node_Event_ParticleComponents;                   // 0x02C8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TArray<class UAudioComponent*>                K2Node_Event_AudioComponents;                      // 0x02D8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
