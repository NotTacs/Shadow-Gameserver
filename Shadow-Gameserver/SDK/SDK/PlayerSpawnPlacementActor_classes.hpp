...
{
public:
	class UArrowComponent*                        Arrow;                                             // 0x0610(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(APlayerSpawnPlacementActor_C) == 0x000618, "Wrong size on APlayerSpawnPlacementActor_C");
static_assert(offsetof(APlayerSpawnPlacementActor_C, Arrow) == 0x000610, "Member 'APlayerSpawnPlacementActor_C::Arrow' has a wrong offset!");
