...
{
public:
	TArray<struct FScalarParameterNameAndCurve>   ScalarParameterNamesAndCurves;                     // 0x00E0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FVectorParameterNameAndCurves>  VectorParameterNamesAndCurves;                     // 0x00F0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FColorParameterNameAndCurves>   ColorParameterNamesAndCurves;                      // 0x0100(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;                  // 0x0110(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneParameterSection) == 0x000120, "Wrong size on UMovieSceneParameterSection");
...
static_assert(offsetof(UMovieSceneParameterSection, TransformParameterNamesAndCurves) == 0x000110, "Member 'UMovieSceneParameterSection::TransformParameterNamesAndCurves' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneAudioSection, bLooping) == 0x0002F0, "Member 'UMovieSceneAudioSection::bLooping' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x0002F1, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x0002F2, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceShakeSection) == 0x000100, "Wrong size on UMovieSceneCameraShakeSourceShakeSection");
static_assert(offsetof(UMovieSceneCameraShakeSourceShakeSection, ShakeData) == 0x0000E0, "Member 'UMovieSceneCameraShakeSourceShakeSection::ShakeData' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceShakeTrack) == 0x000068, "Wrong size on UMovieSceneCameraShakeSourceShakeTrack");
static_assert(offsetof(UMovieSceneCameraShakeSourceShakeTrack, CameraShakeSections) == 0x000058, "Member 'UMovieSceneCameraShakeSourceShakeTrack::CameraShakeSections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceTriggerSection) == 0x000168, "Wrong size on UMovieSceneCameraShakeSourceTriggerSection");
static_assert(offsetof(UMovieSceneCameraShakeSourceTriggerSection, Channel) == 0x0000E0, "Member 'UMovieSceneCameraShakeSourceTriggerSection::Channel' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraShakeSourceTriggerTrack) == 0x000068, "Wrong size on UMovieSceneCameraShakeSourceTriggerTrack");
static_assert(offsetof(UMovieSceneCameraShakeSourceTriggerTrack, Sections) == 0x000058, "Member 'UMovieSceneCameraShakeSourceTriggerTrack::Sections' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, Params) == 0x0000E0, "Member 'UMovieSceneSkeletalAnimationSection::Params' has a wrong offset!");
