...
static_assert(sizeof(AAROriginActor) == 0x000218, "Wrong size on AAROriginActor");
...
static_assert(sizeof(UARSessionConfig) == 0x0000A8, "Wrong size on UARSessionConfig");
...
static_assert(offsetof(UARSessionConfig, WorldAlignment) == 0x000037, "Member 'UARSessionConfig::WorldAlignment' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, SessionType) == 0x000038, "Member 'UARSessionConfig::SessionType' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, PlaneDetectionMode) == 0x000039, "Member 'UARSessionConfig::PlaneDetectionMode' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bHorizontalPlaneDetection) == 0x00003A, "Member 'UARSessionConfig::bHorizontalPlaneDetection' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bVerticalPlaneDetection) == 0x00003B, "Member 'UARSessionConfig::bVerticalPlaneDetection' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bEnableAutoFocus) == 0x00003C, "Member 'UARSessionConfig::bEnableAutoFocus' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, LightEstimationMode) == 0x00003D, "Member 'UARSessionConfig::LightEstimationMode' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, FrameSyncMode) == 0x00003E, "Member 'UARSessionConfig::FrameSyncMode' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bEnableAutomaticCameraOverlay) == 0x00003F, "Member 'UARSessionConfig::bEnableAutomaticCameraOverlay' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bEnableAutomaticCameraTracking) == 0x000040, "Member 'UARSessionConfig::bEnableAutomaticCameraTracking' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bResetCameraTracking) == 0x000041, "Member 'UARSessionConfig::bResetCameraTracking' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, bResetTrackedObjects) == 0x000042, "Member 'UARSessionConfig::bResetTrackedObjects' has a wrong offset!");
...
static_assert(offsetof(UARSessionConfig, FaceTrackingDirection) == 0x00008C, "Member 'UARSessionConfig::FaceTrackingDirection' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, FaceTrackingUpdate) == 0x00008D, "Member 'UARSessionConfig::FaceTrackingUpdate' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, SerializedARCandidateImageDatabase) == 0x000090, "Member 'UARSessionConfig::SerializedARCandidateImageDatabase' has a wrong offset!");
static_assert(offsetof(UARSessionConfig, EnabledSessionTrackingFeature) == 0x0000A0, "Member 'UARSessionConfig::EnabledSessionTrackingFeature' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_304[0x64];                                     // 0x0304(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameMode) == 0x000368, "Wrong size on AARSharedWorldGameMode");
static_assert(offsetof(AARSharedWorldGameMode, BufferSizePerChunk) == 0x000300, "Member 'AARSharedWorldGameMode::BufferSizePerChunk' has a wrong offset!");
...
{
public:
	TArray<uint8>                                 PreviewImageData;                                  // 0x0288(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ARWorldData;                                       // 0x0298(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesTotal;                            // 0x02A8(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesTotal;                                 // 0x02AC(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesDelivered;                        // 0x02B0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesDelivered;                             // 0x02B4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AARSharedWorldGameState) == 0x0002C0, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x000288, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000298, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x0002A8, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x0002AC, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x0002B0, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x0002B4, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x000570, "Wrong size on AARSharedWorldPlayerController");
...
static_assert(sizeof(AARSkyLight) == 0x000238, "Wrong size on AARSkyLight");
static_assert(offsetof(AARSkyLight, CaptureProbe) == 0x000228, "Member 'AARSkyLight::CaptureProbe' has a wrong offset!");
...
static_assert(sizeof(UARTexture) == 0x0000F0, "Wrong size on UARTexture");
static_assert(offsetof(UARTexture, TextureType) == 0x0000D0, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, Timestamp) == 0x0000D4, "Member 'UARTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x0000D8, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x0000E8, "Member 'UARTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTextureCameraImage) == 0x0000F0, "Wrong size on UARTextureCameraImage");
...
static_assert(sizeof(UARTextureCameraDepth) == 0x0000F8, "Wrong size on UARTextureCameraDepth");
static_assert(offsetof(UARTextureCameraDepth, DepthQuality) == 0x0000F0, "Member 'UARTextureCameraDepth::DepthQuality' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, DepthAccuracy) == 0x0000F1, "Member 'UARTextureCameraDepth::DepthAccuracy' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, bIsTemporallySmoothed) == 0x0000F2, "Member 'UARTextureCameraDepth::bIsTemporallySmoothed' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentCaptureProbeTexture) == 0x000148, "Wrong size on UAREnvironmentCaptureProbeTexture");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, TextureType) == 0x000128, "Member 'UAREnvironmentCaptureProbeTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Timestamp) == 0x00012C, "Member 'UAREnvironmentCaptureProbeTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, ExternalTextureGuid) == 0x000130, "Member 'UAREnvironmentCaptureProbeTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Size) == 0x000140, "Member 'UAREnvironmentCaptureProbeTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTrackedGeometry) == 0x0000F0, "Wrong size on UARTrackedGeometry");
...
static_assert(sizeof(UARPlaneGeometry) == 0x000120, "Wrong size on UARPlaneGeometry");
static_assert(offsetof(UARPlaneGeometry, Orientation) == 0x0000E8, "Member 'UARPlaneGeometry::Orientation' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, Center) == 0x0000EC, "Member 'UARPlaneGeometry::Center' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, Extent) == 0x0000F8, "Member 'UARPlaneGeometry::Extent' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, SubsumedBy) == 0x000118, "Member 'UARPlaneGeometry::SubsumedBy' has a wrong offset!");
...
static_assert(sizeof(UARTrackedPoint) == 0x0000F0, "Wrong size on UARTrackedPoint");
...
static_assert(sizeof(UARTrackedImage) == 0x000100, "Wrong size on UARTrackedImage");
static_assert(offsetof(UARTrackedImage, DetectedImage) == 0x0000E8, "Member 'UARTrackedImage::DetectedImage' has a wrong offset!");
static_assert(offsetof(UARTrackedImage, EstimatedSize) == 0x0000F0, "Member 'UARTrackedImage::EstimatedSize' has a wrong offset!");
...
static_assert(sizeof(UARTrackedQRCode) == 0x000110, "Wrong size on UARTrackedQRCode");
static_assert(offsetof(UARTrackedQRCode, QRCode) == 0x0000F8, "Member 'UARTrackedQRCode::QRCode' has a wrong offset!");
static_assert(offsetof(UARTrackedQRCode, Version) == 0x000108, "Member 'UARTrackedQRCode::Version' has a wrong offset!");
...
static_assert(sizeof(UARFaceGeometry) == 0x0001E0, "Wrong size on UARFaceGeometry");
static_assert(offsetof(UARFaceGeometry, LookAtTarget) == 0x0000E8, "Member 'UARFaceGeometry::LookAtTarget' has a wrong offset!");
static_assert(offsetof(UARFaceGeometry, bIsTracked) == 0x0000F4, "Member 'UARFaceGeometry::bIsTracked' has a wrong offset!");
static_assert(offsetof(UARFaceGeometry, BlendShapes) == 0x0000F8, "Member 'UARFaceGeometry::BlendShapes' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentCaptureProbe) == 0x000100, "Wrong size on UAREnvironmentCaptureProbe");
static_assert(offsetof(UAREnvironmentCaptureProbe, EnvironmentCaptureTexture) == 0x0000F8, "Member 'UAREnvironmentCaptureProbe::EnvironmentCaptureTexture' has a wrong offset!");
...
static_assert(sizeof(UARTrackedObject) == 0x0000F0, "Wrong size on UARTrackedObject");
static_assert(offsetof(UARTrackedObject, DetectedObject) == 0x0000E8, "Member 'UARTrackedObject::DetectedObject' has a wrong offset!");
...
static_assert(sizeof(UARTrackedPose) == 0x000140, "Wrong size on UARTrackedPose");
