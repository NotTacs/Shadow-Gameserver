...
public:
	...
	struct FGameplayTag                           Cue;                                               // 0x0A38(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_Interrogate_GC_C) == 0x000A40, "Wrong size on UGA_Interrogate_GC_C");
static_assert(offsetof(UGA_Interrogate_GC_C, UberGraphFrame) == 0x000A30, "Member 'UGA_Interrogate_GC_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Interrogate_GC_C, Cue) == 0x000A38, "Member 'UGA_Interrogate_GC_C::Cue' has a wrong offset!");
