...
enum class ESettingType : uint8
{
	...
	DialogVolume                             = 112,
	VoiceChatVolume                          = 113,
	CinematicsVolume                         = 114,
	Subtitles                                = 115,
	Quality                                  = 116,
	VoiceChat                                = 117,
	PushToTalk                               = 118,
	ProximityVoiceChat                       = 119,
	VoiceChatInputDevice                     = 120,
	VoiceChatOutputDevice                    = 121,
	AllowBackgroundAudio                     = 122,
	ColorBlindMode                           = 123,
	ColorBlindStrength                       = 124,
	IgnoreGamepadInput                       = 125,
	LockPrimaryInputMethodToMouse            = 126,
	EnableRudderControl                      = 127,
	RudderDeadZone                           = 128,
	RudderMaxThrottle                        = 129,
	VisualizeSoundEffects                    = 130,
	VisualizeSoundEffectsHeader              = 131,
	MoveStickDeadZone                        = 132,
	LookStickDeadZone                        = 133,
	LookSensitivityPreset                    = 134,
	LookSensitivityPresetAds                 = 135,
	LookBuildModeMultiplier                  = 136,
	LookEditModeMultiplier                   = 137,
	UseAdvancedOptions                       = 138,
	LookHorizontalSpeed                      = 139,
	LookVerticalSpeed                        = 140,
	LookHorizontalSpeedAds                   = 141,
	LookVerticalSpeedAds                     = 142,
	LookHorizontalBoostSpeed                 = 143,
	LookVerticalBoostSpeed                   = 144,
	LookBoostAccelerationTime                = 145,
	LookHorizontalBoostSpeedAds              = 146,
	LookVerticalBoostSpeedAds                = 147,
	LookBoostAccelerationTimeAds             = 148,
	InstantBoostWhenBuilding                 = 149,
	LookEaseTime                             = 150,
	LookInputCurve                           = 151,
	AimAssistStrength                        = 152,
	UseLegacyControls                        = 153,
	PlayerSurveysAllowed                     = 154,
	NotifyWhenPlaying                        = 155,
...
enum class EFortSettingPlatformVisibility : uint8
{
	...
	IOS                                      = 16,
	Android                                  = 32,
	EFortSettingPlatformVisibility_MAX       = 33,
};
...
// Enum FortniteUI.EAthenaSpatialElevatorState
// NumValues: 0x0006
...
static_assert(alignof(FHUDMessageOverlaySlotPlacementData) == 0x000004, "Wrong alignment on FHUDMessageOverlaySlotPlacementData");
static_assert(sizeof(FHUDMessageOverlaySlotPlacementData) == 0x000014, "Wrong size on FHUDMessageOverlaySlotPlacementData");
static_assert(offsetof(FHUDMessageOverlaySlotPlacementData, Padding) == 0x000000, "Member 'FHUDMessageOverlaySlotPlacementData::Padding' has a wrong offset!");
static_assert(offsetof(FHUDMessageOverlaySlotPlacementData, HorizontalAlignment) == 0x000010, "Member 'FHUDMessageOverlaySlotPlacementData::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(FHUDMessageOverlaySlotPlacementData, VerticalAlignment) == 0x000011, "Member 'FHUDMessageOverlaySlotPlacementData::VerticalAlignment' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4[0x3AC];                                      // 0x0004(0x03AC)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UFortSetting*>                   SettingRootList;                                   // 0x03B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UFortSetting*>                   SettingWhiteList;                                  // 0x03C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFortSettingsFilterState) == 0x000008, "Wrong alignment on FFortSettingsFilterState");
static_assert(sizeof(FFortSettingsFilterState) == 0x0003D0, "Wrong size on FFortSettingsFilterState");
...
static_assert(offsetof(FFortSettingsFilterState, SettingRootList) == 0x0003B0, "Member 'FFortSettingsFilterState::SettingRootList' has a wrong offset!");
static_assert(offsetof(FFortSettingsFilterState, SettingWhiteList) == 0x0003C0, "Member 'FFortSettingsFilterState::SettingWhiteList' has a wrong offset!");
...
static_assert(sizeof(FFortFocusedBuildingInfo) == 0x000038, "Wrong size on FFortFocusedBuildingInfo");
...
static_assert(offsetof(FFortFocusedBuildingInfo, InteractionType) == 0x000020, "Member 'FFortFocusedBuildingInfo::InteractionType' has a wrong offset!");
static_assert(offsetof(FFortFocusedBuildingInfo, InteractionCost) == 0x000024, "Member 'FFortFocusedBuildingInfo::InteractionCost' has a wrong offset!");
static_assert(offsetof(FFortFocusedBuildingInfo, BuildingMaterial) == 0x000028, "Member 'FFortFocusedBuildingInfo::BuildingMaterial' has a wrong offset!");
static_assert(offsetof(FFortFocusedBuildingInfo, QuickEditClass) == 0x00002C, "Member 'FFortFocusedBuildingInfo::QuickEditClass' has a wrong offset!");
static_assert(offsetof(FFortFocusedBuildingInfo, bIsPlayerBuilt) == 0x000034, "Member 'FFortFocusedBuildingInfo::bIsPlayerBuilt' has a wrong offset!");
...
{
public:
	TArray<class FName>                           StorefrontNames;                                   // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	bool                                          bShowTimerIcon;                                    // 0x002B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableToastNotification;                          // 0x002C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAthenaItemShopSectionDisplayData) == 0x000008, "Wrong alignment on FAthenaItemShopSectionDisplayData");
static_assert(sizeof(FAthenaItemShopSectionDisplayData) == 0x000068, "Wrong size on FAthenaItemShopSectionDisplayData");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, StorefrontNames) == 0x000000, "Member 'FAthenaItemShopSectionDisplayData::StorefrontNames' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, SectionDisplayName) == 0x000010, "Member 'FAthenaItemShopSectionDisplayData::SectionDisplayName' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, bSortOffersByOwnership) == 0x000028, "Member 'FAthenaItemShopSectionDisplayData::bSortOffersByOwnership' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, bShowIneligibleOffers) == 0x000029, "Member 'FAthenaItemShopSectionDisplayData::bShowIneligibleOffers' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, bShowIneligibleOffersIfGiftable) == 0x00002A, "Member 'FAthenaItemShopSectionDisplayData::bShowIneligibleOffersIfGiftable' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, bShowTimerIcon) == 0x00002B, "Member 'FAthenaItemShopSectionDisplayData::bShowTimerIcon' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, bEnableToastNotification) == 0x00002C, "Member 'FAthenaItemShopSectionDisplayData::bEnableToastNotification' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, SectionTag) == 0x000030, "Member 'FAthenaItemShopSectionDisplayData::SectionTag' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, BangType) == 0x000038, "Member 'FAthenaItemShopSectionDisplayData::BangType' has a wrong offset!");
static_assert(offsetof(FAthenaItemShopSectionDisplayData, SectionWidgetClass) == 0x000040, "Member 'FAthenaItemShopSectionDisplayData::SectionWidgetClass' has a wrong offset!");
...
static_assert(alignof(FItemShopCurrencyDislayData) == 0x000008, "Wrong alignment on FItemShopCurrencyDislayData");
static_assert(sizeof(FItemShopCurrencyDislayData) == 0x000010, "Wrong size on FItemShopCurrencyDislayData");
static_assert(offsetof(FItemShopCurrencyDislayData, CurrencyType) == 0x000000, "Member 'FItemShopCurrencyDislayData::CurrencyType' has a wrong offset!");
static_assert(offsetof(FItemShopCurrencyDislayData, OfferTileClass) == 0x000008, "Member 'FItemShopCurrencyDislayData::OfferTileClass' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             ChangeDelegate;                                    // 0x0008(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FPrimaryContentSetup) == 0x000001, "Wrong size on FPrimaryContentSetup");
static_assert(offsetof(FPrimaryContentSetup, ShowBottomBar) == 0x000000, "Member 'FPrimaryContentSetup::ShowBottomBar' has a wrong offset!");
...
public:
	...
	bool                                          bResetOnFinish;                                    // 0x0008(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldAnimateTranslation;                         // 0x0009(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0x6];                                        // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveVector*                           Translation;                                       // 0x0010(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldAnimateScale;                               // 0x0018(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveVector*                           Scale;                                             // 0x0020(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldAnimateAlpha;                               // 0x0028(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            Alpha;                                             // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UWorld*                                 World;                                             // 0x0040(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FFortSimpleWidgetAnimation) == 0x000078, "Wrong size on FFortSimpleWidgetAnimation");
...
static_assert(offsetof(FFortSimpleWidgetAnimation, bResetOnFinish) == 0x000008, "Member 'FFortSimpleWidgetAnimation::bResetOnFinish' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, bShouldAnimateTranslation) == 0x000009, "Member 'FFortSimpleWidgetAnimation::bShouldAnimateTranslation' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, Translation) == 0x000010, "Member 'FFortSimpleWidgetAnimation::Translation' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, bShouldAnimateScale) == 0x000018, "Member 'FFortSimpleWidgetAnimation::bShouldAnimateScale' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, Scale) == 0x000020, "Member 'FFortSimpleWidgetAnimation::Scale' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, bShouldAnimateAlpha) == 0x000028, "Member 'FFortSimpleWidgetAnimation::bShouldAnimateAlpha' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, Alpha) == 0x000030, "Member 'FFortSimpleWidgetAnimation::Alpha' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimation, World) == 0x000040, "Member 'FFortSimpleWidgetAnimation::World' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_Configuration) == 0x0000F8, "Wrong size on FFortItemCard_PowerRatingBlock_Configuration");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, MoonbeamBorderBrush) == 0x000008, "Member 'FFortItemCard_PowerRatingBlock_Configuration::MoonbeamBorderBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, MoonbeamBorderExteriorPadding) == 0x000090, "Member 'FFortItemCard_PowerRatingBlock_Configuration::MoonbeamBorderExteriorPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, MoonbeamBorderPadding) == 0x0000A0, "Member 'FFortItemCard_PowerRatingBlock_Configuration::MoonbeamBorderPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, CustomRatingInternalPadding) == 0x0000B0, "Member 'FFortItemCard_PowerRatingBlock_Configuration::CustomRatingInternalPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, CustomRatingIconSize) == 0x0000C0, "Member 'FFortItemCard_PowerRatingBlock_Configuration::CustomRatingIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, CustomRatingTextStyle) == 0x0000C8, "Member 'FFortItemCard_PowerRatingBlock_Configuration::CustomRatingTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, ComparisonIndicatorSize) == 0x0000F0, "Member 'FFortItemCard_PowerRatingBlock_Configuration::ComparisonIndicatorSize' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration) == 0x000258, "Wrong size on FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, PersonnelPowerRatingIconBrush) == 0x0000F8, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::PersonnelPowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, PersonnelPowerRatingTextStyle) == 0x000180, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::PersonnelPowerRatingTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingIconBrush) == 0x0001A8, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingTextStyle) == 0x000230, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingTextStyle' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_PersonnelAndSchematics_Configuration) == 0x000370, "Wrong size on FFortItemCard_S_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000268, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, Nameplate) == 0x000270, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000308, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000310, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000318, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000320, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000324, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x00032C, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000334, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000348, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x00035C, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeter) == 0x000360, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(offsetof(FFortAthenaTutorialHighlightInfo, ItemHighlightTag) == 0x000008, "Member 'FFortAthenaTutorialHighlightInfo::ItemHighlightTag' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialHighlightInfo, HighlightMargin) == 0x000010, "Member 'FFortAthenaTutorialHighlightInfo::HighlightMargin' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialHighlightInfo, HighlightWidgetOverride) == 0x000020, "Member 'FFortAthenaTutorialHighlightInfo::HighlightWidgetOverride' has a wrong offset!");
...
static_assert(sizeof(FPreviewRewardData) == 0x000088, "Wrong size on FPreviewRewardData");
...
public:
	...
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFortSimpleWidgetAnimation>     Targets;                                           // 0x0010(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnimationsFinished;                              // 0x0020(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_30[0x8];                                       // 0x0030(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortSimpleWidgetAnimations) == 0x000008, "Wrong alignment on FFortSimpleWidgetAnimations");
static_assert(sizeof(FFortSimpleWidgetAnimations) == 0x000038, "Wrong size on FFortSimpleWidgetAnimations");
...
static_assert(offsetof(FFortSimpleWidgetAnimations, bIsEnabled) == 0x000008, "Member 'FFortSimpleWidgetAnimations::bIsEnabled' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimations, Targets) == 0x000010, "Member 'FFortSimpleWidgetAnimations::Targets' has a wrong offset!");
static_assert(offsetof(FFortSimpleWidgetAnimations, OnAnimationsFinished) == 0x000020, "Member 'FFortSimpleWidgetAnimations::OnAnimationsFinished' has a wrong offset!");
...
static_assert(sizeof(FPlaylistFilter) == 0x000018, "Wrong size on FPlaylistFilter");
...
static_assert(sizeof(FLeaderboardFilter) == 0x000020, "Wrong size on FLeaderboardFilter");
...
static_assert(sizeof(FFortTopBarTabButtonInfo) == 0x0000E8, "Wrong size on FFortTopBarTabButtonInfo");
...
static_assert(offsetof(FFortTopBarTabButtonInfo, LinkedUIFeature) == 0x0000B8, "Member 'FFortTopBarTabButtonInfo::LinkedUIFeature' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, BangType) == 0x0000B9, "Member 'FFortTopBarTabButtonInfo::BangType' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bForceImage) == 0x0000BA, "Member 'FFortTopBarTabButtonInfo::bForceImage' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bPrimaryPlayerOnly) == 0x0000BB, "Member 'FFortTopBarTabButtonInfo::bPrimaryPlayerOnly' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bInteractAnalytic) == 0x0000BC, "Member 'FFortTopBarTabButtonInfo::bInteractAnalytic' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, OverrideTabWidget) == 0x0000C0, "Member 'FFortTopBarTabButtonInfo::OverrideTabWidget' has a wrong offset!");
...
static_assert(alignof(FHUDMessageCanvasSlotPlacementData) == 0x000004, "Wrong alignment on FHUDMessageCanvasSlotPlacementData");
static_assert(sizeof(FHUDMessageCanvasSlotPlacementData) == 0x000020, "Wrong size on FHUDMessageCanvasSlotPlacementData");
static_assert(offsetof(FHUDMessageCanvasSlotPlacementData, Anchors) == 0x000000, "Member 'FHUDMessageCanvasSlotPlacementData::Anchors' has a wrong offset!");
static_assert(offsetof(FHUDMessageCanvasSlotPlacementData, Position) == 0x000010, "Member 'FHUDMessageCanvasSlotPlacementData::Position' has a wrong offset!");
static_assert(offsetof(FHUDMessageCanvasSlotPlacementData, Alignment) == 0x000018, "Member 'FHUDMessageCanvasSlotPlacementData::Alignment' has a wrong offset!");
...
static_assert(offsetof(FBattlePassPageData, StartingIndex) == 0x000000, "Member 'FBattlePassPageData::StartingIndex' has a wrong offset!");
static_assert(offsetof(FBattlePassPageData, EndingIndex) == 0x000004, "Member 'FBattlePassPageData::EndingIndex' has a wrong offset!");
...
public:
	...
	class FString                                 OfferButtonText;                                   // 0x00D0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ChallengeCategoryTag;                              // 0x00E0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 WebsiteURL;                                        // 0x00F0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 WebsiteButtonText;                                 // 0x0100(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortUIFeature                                NavigateToTabValue;                                // 0x0110(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 NavigateToTabButtonText;                           // 0x0118(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 STWUpsellButtonText;                               // 0x0128(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_138[0x20];                                     // 0x0138(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 VideoButtonText;                                   // 0x0158(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoVideoString;                                  // 0x0168(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoStreamingVideoID;                             // 0x0178(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoFallbackVideoID;                              // 0x0188(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoProdLinkID;                                   // 0x0198(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoGamedevLinkID;                                // 0x01A8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoAutoplay;                                     // 0x01B8(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoForceAutoplay;                                // 0x01B9(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoLoop;                                         // 0x01BA(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoMute;                                         // 0x01BB(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoFullscreen;                                   // 0x01BC(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          VideoStreamingEnabled;                             // 0x01BD(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1BE[0x2];                                      // 0x01BE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 VideoUID;                                          // 0x01C0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAthenaNewsEntry) == 0x0001D8, "Wrong size on FAthenaNewsEntry");
static_assert(offsetof(FAthenaNewsEntry, EntryType) == 0x000000, "Member 'FAthenaNewsEntry::EntryType' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, ID) == 0x000008, "Member 'FAthenaNewsEntry::ID' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, TabTitleOverride) == 0x000018, "Member 'FAthenaNewsEntry::TabTitleOverride' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, Title) == 0x000028, "Member 'FAthenaNewsEntry::Title' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, Body) == 0x000038, "Member 'FAthenaNewsEntry::Body' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, Image) == 0x000048, "Member 'FAthenaNewsEntry::Image' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, TileImage) == 0x000058, "Member 'FAthenaNewsEntry::TileImage' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, ButtonTextOverride) == 0x000068, "Member 'FAthenaNewsEntry::ButtonTextOverride' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, AdSpace) == 0x000078, "Member 'FAthenaNewsEntry::AdSpace' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, SpotLight) == 0x000088, "Member 'FAthenaNewsEntry::SpotLight' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, bHidden) == 0x000089, "Member 'FAthenaNewsEntry::bHidden' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, SubGameFilter) == 0x00008C, "Member 'FAthenaNewsEntry::SubGameFilter' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, PlaylistId) == 0x000090, "Member 'FAthenaNewsEntry::PlaylistId' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, bHasCustomColor) == 0x0000A0, "Member 'FAthenaNewsEntry::bHasCustomColor' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, CustomDarkColor) == 0x0000A4, "Member 'FAthenaNewsEntry::CustomDarkColor' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, CustomLightColor) == 0x0000A8, "Member 'FAthenaNewsEntry::CustomLightColor' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, SortingPriority) == 0x0000B0, "Member 'FAthenaNewsEntry::SortingPriority' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, ExperimentPercent) == 0x0000B8, "Member 'FAthenaNewsEntry::ExperimentPercent' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, ExperimentId) == 0x0000BC, "Member 'FAthenaNewsEntry::ExperimentId' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, OfferId) == 0x0000C0, "Member 'FAthenaNewsEntry::OfferId' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, OfferButtonText) == 0x0000D0, "Member 'FAthenaNewsEntry::OfferButtonText' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, ChallengeCategoryTag) == 0x0000E0, "Member 'FAthenaNewsEntry::ChallengeCategoryTag' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, WebsiteURL) == 0x0000F0, "Member 'FAthenaNewsEntry::WebsiteURL' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, WebsiteButtonText) == 0x000100, "Member 'FAthenaNewsEntry::WebsiteButtonText' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, NavigateToTabValue) == 0x000110, "Member 'FAthenaNewsEntry::NavigateToTabValue' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, NavigateToTabButtonText) == 0x000118, "Member 'FAthenaNewsEntry::NavigateToTabButtonText' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, STWUpsellButtonText) == 0x000128, "Member 'FAthenaNewsEntry::STWUpsellButtonText' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoButtonText) == 0x000158, "Member 'FAthenaNewsEntry::VideoButtonText' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoVideoString) == 0x000168, "Member 'FAthenaNewsEntry::VideoVideoString' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoStreamingVideoID) == 0x000178, "Member 'FAthenaNewsEntry::VideoStreamingVideoID' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoFallbackVideoID) == 0x000188, "Member 'FAthenaNewsEntry::VideoFallbackVideoID' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoProdLinkID) == 0x000198, "Member 'FAthenaNewsEntry::VideoProdLinkID' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoGamedevLinkID) == 0x0001A8, "Member 'FAthenaNewsEntry::VideoGamedevLinkID' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoAutoplay) == 0x0001B8, "Member 'FAthenaNewsEntry::VideoAutoplay' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoForceAutoplay) == 0x0001B9, "Member 'FAthenaNewsEntry::VideoForceAutoplay' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoLoop) == 0x0001BA, "Member 'FAthenaNewsEntry::VideoLoop' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoMute) == 0x0001BB, "Member 'FAthenaNewsEntry::VideoMute' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoFullscreen) == 0x0001BC, "Member 'FAthenaNewsEntry::VideoFullscreen' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoStreamingEnabled) == 0x0001BD, "Member 'FAthenaNewsEntry::VideoStreamingEnabled' has a wrong offset!");
static_assert(offsetof(FAthenaNewsEntry, VideoUID) == 0x0001C0, "Member 'FAthenaNewsEntry::VideoUID' has a wrong offset!");
...
static_assert(offsetof(FAthenaPlaylistEntry, bIsCMSDataHidden) == 0x000076, "Member 'FAthenaPlaylistEntry::bIsCMSDataHidden' has a wrong offset!");
...
static_assert(sizeof(FShowdownLatestTournamentData) == 0x000060, "Wrong size on FShowdownLatestTournamentData");
static_assert(offsetof(FShowdownLatestTournamentData, LastModified) == 0x000000, "Member 'FShowdownLatestTournamentData::LastModified' has a wrong offset!");
static_assert(offsetof(FShowdownLatestTournamentData, Entries) == 0x000010, "Member 'FShowdownLatestTournamentData::Entries' has a wrong offset!");
...
static_assert(sizeof(FCmsJsonMessages) == 0x0002E8, "Wrong size on FCmsJsonMessages");
...
static_assert(sizeof(FVideoConfig_Mono) == 0x000060, "Wrong size on FVideoConfig_Mono");
...
static_assert(offsetof(FVideoConfig_Mono, StreamingVideoID) == 0x000010, "Member 'FVideoConfig_Mono::StreamingVideoID' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, FallbackVideoID) == 0x000018, "Member 'FVideoConfig_Mono::FallbackVideoID' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, ProdLinkID) == 0x000020, "Member 'FVideoConfig_Mono::ProdLinkID' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, GamedevLinkID) == 0x000030, "Member 'FVideoConfig_Mono::GamedevLinkID' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, bIsAutoPlay) == 0x000040, "Member 'FVideoConfig_Mono::bIsAutoPlay' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, bForceAutoPlay) == 0x000041, "Member 'FVideoConfig_Mono::bForceAutoPlay' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, bStreamingEnabled) == 0x000042, "Member 'FVideoConfig_Mono::bStreamingEnabled' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, VideoUID) == 0x000048, "Member 'FVideoConfig_Mono::VideoUID' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, bShouldBeModal) == 0x000058, "Member 'FVideoConfig_Mono::bShouldBeModal' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, bUseSkipBoundaries) == 0x000059, "Member 'FVideoConfig_Mono::bUseSkipBoundaries' has a wrong offset!");
static_assert(offsetof(FVideoConfig_Mono, bKairosPlayer) == 0x00005A, "Member 'FVideoConfig_Mono::bKairosPlayer' has a wrong offset!");
...
public:
	...
	TArray<class FName>                           KeybindWidget_NameArray;                           // 0x0090(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           KeybindWidget_GamepadNameArray;                    // 0x00A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<struct FFortAthenaTutorialHighlightInfo> HighlightInfo;                                     // 0x00B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortAthenaTutorialScreenInfo) == 0x0000D0, "Wrong size on FFortAthenaTutorialScreenInfo");
...
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptPosition) == 0x000004, "Member 'FFortAthenaTutorialScreenInfo::TextPromptPosition' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptPosition_AthenaHUD) == 0x00000C, "Member 'FFortAthenaTutorialScreenInfo::TextPromptPosition_AthenaHUD' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptAnchors) == 0x000014, "Member 'FFortAthenaTutorialScreenInfo::TextPromptAnchors' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptAnchors_AthenaHUD) == 0x000024, "Member 'FFortAthenaTutorialScreenInfo::TextPromptAnchors_AthenaHUD' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptText_Touch) == 0x000038, "Member 'FFortAthenaTutorialScreenInfo::TextPromptText_Touch' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptText_Gamepad) == 0x000050, "Member 'FFortAthenaTutorialScreenInfo::TextPromptText_Gamepad' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, TextPromptText_TouchLegacy) == 0x000068, "Member 'FFortAthenaTutorialScreenInfo::TextPromptText_TouchLegacy' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, ActionWidget_DataTableRow) == 0x000080, "Member 'FFortAthenaTutorialScreenInfo::ActionWidget_DataTableRow' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, KeybindWidget_NameArray) == 0x000090, "Member 'FFortAthenaTutorialScreenInfo::KeybindWidget_NameArray' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, KeybindWidget_GamepadNameArray) == 0x0000A0, "Member 'FFortAthenaTutorialScreenInfo::KeybindWidget_GamepadNameArray' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, ForceSingleInputKeybind) == 0x0000B0, "Member 'FFortAthenaTutorialScreenInfo::ForceSingleInputKeybind' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, HighlightInfo) == 0x0000B8, "Member 'FFortAthenaTutorialScreenInfo::HighlightInfo' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, DisplayNextButton) == 0x0000C8, "Member 'FFortAthenaTutorialScreenInfo::DisplayNextButton' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, DisplayTextPromptTarget) == 0x0000C9, "Member 'FFortAthenaTutorialScreenInfo::DisplayTextPromptTarget' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, ExtraWidget) == 0x0000CA, "Member 'FFortAthenaTutorialScreenInfo::ExtraWidget' has a wrong offset!");
...
static_assert(sizeof(FFortAthenaTutorialStandaloneStepInfo) == 0x0000D8, "Wrong size on FFortAthenaTutorialStandaloneStepInfo");
...
static_assert(sizeof(FFortBattlePassVideoAnnotation) == 0x000020, "Wrong size on FFortBattlePassVideoAnnotation");
...
static_assert(offsetof(FFortBattlePassVideoAnnotation, EntryAngle) == 0x000010, "Member 'FFortBattlePassVideoAnnotation::EntryAngle' has a wrong offset!");
static_assert(offsetof(FFortBattlePassVideoAnnotation, EntryMagnitude) == 0x000014, "Member 'FFortBattlePassVideoAnnotation::EntryMagnitude' has a wrong offset!");
static_assert(offsetof(FFortBattlePassVideoAnnotation, RewardItemDefinition) == 0x000018, "Member 'FFortBattlePassVideoAnnotation::RewardItemDefinition' has a wrong offset!");
...
static_assert(alignof(FVaultVariantOverrideOption) == 0x000004, "Wrong alignment on FVaultVariantOverrideOption");
static_assert(sizeof(FVaultVariantOverrideOption) == 0x000010, "Wrong size on FVaultVariantOverrideOption");
...
static_assert(offsetof(FVaultVariantOverrideOption, VariantTagOverride) == 0x000008, "Member 'FVaultVariantOverrideOption::VariantTagOverride' has a wrong offset!");
...
public:
	...
	class FName                                   BannerRowName;                                     // 0x000C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ItemVariantPreviewIndex;                           // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasEtherealBackground;                            // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVaultVariantOverrideOption>    VariantOverrides;                                  // 0x0020(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FItemPreviewSettings) == 0x000008, "Wrong alignment on FItemPreviewSettings");
static_assert(sizeof(FItemPreviewSettings) == 0x000030, "Wrong size on FItemPreviewSettings");
...
static_assert(offsetof(FItemPreviewSettings, BannerRowName) == 0x00000C, "Member 'FItemPreviewSettings::BannerRowName' has a wrong offset!");
static_assert(offsetof(FItemPreviewSettings, ItemVariantPreviewIndex) == 0x000014, "Member 'FItemPreviewSettings::ItemVariantPreviewIndex' has a wrong offset!");
static_assert(offsetof(FItemPreviewSettings, bHasEtherealBackground) == 0x000018, "Member 'FItemPreviewSettings::bHasEtherealBackground' has a wrong offset!");
static_assert(offsetof(FItemPreviewSettings, VariantOverrides) == 0x000020, "Member 'FItemPreviewSettings::VariantOverrides' has a wrong offset!");
...
static_assert(alignof(FContextPosition) == 0x000004, "Wrong alignment on FContextPosition");
static_assert(sizeof(FContextPosition) == 0x000010, "Wrong size on FContextPosition");
static_assert(offsetof(FContextPosition, Platform) == 0x000000, "Member 'FContextPosition::Platform' has a wrong offset!");
static_assert(offsetof(FContextPosition, Position) == 0x000004, "Member 'FContextPosition::Position' has a wrong offset!");
static_assert(offsetof(FContextPosition, HorizontalAlignment) == 0x00000C, "Member 'FContextPosition::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(FContextPosition, VerticalAlignment) == 0x00000D, "Member 'FContextPosition::VerticalAlignment' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             ChangeDelegate;                                    // 0x0000(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration) == 0x0001A8, "Wrong size on FFortItemCard_PowerRatingBlock_ItemInstance_Configuration");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration, PowerRatingIconBrush) == 0x0000F8, "Member 'FFortItemCard_PowerRatingBlock_ItemInstance_Configuration::PowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration, PowerRatingTextStyle) == 0x000180, "Member 'FFortItemCard_PowerRatingBlock_ItemInstance_Configuration::PowerRatingTextStyle' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XS_ItemInstance_Configuration) == 0x000230, "Wrong size on FFortItemCard_XS_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, BookmarkImageSize) == 0x0001C8, "Member 'FFortItemCard_XS_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, TraitBoxPadding) == 0x0001D0, "Member 'FFortItemCard_XS_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, FirstTraitSize) == 0x0001E0, "Member 'FFortItemCard_XS_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, StackCountBlock) == 0x0001E8, "Member 'FFortItemCard_XS_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, DurabilityMeter) == 0x000218, "Member 'FFortItemCard_XS_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_ItemInstance_Configuration) == 0x000248, "Wrong size on FFortItemCard_S_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, BookmarkImageSize) == 0x0001C8, "Member 'FFortItemCard_S_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, StackCountBlock) == 0x0001D0, "Member 'FFortItemCard_S_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TraitBoxPadding) == 0x000200, "Member 'FFortItemCard_S_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, FirstTraitSize) == 0x000210, "Member 'FFortItemCard_S_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeterPadding) == 0x000218, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeter) == 0x000228, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, DurabilityMeter) == 0x000234, "Member 'FFortItemCard_S_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_M_ItemInstance_Configuration) == 0x000258, "Wrong size on FFortItemCard_M_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, BookmarkImageSize) == 0x0001C8, "Member 'FFortItemCard_M_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, StackCountBlock) == 0x0001D0, "Member 'FFortItemCard_M_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TraitBoxPadding) == 0x000200, "Member 'FFortItemCard_M_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, FirstTraitSize) == 0x000210, "Member 'FFortItemCard_M_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000218, "Member 'FFortItemCard_M_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, SecondTraitSize) == 0x00021C, "Member 'FFortItemCard_M_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeterPadding) == 0x000224, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeter) == 0x000234, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, DurabilityMeter) == 0x000240, "Member 'FFortItemCard_M_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_M_PersonnelAndSchematics_Configuration) == 0x000370, "Wrong size on FFortItemCard_M_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000268, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, Nameplate) == 0x000270, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000308, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000310, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000318, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000320, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000324, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x00032C, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000334, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000348, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x00035C, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeter) == 0x000360, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_ItemInstance_Configuration) == 0x000258, "Wrong size on FFortItemCard_L_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, BookmarkImageSize) == 0x0001C8, "Member 'FFortItemCard_L_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, StackCountBlock) == 0x0001D0, "Member 'FFortItemCard_L_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TraitBoxPadding) == 0x000200, "Member 'FFortItemCard_L_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, FirstTraitSize) == 0x000210, "Member 'FFortItemCard_L_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000218, "Member 'FFortItemCard_L_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, SecondTraitSize) == 0x00021C, "Member 'FFortItemCard_L_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeterPadding) == 0x000224, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeter) == 0x000234, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, DurabilityMeter) == 0x000240, "Member 'FFortItemCard_L_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_PersonnelAndSchematics_Configuration) == 0x000370, "Wrong size on FFortItemCard_L_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000268, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, Nameplate) == 0x000270, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000308, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000310, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000318, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000320, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000324, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x00032C, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000334, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000348, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x00035C, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeter) == 0x000360, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XL_ItemInstance_Configuration) == 0x000258, "Wrong size on FFortItemCard_XL_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, BookmarkImageSize) == 0x0001C8, "Member 'FFortItemCard_XL_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, StackCountBlock) == 0x0001D0, "Member 'FFortItemCard_XL_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TraitBoxPadding) == 0x000200, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, FirstTraitSize) == 0x000210, "Member 'FFortItemCard_XL_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000218, "Member 'FFortItemCard_XL_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, SecondTraitSize) == 0x00021C, "Member 'FFortItemCard_XL_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeterPadding) == 0x000224, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeter) == 0x000234, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, DurabilityMeter) == 0x000240, "Member 'FFortItemCard_XL_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XL_PersonnelAndSchematics_Configuration) == 0x0003F8, "Wrong size on FFortItemCard_XL_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000268, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, Nameplate) == 0x000270, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ItemNameTextStyle) == 0x000308, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ItemNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000330, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000338, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000340, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000344, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x00034C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000354, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextLeftPadding) == 0x000368, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextStyle) == 0x000370, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconImageLeftPadding) == 0x000398, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconImageLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x00039C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenClassIconAndName) == 0x0003A4, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenClassIconAndName' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassNameTextStyle) == 0x0003A8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x0003D0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeter) == 0x0003D4, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplatePadding) == 0x0003E0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplatePadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplateSize) == 0x0003F0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplateSize' has a wrong offset!");
...
static_assert(sizeof(FInterpolatedTransitionCamera) == 0x000040, "Wrong size on FInterpolatedTransitionCamera");
...
static_assert(offsetof(FInterpolatedTransitionCamera, FieldOfView) == 0x000030, "Member 'FInterpolatedTransitionCamera::FieldOfView' has a wrong offset!");
...
static_assert(sizeof(FSceneTransitionOptions) == 0x000001, "Wrong size on FSceneTransitionOptions");
...
static_assert(alignof(FHudLayoutToolProxyPropertyData) == 0x000008, "Wrong alignment on FHudLayoutToolProxyPropertyData");
static_assert(sizeof(FHudLayoutToolProxyPropertyData) == 0x000030, "Wrong size on FHudLayoutToolProxyPropertyData");
static_assert(offsetof(FHudLayoutToolProxyPropertyData, Default) == 0x000000, "Member 'FHudLayoutToolProxyPropertyData::Default' has a wrong offset!");
static_assert(offsetof(FHudLayoutToolProxyPropertyData, Value) == 0x000004, "Member 'FHudLayoutToolProxyPropertyData::Value' has a wrong offset!");
static_assert(offsetof(FHudLayoutToolProxyPropertyData, MinValue) == 0x000008, "Member 'FHudLayoutToolProxyPropertyData::MinValue' has a wrong offset!");
static_assert(offsetof(FHudLayoutToolProxyPropertyData, MaxValue) == 0x00000C, "Member 'FHudLayoutToolProxyPropertyData::MaxValue' has a wrong offset!");
static_assert(offsetof(FHudLayoutToolProxyPropertyData, Type) == 0x000010, "Member 'FHudLayoutToolProxyPropertyData::Type' has a wrong offset!");
static_assert(offsetof(FHudLayoutToolProxyPropertyData, DisplayName) == 0x000018, "Member 'FHudLayoutToolProxyPropertyData::DisplayName' has a wrong offset!");
...
static_assert(sizeof(FIconPicker) == 0x000028, "Wrong size on FIconPicker");
static_assert(offsetof(FIconPicker, Tags) == 0x000000, "Member 'FIconPicker::Tags' has a wrong offset!");
static_assert(offsetof(FIconPicker, Sprite) == 0x000020, "Member 'FIconPicker::Sprite' has a wrong offset!");
...
static_assert(sizeof(FFortMobileHUDWidgetLayout) == 0x000038, "Wrong size on FFortMobileHUDWidgetLayout");
...
static_assert(sizeof(FHUDWidgetBehaviorRegistryEntry) == 0x000018, "Wrong size on FHUDWidgetBehaviorRegistryEntry");
...
static_assert(offsetof(FHUDWidgetBehaviorRegistryEntry, HUDWidgetOverrideTag) == 0x000008, "Member 'FHUDWidgetBehaviorRegistryEntry::HUDWidgetOverrideTag' has a wrong offset!");
static_assert(offsetof(FHUDWidgetBehaviorRegistryEntry, HUDWidgetBehaviorClass) == 0x000010, "Member 'FHUDWidgetBehaviorRegistryEntry::HUDWidgetBehaviorClass' has a wrong offset!");
...
static_assert(offsetof(FHUDWidgetRegistryEntry, bIsMandatory) == 0x000008, "Member 'FHUDWidgetRegistryEntry::bIsMandatory' has a wrong offset!");
static_assert(offsetof(FHUDWidgetRegistryEntry, MandatoryOnScreenPercent) == 0x00000C, "Member 'FHUDWidgetRegistryEntry::MandatoryOnScreenPercent' has a wrong offset!");
static_assert(offsetof(FHUDWidgetRegistryEntry, MaximumAmountOfInstances) == 0x000010, "Member 'FHUDWidgetRegistryEntry::MaximumAmountOfInstances' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct FCameraWidgetBinding final
{
public:
	struct FGameplayTag                           CameraTag;                                         // 0x0000(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ScreenTag;                                         // 0x0008(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCameraWidgetBinding) == 0x000004, "Wrong alignment on FCameraWidgetBinding");
static_assert(sizeof(FCameraWidgetBinding) == 0x000010, "Wrong size on FCameraWidgetBinding");
static_assert(offsetof(FCameraWidgetBinding, CameraTag) == 0x000000, "Member 'FCameraWidgetBinding::CameraTag' has a wrong offset!");
static_assert(offsetof(FCameraWidgetBinding, ScreenTag) == 0x000008, "Member 'FCameraWidgetBinding::ScreenTag' has a wrong offset!");
...
static_assert(sizeof(FUIStateTag) == 0x000008, "Wrong size on FUIStateTag");
...
static_assert(alignof(FAthenaUIStateTag) == 0x000004, "Wrong alignment on FAthenaUIStateTag");
static_assert(sizeof(FAthenaUIStateTag) == 0x000008, "Wrong size on FAthenaUIStateTag");
...
static_assert(alignof(FFortStartupUIStateTag) == 0x000004, "Wrong alignment on FFortStartupUIStateTag");
static_assert(sizeof(FFortStartupUIStateTag) == 0x000008, "Wrong size on FFortStartupUIStateTag");
...
static_assert(sizeof(FFortVideoInfo) == 0x000038, "Wrong size on FFortVideoInfo");
...
static_assert(offsetof(FFortVideoInfo, RequiredActiveQuest) == 0x000028, "Member 'FFortVideoInfo::RequiredActiveQuest' has a wrong offset!");
...
static_assert(alignof(FCameraToWinterQuestViewState) == 0x000008, "Wrong alignment on FCameraToWinterQuestViewState");
static_assert(sizeof(FCameraToWinterQuestViewState) == 0x000028, "Wrong size on FCameraToWinterQuestViewState");
static_assert(offsetof(FCameraToWinterQuestViewState, UIViewState) == 0x000000, "Member 'FCameraToWinterQuestViewState::UIViewState' has a wrong offset!");
static_assert(offsetof(FCameraToWinterQuestViewState, CameraTagsToSetFrom) == 0x000008, "Member 'FCameraToWinterQuestViewState::CameraTagsToSetFrom' has a wrong offset!");
...
static_assert(offsetof(FGGCenterDisplayEntry, bIsFinal) == 0x000015, "Member 'FGGCenterDisplayEntry::bIsFinal' has a wrong offset!");
...
// 0x0050 (0x0050 - 0x0000)
struct FHUDLayoutToolPreset final
{
public:
	class FText                                   PresetName;                                        // 0x0000(0x0018)(Edit, NativeAccessSpecifierPrivate)
	class FText                                   PresetDescription;                                 // 0x0018(0x0018)(Edit, NativeAccessSpecifierPrivate)
	class FString                                 HUDLayoutSave;                                     // 0x0030(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTexture2D*                             PresetPreviewImage;                                // 0x0040(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsRecommended;                                    // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FHUDLayoutToolPreset) == 0x000008, "Wrong alignment on FHUDLayoutToolPreset");
static_assert(sizeof(FHUDLayoutToolPreset) == 0x000050, "Wrong size on FHUDLayoutToolPreset");
static_assert(offsetof(FHUDLayoutToolPreset, PresetName) == 0x000000, "Member 'FHUDLayoutToolPreset::PresetName' has a wrong offset!");
static_assert(offsetof(FHUDLayoutToolPreset, PresetDescription) == 0x000018, "Member 'FHUDLayoutToolPreset::PresetDescription' has a wrong offset!");
static_assert(offsetof(FHUDLayoutToolPreset, HUDLayoutSave) == 0x000030, "Member 'FHUDLayoutToolPreset::HUDLayoutSave' has a wrong offset!");
static_assert(offsetof(FHUDLayoutToolPreset, PresetPreviewImage) == 0x000040, "Member 'FHUDLayoutToolPreset::PresetPreviewImage' has a wrong offset!");
static_assert(offsetof(FHUDLayoutToolPreset, bIsRecommended) == 0x000048, "Member 'FHUDLayoutToolPreset::bIsRecommended' has a wrong offset!");
...
static_assert(alignof(FHUDLayoutToolV2_ButtonStateColor) == 0x000008, "Wrong alignment on FHUDLayoutToolV2_ButtonStateColor");
static_assert(sizeof(FHUDLayoutToolV2_ButtonStateColor) == 0x000050, "Wrong size on FHUDLayoutToolV2_ButtonStateColor");
...
static_assert(offsetof(FHUDLayoutToolV2_ButtonStateColor, IconColor) == 0x000028, "Member 'FHUDLayoutToolV2_ButtonStateColor::IconColor' has a wrong offset!");
static_assert(offsetof(FHUDLayoutToolV2_ButtonStateColor, BackgroundColor) == 0x000038, "Member 'FHUDLayoutToolV2_ButtonStateColor::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FHUDLayoutToolV2_ButtonStateColor, IconAngle) == 0x000048, "Member 'FHUDLayoutToolV2_ButtonStateColor::IconAngle' has a wrong offset!");
...
// 0x0018 (0x0018 - 0x0000)
struct FSpatialCustomizationCategoryData final
{
public:
	struct FGameplayTag                           VariantChannelTag;                                 // 0x0000(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortTokenType*                         CategoryKey;                                       // 0x0008(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   CategoryPartName;                                  // 0x0010(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSpatialCustomizationCategoryData) == 0x000008, "Wrong alignment on FSpatialCustomizationCategoryData");
static_assert(sizeof(FSpatialCustomizationCategoryData) == 0x000018, "Wrong size on FSpatialCustomizationCategoryData");
static_assert(offsetof(FSpatialCustomizationCategoryData, VariantChannelTag) == 0x000000, "Member 'FSpatialCustomizationCategoryData::VariantChannelTag' has a wrong offset!");
static_assert(offsetof(FSpatialCustomizationCategoryData, CategoryKey) == 0x000008, "Member 'FSpatialCustomizationCategoryData::CategoryKey' has a wrong offset!");
static_assert(offsetof(FSpatialCustomizationCategoryData, CategoryPartName) == 0x000010, "Member 'FSpatialCustomizationCategoryData::CategoryPartName' has a wrong offset!");

// ScriptStruct FortniteUI.HenchmenData
// 0x00F8 (0x00F8 - 0x0000)
struct FHenchmenData final
{
public:
	class UAthenaCharacterItemDefinition*         HenchmanItemDef;                                   // 0x0000(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortQuestItemDefinition*               EgoQuest;                                          // 0x0008(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVariantTokenType*                  EgoSide;                                           // 0x0010(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAnimationAsset*                        EgoIdleAnimation;                                  // 0x0018(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLoopEgoIdleAnimation;                             // 0x0020(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortQuestItemDefinition*               AlterQuest;                                        // 0x0028(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortVariantTokenType*                  AlterSide;                                         // 0x0030(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAnimationAsset*                        AlterIdleAnimation;                                // 0x0038(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLoopAlterIdleAnimation;                           // 0x0040(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimationAsset*                        DefaultIdleAnimation;                              // 0x0048(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bLoopDefaultIdleAnimation;                         // 0x0050(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortChallengeBundleItemDefinition*     UnlockChallengeBundle;                             // 0x0058(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortChallengeBundleItemDefinition*     AB_ChallengeBundle;                                // 0x0060(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortQuestItemDefinition*               QuestToUnlockAB;                                   // 0x0068(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           MannequinActorTag;                                 // 0x0070(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           HenchmanRoomRootCameraTag;                         // 0x0078(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           HenchmanRoomIntroCameraTag;                        // 0x0080(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           HenchmanFactionSelectionCamera;                    // 0x0088(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           EgoFactionDetailCamera;                            // 0x0090(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           AlterFactionDetailCamera;                          // 0x0098(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           OverrideScreenTag;                                 // 0x00A0(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UObject>                 HenchmanAboutImage;                                // 0x00A8(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   HenchmanAboutTitle;                                // 0x00D0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TArray<class FText>                           HenchmanAboutEntrie;                               // 0x00E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHenchmenData) == 0x000008, "Wrong alignment on FHenchmenData");
static_assert(sizeof(FHenchmenData) == 0x0000F8, "Wrong size on FHenchmenData");
static_assert(offsetof(FHenchmenData, HenchmanItemDef) == 0x000000, "Member 'FHenchmenData::HenchmanItemDef' has a wrong offset!");
static_assert(offsetof(FHenchmenData, EgoQuest) == 0x000008, "Member 'FHenchmenData::EgoQuest' has a wrong offset!");
static_assert(offsetof(FHenchmenData, EgoSide) == 0x000010, "Member 'FHenchmenData::EgoSide' has a wrong offset!");
static_assert(offsetof(FHenchmenData, EgoIdleAnimation) == 0x000018, "Member 'FHenchmenData::EgoIdleAnimation' has a wrong offset!");
static_assert(offsetof(FHenchmenData, bLoopEgoIdleAnimation) == 0x000020, "Member 'FHenchmenData::bLoopEgoIdleAnimation' has a wrong offset!");
static_assert(offsetof(FHenchmenData, AlterQuest) == 0x000028, "Member 'FHenchmenData::AlterQuest' has a wrong offset!");
static_assert(offsetof(FHenchmenData, AlterSide) == 0x000030, "Member 'FHenchmenData::AlterSide' has a wrong offset!");
static_assert(offsetof(FHenchmenData, AlterIdleAnimation) == 0x000038, "Member 'FHenchmenData::AlterIdleAnimation' has a wrong offset!");
static_assert(offsetof(FHenchmenData, bLoopAlterIdleAnimation) == 0x000040, "Member 'FHenchmenData::bLoopAlterIdleAnimation' has a wrong offset!");
static_assert(offsetof(FHenchmenData, DefaultIdleAnimation) == 0x000048, "Member 'FHenchmenData::DefaultIdleAnimation' has a wrong offset!");
static_assert(offsetof(FHenchmenData, bLoopDefaultIdleAnimation) == 0x000050, "Member 'FHenchmenData::bLoopDefaultIdleAnimation' has a wrong offset!");
static_assert(offsetof(FHenchmenData, UnlockChallengeBundle) == 0x000058, "Member 'FHenchmenData::UnlockChallengeBundle' has a wrong offset!");
static_assert(offsetof(FHenchmenData, AB_ChallengeBundle) == 0x000060, "Member 'FHenchmenData::AB_ChallengeBundle' has a wrong offset!");
static_assert(offsetof(FHenchmenData, QuestToUnlockAB) == 0x000068, "Member 'FHenchmenData::QuestToUnlockAB' has a wrong offset!");
static_assert(offsetof(FHenchmenData, MannequinActorTag) == 0x000070, "Member 'FHenchmenData::MannequinActorTag' has a wrong offset!");
static_assert(offsetof(FHenchmenData, HenchmanRoomRootCameraTag) == 0x000078, "Member 'FHenchmenData::HenchmanRoomRootCameraTag' has a wrong offset!");
static_assert(offsetof(FHenchmenData, HenchmanRoomIntroCameraTag) == 0x000080, "Member 'FHenchmenData::HenchmanRoomIntroCameraTag' has a wrong offset!");
static_assert(offsetof(FHenchmenData, HenchmanFactionSelectionCamera) == 0x000088, "Member 'FHenchmenData::HenchmanFactionSelectionCamera' has a wrong offset!");
static_assert(offsetof(FHenchmenData, EgoFactionDetailCamera) == 0x000090, "Member 'FHenchmenData::EgoFactionDetailCamera' has a wrong offset!");
static_assert(offsetof(FHenchmenData, AlterFactionDetailCamera) == 0x000098, "Member 'FHenchmenData::AlterFactionDetailCamera' has a wrong offset!");
static_assert(offsetof(FHenchmenData, OverrideScreenTag) == 0x0000A0, "Member 'FHenchmenData::OverrideScreenTag' has a wrong offset!");
static_assert(offsetof(FHenchmenData, HenchmanAboutImage) == 0x0000A8, "Member 'FHenchmenData::HenchmanAboutImage' has a wrong offset!");
static_assert(offsetof(FHenchmenData, HenchmanAboutTitle) == 0x0000D0, "Member 'FHenchmenData::HenchmanAboutTitle' has a wrong offset!");
static_assert(offsetof(FHenchmenData, HenchmanAboutEntrie) == 0x0000E8, "Member 'FHenchmenData::HenchmanAboutEntrie' has a wrong offset!");
