...
static_assert(alignof(CommonButton_SetHoveredSoundOverride) == 0x000008, "Wrong alignment on CommonButton_SetHoveredSoundOverride");
static_assert(sizeof(CommonButton_SetHoveredSoundOverride) == 0x000008, "Wrong size on CommonButton_SetHoveredSoundOverride");
static_assert(offsetof(CommonButton_SetHoveredSoundOverride, Sound) == 0x000000, "Member 'CommonButton_SetHoveredSoundOverride::Sound' has a wrong offset!");
...
static_assert(alignof(CommonButton_SetPressedSoundOverride) == 0x000008, "Wrong alignment on CommonButton_SetPressedSoundOverride");
static_assert(sizeof(CommonButton_SetPressedSoundOverride) == 0x000008, "Wrong size on CommonButton_SetPressedSoundOverride");
static_assert(offsetof(CommonButton_SetPressedSoundOverride, Sound) == 0x000000, "Member 'CommonButton_SetPressedSoundOverride::Sound' has a wrong offset!");
...
static_assert(alignof(CommonButtonGroup_GetSelectedButton) == 0x000008, "Wrong alignment on CommonButtonGroup_GetSelectedButton");
static_assert(sizeof(CommonButtonGroup_GetSelectedButton) == 0x000008, "Wrong size on CommonButtonGroup_GetSelectedButton");
static_assert(offsetof(CommonButtonGroup_GetSelectedButton, ReturnValue) == 0x000000, "Member 'CommonButtonGroup_GetSelectedButton::ReturnValue' has a wrong offset!");
