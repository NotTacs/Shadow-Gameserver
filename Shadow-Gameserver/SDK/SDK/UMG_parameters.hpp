...
static_assert(sizeof(RichTextBlock_SetDefaultFont) == 0x000050, "Wrong size on RichTextBlock_SetDefaultFont");
...
static_assert(sizeof(RichTextBlock_SetDefaultTextStyle) == 0x000268, "Wrong size on RichTextBlock_SetDefaultTextStyle");
...
static_assert(sizeof(MultiLineEditableText_SetWidgetStyle) == 0x000268, "Wrong size on MultiLineEditableText_SetWidgetStyle");
...
static_assert(sizeof(MultiLineEditableTextBox_SetTextStyle) == 0x000268, "Wrong size on MultiLineEditableTextBox_SetTextStyle");
...
static_assert(sizeof(WidgetInteractionComponent_SetCustomHitResult) == 0x00008C, "Wrong size on WidgetInteractionComponent_SetCustomHitResult");
...
static_assert(sizeof(WidgetInteractionComponent_GetLastHitResult) == 0x00008C, "Wrong size on WidgetInteractionComponent_GetLastHitResult");
