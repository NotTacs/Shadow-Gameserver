...
public:
	...
	TMap<uint32, struct FPointWeightMap>          WeightMaps;                                        // 0x0030(0x0050)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FClothLODDataCommon) == 0x000158, "Wrong size on FClothLODDataCommon");
