...
static_assert(offsetof(AthenaMapChallengeCategoryRotator_C_BP_OnOptionSelected, Param_Index) == 0x000000, "Member 'AthenaMapChallengeCategoryRotator_C_BP_OnOptionSelected::Param_Index' has a wrong offset!");
