...
static_assert(sizeof(GeometryCollectionActor_RaycastSingle) == 0x0000A8, "Wrong size on GeometryCollectionActor_RaycastSingle");
...
static_assert(offsetof(GeometryCollectionActor_RaycastSingle, ReturnValue) == 0x0000A4, "Member 'GeometryCollectionActor_RaycastSingle::ReturnValue' has a wrong offset!");
