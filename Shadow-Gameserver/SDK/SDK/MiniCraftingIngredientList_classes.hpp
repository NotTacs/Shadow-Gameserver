...
public:
	...
	class UWrapBox*                               EntriesWrapBox;                                    // 0x02F0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UMiniCraftingIngredientList_C) == 0x0002F8, "Wrong size on UMiniCraftingIngredientList_C");
static_assert(offsetof(UMiniCraftingIngredientList_C, UberGraphFrame) == 0x0002E8, "Member 'UMiniCraftingIngredientList_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMiniCraftingIngredientList_C, EntriesWrapBox) == 0x0002F0, "Member 'UMiniCraftingIngredientList_C::EntriesWrapBox' has a wrong offset!");
