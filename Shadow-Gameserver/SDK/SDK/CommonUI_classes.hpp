...
public:
	...
	FMulticastInlineDelegateProperty_             OnButtonClicked;                                   // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_70[0x18];                                      // 0x0070(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnButtonDoubleClicked;                             // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSelectionCleared;                                // 0x0098(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bSelectionRequired;                                // 0x00A8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonButtonGroup) == 0x0000C8, "Wrong size on UCommonButtonGroup");
...
static_assert(offsetof(UCommonButtonGroup, OnButtonClicked) == 0x000060, "Member 'UCommonButtonGroup::OnButtonClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonGroup, OnButtonDoubleClicked) == 0x000088, "Member 'UCommonButtonGroup::OnButtonDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonGroup, OnSelectionCleared) == 0x000098, "Member 'UCommonButtonGroup::OnSelectionCleared' has a wrong offset!");
static_assert(offsetof(UCommonButtonGroup, bSelectionRequired) == 0x0000A8, "Member 'UCommonButtonGroup::bSelectionRequired' has a wrong offset!");
...
static_assert(sizeof(UCommonLoadGuard) == 0x000218, "Wrong size on UCommonLoadGuard");
