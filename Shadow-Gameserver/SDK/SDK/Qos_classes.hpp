...
static_assert(sizeof(AQosBeaconClient) == 0x0002E0, "Wrong size on AQosBeaconClient");
...
static_assert(sizeof(AQosBeaconHost) == 0x000250, "Wrong size on AQosBeaconHost");
