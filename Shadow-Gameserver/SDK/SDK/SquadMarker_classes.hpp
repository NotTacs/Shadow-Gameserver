...
static_assert(sizeof(USquadMarker_C) == 0x000580, "Wrong size on USquadMarker_C");
static_assert(offsetof(USquadMarker_C, UberGraphFrame) == 0x000578, "Member 'USquadMarker_C::UberGraphFrame' has a wrong offset!");
