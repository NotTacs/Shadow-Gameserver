...
static_assert(sizeof(SourceEffectMidSideSpreaderPreset_SetSettings) == 0x00000C, "Wrong size on SourceEffectMidSideSpreaderPreset_SetSettings");
...
// 0x0004 (0x0004 - 0x0000)
struct SynthComponentMonoWaveTable_SetLowPassFilterFrequency final
{
public:
...
static_assert(alignof(SynthComponentMonoWaveTable_SetLowPassFilterFrequency) == 0x000004, "Wrong alignment on SynthComponentMonoWaveTable_SetLowPassFilterFrequency");
static_assert(sizeof(SynthComponentMonoWaveTable_SetLowPassFilterFrequency) == 0x000004, "Wrong size on SynthComponentMonoWaveTable_SetLowPassFilterFrequency");
static_assert(offsetof(SynthComponentMonoWaveTable_SetLowPassFilterFrequency, InNewFrequency) == 0x000000, "Member 'SynthComponentMonoWaveTable_SetLowPassFilterFrequency::InNewFrequency' has a wrong offset!");
