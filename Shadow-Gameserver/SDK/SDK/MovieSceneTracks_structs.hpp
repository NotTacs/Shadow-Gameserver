...
static_assert(sizeof(FMovieSceneParameterSectionTemplate) == 0x000060, "Wrong size on FMovieSceneParameterSectionTemplate");
...
static_assert(offsetof(FMovieSceneParameterSectionTemplate, Transforms) == 0x000050, "Member 'FMovieSceneParameterSectionTemplate::Transforms' has a wrong offset!");
...
{
public:
	TSubclassOf<class UCameraShake>               ShakeClass;                                        // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TFieldPath<struct FProperty>                  BoundObjectProperty;                               // 0x0008(0x0020)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneMaterialParameterCollectionTemplate) == 0x000068, "Wrong size on FMovieSceneMaterialParameterCollectionTemplate");
static_assert(offsetof(FMovieSceneMaterialParameterCollectionTemplate, MPC) == 0x000060, "Member 'FMovieSceneMaterialParameterCollectionTemplate::MPC' has a wrong offset!");
...
{
public:
	int32                                         MaterialIndex;                                     // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneComponentMaterialSectionTemplate) == 0x000068, "Wrong size on FMovieSceneComponentMaterialSectionTemplate");
static_assert(offsetof(FMovieSceneComponentMaterialSectionTemplate, MaterialIndex) == 0x000060, "Member 'FMovieSceneComponentMaterialSectionTemplate::MaterialIndex' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneParticleParameterSectionTemplate) == 0x000060, "Wrong size on FMovieSceneParticleParameterSectionTemplate");
