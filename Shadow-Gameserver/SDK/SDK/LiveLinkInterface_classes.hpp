...
static_assert(sizeof(ULiveLinkVirtualSubject) == 0x0000D8, "Wrong size on ULiveLinkVirtualSubject");
...
public:
	...
	class FString                                 ConnectionString;                                  // 0x0060(0x0010)(Edit, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ULiveLinkSourceFactory>     Factory;                                           // 0x0070(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkSourceSettings) == 0x000078, "Wrong size on ULiveLinkSourceSettings");
static_assert(offsetof(ULiveLinkSourceSettings, Mode) == 0x000028, "Member 'ULiveLinkSourceSettings::Mode' has a wrong offset!");
static_assert(offsetof(ULiveLinkSourceSettings, BufferSettings) == 0x00002C, "Member 'ULiveLinkSourceSettings::BufferSettings' has a wrong offset!");
static_assert(offsetof(ULiveLinkSourceSettings, ConnectionString) == 0x000060, "Member 'ULiveLinkSourceSettings::ConnectionString' has a wrong offset!");
static_assert(offsetof(ULiveLinkSourceSettings, Factory) == 0x000070, "Member 'ULiveLinkSourceSettings::Factory' has a wrong offset!");
...
static_assert(sizeof(ULiveLinkCurveRemapSettings) == 0x0000C8, "Wrong size on ULiveLinkCurveRemapSettings");
static_assert(offsetof(ULiveLinkCurveRemapSettings, CurveConversionSettings) == 0x000078, "Member 'ULiveLinkCurveRemapSettings::CurveConversionSettings' has a wrong offset!");
...
static_assert(sizeof(ULiveLinkSubjectSettings) == 0x000058, "Wrong size on ULiveLinkSubjectSettings");
