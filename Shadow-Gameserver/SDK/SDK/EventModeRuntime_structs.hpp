...
{
public:
	EPlaylistUIExtensionSlot                      Slot;                                              // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FEventModeFocusActor) == 0x000040, "Wrong size on FEventModeFocusActor");
...
static_assert(offsetof(FEventModeFocusActor, Offset) == 0x00002C, "Member 'FEventModeFocusActor::Offset' has a wrong offset!");
static_assert(offsetof(FEventModeFocusActor, FOV) == 0x000038, "Member 'FEventModeFocusActor::FOV' has a wrong offset!");
