...
public:
	...
	struct FHitResult                             K2Node_ComponentBoundEvent_ImpactResult;           // 0x0058(0x008C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	float                                         K2Node_Event_Damage_1;                             // 0x00E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_HitInfo_1;                            // 0x0114(0x008C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	EInteractionBeingAttempted                    K2Node_Event_InteractionBeingAttempted;            // 0x01D0(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_2;            // 0x0360(0x0010)(ZeroConstructor, NoDestructor)
	...
	class AAthenaSupplyDropBalloon_C*             K2Node_DynamicCast_AsAthena_Supply_Drop_Balloon;   // 0x0390(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_NotEqual_VectorVector_ReturnValue;        // 0x03C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FRotator                               CallFunc_K2_GetActorRotation_ReturnValue;          // 0x03E4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         CallFunc_Add_FloatFloat_ReturnValue;               // 0x03FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_K2_GetActorRotation_ReturnValue_1;        // 0x0400(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         CallFunc_RandomFloatInRange_ReturnValue;           // 0x041C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_RandomFloatInRange_ReturnValue_1;         // 0x0444(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_MakeVector_ReturnValue_1;                 // 0x0448(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_K2_TeleportTo_ReturnValue;                // 0x0460(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_461[0x3];                                      // 0x0461(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               CallFunc_SelectRotator_ReturnValue;                // 0x0464(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_Has_Been_Initd_Variable;                 // 0x0470(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_K2_TeleportTo_ReturnValue_1;              // 0x0471(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_3;                    // 0x0472(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue_4;                    // 0x0473(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_474[0x4];                                      // 0x0474(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                CallFunc_GetAbilitySystemComponent_ReturnValue_1;  // 0x0478(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAbilitySystemComponent*                CallFunc_GetAbilitySystemComponent_ReturnValue_2;  // 0x0480(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_1; // 0x0488(0x0008)(NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue; // 0x0490(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_HasAuthority_ReturnValue_1;               // 0x0494(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_495[0x3];                                      // 0x0495(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_FMax_ReturnValue;                         // 0x0498(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue_4;        // 0x04AC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AreAnyListenersWithinRange_ReturnValue;   // 0x04B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsPlaying_ReturnValue;                    // 0x04B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_1;          // 0x04BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4BB[0x5];                                      // 0x04BB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                CallFunc_GetAbilitySystemComponent_ReturnValue_3;  // 0x04C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_2; // 0x04C8(0x0008)(NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop) == 0x0004E0, "Wrong size on AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop");
...
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_Damage_1) == 0x0000E4, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_Damage_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_DamageTags_1) == 0x0000E8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_DamageTags_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_Momentum_1) == 0x000108, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_Momentum_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_HitInfo_1) == 0x000114, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_HitInfo_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_InstigatedBy_1) == 0x0001A0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_InstigatedBy_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_DamageCauser_1) == 0x0001A8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_DamageCauser_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_EffectContext_1) == 0x0001B0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_EffectContext_1' has a wrong offset!");
...
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_InteractionBeingAttempted) == 0x0001D0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_InteractionBeingAttempted' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_GetAbilitySystemComponent_ReturnValue) == 0x0001D8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_GetAbilitySystemComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue) == 0x0001E0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue) == 0x0001E8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_Damage) == 0x0001F0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_Damage' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_DamageTags) == 0x0001F8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_DamageTags' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_Momentum) == 0x000218, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_Momentum' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_HitInfo) == 0x000224, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_HitInfo' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_InstigatedBy) == 0x0002B0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_InstigatedBy' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_DamageCauser) == 0x0002B8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_DamageCauser' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_Event_EffectContext) == 0x0002C0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_Event_EffectContext' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_CreateDelegate_OutputDelegate) == 0x0002D8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetComponentToWorld_ReturnValue) == 0x0002F0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetComponentToWorld_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BreakTransform_Location) == 0x000320, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BreakTransform_Rotation) == 0x00032C, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BreakTransform_Scale) == 0x000338, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_SpawnEmitterAtLocation_ReturnValue) == 0x000348, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_SpawnEmitterAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_CreateDelegate_OutputDelegate_1) == 0x000350, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_CreateDelegate_OutputDelegate_2) == 0x000360, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000370, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_SetTimerDelegate_ReturnValue_1) == 0x000378, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_SetTimerDelegate_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetRootComponent_ReturnValue) == 0x000380, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetRootComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue) == 0x000388, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_AttachToComponent_ReturnValue) == 0x000389, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_DynamicCast_AsAthena_Supply_Drop_Balloon) == 0x000390, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_DynamicCast_AsAthena_Supply_Drop_Balloon' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_DynamicCast_bSuccess) == 0x000398, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, K2Node_CreateDelegate_OutputDelegate_3) == 0x00039C, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorLocation_ReturnValue) == 0x0003AC, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue_1) == 0x0003B8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x0003BC, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue_2) == 0x0003C8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_NotEqual_VectorVector_ReturnValue) == 0x0003C9, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_NotEqual_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x0003CC, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x0003D8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorRotation_ReturnValue) == 0x0003E4, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BreakVector_X) == 0x0003F0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BreakVector_Y) == 0x0003F4, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BreakVector_Z) == 0x0003F8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_Add_FloatFloat_ReturnValue) == 0x0003FC, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorRotation_ReturnValue_1) == 0x000400, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorRotation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_MakeVector_ReturnValue) == 0x00040C, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_HasAuthority_ReturnValue) == 0x000418, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_RandomFloatInRange_ReturnValue) == 0x00041C, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorLocation_ReturnValue_3) == 0x000420, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorLocation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_Subtract_VectorVector_ReturnValue) == 0x00042C, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_Normal_ReturnValue) == 0x000438, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_Normal_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_RandomFloatInRange_ReturnValue_1) == 0x000444, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_RandomFloatInRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_MakeVector_ReturnValue_1) == 0x000448, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_MakeVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_Add_VectorVector_ReturnValue) == 0x000454, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_TeleportTo_ReturnValue) == 0x000460, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_TeleportTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_SelectRotator_ReturnValue) == 0x000464, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_SelectRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, Temp_bool_Has_Been_Initd_Variable) == 0x000470, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_TeleportTo_ReturnValue_1) == 0x000471, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_TeleportTo_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue_3) == 0x000472, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue_4) == 0x000473, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_GetAbilitySystemComponent_ReturnValue_1) == 0x000478, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_GetAbilitySystemComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_GetAbilitySystemComponent_ReturnValue_2) == 0x000480, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_GetAbilitySystemComponent_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_1) == 0x000488, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue) == 0x000490, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_HasAuthority_ReturnValue_1) == 0x000494, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_FMax_ReturnValue) == 0x000498, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_SetTimerDelegate_ReturnValue_2) == 0x0004A0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_SetTimerDelegate_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, Temp_bool_IsClosed_Variable) == 0x0004A8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue_5) == 0x0004A9, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_K2_GetActorLocation_ReturnValue_4) == 0x0004AC, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_K2_GetActorLocation_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_AreAnyListenersWithinRange_ReturnValue) == 0x0004B8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_AreAnyListenersWithinRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsPlaying_ReturnValue) == 0x0004B9, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsDedicatedServer_ReturnValue_1) == 0x0004BA, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsDedicatedServer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_GetAbilitySystemComponent_ReturnValue_3) == 0x0004C0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_GetAbilitySystemComponent_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_2) == 0x0004C8, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop, CallFunc_IsValid_ReturnValue_6) == 0x0004D0, "Member 'AthenaSupplyDrop_C_ExecuteUbergraph_AthenaSupplyDrop::CallFunc_IsValid_ReturnValue_6' has a wrong offset!");
...
static_assert(sizeof(AthenaSupplyDrop_C_BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature) == 0x00008C, "Wrong size on AthenaSupplyDrop_C_BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature");
...
public:
	...
	struct FFortItemEntry                         CallFunc_Array_Get_Item;                           // 0x0050(0x0150)()
	...
	class AFortPickup*                            CallFunc_SpawnPickup_ReturnValue;                  // 0x01B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AthenaSupplyDrop_C_SpawnLoot) == 0x0001C8, "Wrong size on AthenaSupplyDrop_C_SpawnLoot");
...
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, CallFunc_Array_Length_ReturnValue) == 0x0001A0, "Member 'AthenaSupplyDrop_C_SpawnLoot::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, K2Node_DynamicCast_AsFort_World_Item_Definition) == 0x0001A8, "Member 'AthenaSupplyDrop_C_SpawnLoot::K2Node_DynamicCast_AsFort_World_Item_Definition' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, K2Node_DynamicCast_bSuccess) == 0x0001B0, "Member 'AthenaSupplyDrop_C_SpawnLoot::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, CallFunc_Less_IntInt_ReturnValue) == 0x0001B1, "Member 'AthenaSupplyDrop_C_SpawnLoot::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, CallFunc_SpawnPickup_ReturnValue) == 0x0001B8, "Member 'AthenaSupplyDrop_C_SpawnLoot::CallFunc_SpawnPickup_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, Temp_bool_Has_Been_Initd_Variable) == 0x0001C0, "Member 'AthenaSupplyDrop_C_SpawnLoot::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_SpawnLoot, Temp_bool_IsClosed_Variable) == 0x0001C1, "Member 'AthenaSupplyDrop_C_SpawnLoot::Temp_bool_IsClosed_Variable' has a wrong offset!");
...
static_assert(offsetof(AthenaSupplyDrop_C_PlayLandingFX, CallFunc_BreakVector_X_1) == 0x000064, "Member 'AthenaSupplyDrop_C_PlayLandingFX::CallFunc_BreakVector_X_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_PlayLandingFX, CallFunc_BreakVector_Y_1) == 0x000068, "Member 'AthenaSupplyDrop_C_PlayLandingFX::CallFunc_BreakVector_Y_1' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_PlayLandingFX, CallFunc_BreakVector_Z_1) == 0x00006C, "Member 'AthenaSupplyDrop_C_PlayLandingFX::CallFunc_BreakVector_Z_1' has a wrong offset!");
...
{
public:
	TArray<class UPrimitiveComponent*>            PrimComponents;                                    // 0x0000(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
...
public:
	...
	bool                                          CallFunc_NotEqual_VectorVector_ReturnValue;        // 0x000B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(AthenaSupplyDrop_C_BlueprintCanInteract, CallFunc_NotEqual_VectorVector_ReturnValue) == 0x00000B, "Member 'AthenaSupplyDrop_C_BlueprintCanInteract::CallFunc_NotEqual_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_BlueprintCanInteract, CallFunc_Not_PreBool_ReturnValue) == 0x00000C, "Member 'AthenaSupplyDrop_C_BlueprintCanInteract::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaSupplyDrop_C_BlueprintCanInteract, CallFunc_BooleanAND_ReturnValue) == 0x00000D, "Member 'AthenaSupplyDrop_C_BlueprintCanInteract::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaSupplyDrop_C_GetLootSpawnLocation, CallFunc_Add_VectorVector_ReturnValue_1) == 0x000040, "Member 'AthenaSupplyDrop_C_GetLootSpawnLocation::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
