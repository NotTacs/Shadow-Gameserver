...
public:
	...
	TMap<class UAnimMontage*, struct FFortMantisMontageData> MontageDataMap;                                    // 0x0110(0x0050)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortMantisPawnComponent) == 0x0001C0, "Wrong size on UFortMantisPawnComponent");
...
{
public:
	class UFortMantisPawnComponent*               MantisPawnComponent;                               // 0x0A30(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UAbilityTask_PlayMontageAndWait*        MontageTask;                                       // 0x0A38(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortAbilityTask_ApplyRootMotionMantisForce* RootMotionTask;                                    // 0x0A40(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortGameplayAbility_Mantis) == 0x000A50, "Wrong size on UFortGameplayAbility_Mantis");
static_assert(offsetof(UFortGameplayAbility_Mantis, MantisPawnComponent) == 0x000A30, "Member 'UFortGameplayAbility_Mantis::MantisPawnComponent' has a wrong offset!");
static_assert(offsetof(UFortGameplayAbility_Mantis, MontageTask) == 0x000A38, "Member 'UFortGameplayAbility_Mantis::MontageTask' has a wrong offset!");
static_assert(offsetof(UFortGameplayAbility_Mantis, RootMotionTask) == 0x000A40, "Member 'UFortGameplayAbility_Mantis::RootMotionTask' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_326[0xA];                                      // 0x0326(0x000A)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_297[0x9];                                      // 0x0297(0x0009)(Fixing Struct Size After Last Property [ Dumper-7 ])
