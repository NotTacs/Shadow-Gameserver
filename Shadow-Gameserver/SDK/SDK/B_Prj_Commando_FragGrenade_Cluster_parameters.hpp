...
static_assert(offsetof(B_Prj_Commando_FragGrenade_Cluster_C_ExecuteUbergraph_B_Prj_Commando_FragGrenade_Cluster, Temp_bool_IsClosed_Variable_1) == 0x000138, "Member 'B_Prj_Commando_FragGrenade_Cluster_C_ExecuteUbergraph_B_Prj_Commando_FragGrenade_Cluster::Temp_bool_IsClosed_Variable_1' has a wrong offset!");
...
static_assert(sizeof(B_Prj_Commando_FragGrenade_Cluster_C_OnStop) == 0x00008C, "Wrong size on B_Prj_Commando_FragGrenade_Cluster_C_OnStop");
