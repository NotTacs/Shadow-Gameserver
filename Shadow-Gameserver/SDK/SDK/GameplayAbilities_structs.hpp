...
public:
	...
	TFieldPath<struct FProperty>                  Attribute;                                         // 0x0010(0x0020)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FAttributeBasedFloat) == 0x0000F8, "Wrong size on FAttributeBasedFloat");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x000094, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_148[0x310];                                    // 0x0148(0x0310)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x000480, "Wrong size on FActiveGameplayEffectsContainer");
...
static_assert(offsetof(FActiveGameplayEffectsContainer, ApplicationImmunityQueryEffects) == 0x000458, "Member 'FActiveGameplayEffectsContainer::ApplicationImmunityQueryEffects' has a wrong offset!");
...
static_assert(sizeof(FGameplayEffectModifierMagnitude) == 0x0001A8, "Wrong size on FGameplayEffectModifierMagnitude");
...
static_assert(offsetof(FGameplayEffectModifierMagnitude, CustomMagnitude) == 0x000120, "Member 'FGameplayEffectModifierMagnitude::CustomMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByCallerMagnitude) == 0x000198, "Member 'FGameplayEffectModifierMagnitude::SetByCallerMagnitude' has a wrong offset!");
...
static_assert(sizeof(FGameplayModifierInfo) == 0x000290, "Wrong size on FGameplayModifierInfo");
...
static_assert(offsetof(FGameplayModifierInfo, ModifierMagnitude) == 0x000060, "Member 'FGameplayModifierInfo::ModifierMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, EvaluationChannelSettings) == 0x000208, "Member 'FGameplayModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, SourceTags) == 0x000210, "Member 'FGameplayModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, TargetTags) == 0x000250, "Member 'FGameplayModifierInfo::TargetTags' has a wrong offset!");
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x000280, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x0001F8, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x000200, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000240, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
...
public:
	...
	TFieldPath<struct FProperty>                  PropertyToEdit;                                    // 0x0008(0x0020)(Edit, EditConst, NativeAccessSpecifierPublic)
