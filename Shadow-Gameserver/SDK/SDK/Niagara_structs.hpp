...
// NumValues: 0x0005
enum class ENiagaraFastPathInputType : uint32
{
	Local                                    = 0,
	RangedSpawn                              = 1,
	RangedUpdate                             = 2,
...
// NumValues: 0x0004
enum class ENiagaraFastPathMode : uint32
{
	ScriptVMOnly                             = 0,
	FastPathOnly                             = 1,
...
{
public:
	class UObject*                                ClassStructOrEnum;                                 // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        UnderlyingType;                                    // 0x0008(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FNiagaraVariableBase) == 0x000008, "Wrong alignment on FNiagaraVariableBase");
static_assert(sizeof(FNiagaraVariableBase) == 0x000018, "Wrong size on FNiagaraVariableBase");
static_assert(offsetof(FNiagaraVariableBase, Name) == 0x000000, "Member 'FNiagaraVariableBase::Name' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableBase, TypeDef) == 0x000008, "Member 'FNiagaraVariableBase::TypeDef' has a wrong offset!");
...
static_assert(offsetof(FNiagaraVariableWithOffset, Offset) == 0x000018, "Member 'FNiagaraVariableWithOffset::Offset' has a wrong offset!");
...
{
public:
	TArray<uint8>                                 VarData;                                           // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FNiagaraVariable) == 0x000008, "Wrong alignment on FNiagaraVariable");
static_assert(sizeof(FNiagaraVariable) == 0x000028, "Wrong size on FNiagaraVariable");
static_assert(offsetof(FNiagaraVariable, VarData) == 0x000018, "Member 'FNiagaraVariable::VarData' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneNiagaraParameterSectionTemplate) == 0x000048, "Wrong size on FMovieSceneNiagaraParameterSectionTemplate");
...
static_assert(sizeof(FNiagaraBoundParameter) == 0x000030, "Wrong size on FNiagaraBoundParameter");
...
static_assert(offsetof(FNiagaraBoundParameter, SrcOffset) == 0x000028, "Member 'FNiagaraBoundParameter::SrcOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraBoundParameter, DestOffset) == 0x00002C, "Member 'FNiagaraBoundParameter::DestOffset' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneNiagaraBoolParameterSectionTemplate) == 0x0000D8, "Wrong size on FMovieSceneNiagaraBoolParameterSectionTemplate");
static_assert(offsetof(FMovieSceneNiagaraBoolParameterSectionTemplate, BoolChannel) == 0x000048, "Member 'FMovieSceneNiagaraBoolParameterSectionTemplate::BoolChannel' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneNiagaraColorParameterSectionTemplate) == 0x0002C8, "Wrong size on FMovieSceneNiagaraColorParameterSectionTemplate");
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, RedChannel) == 0x000048, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::RedChannel' has a wrong offset!");
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, GreenChannel) == 0x0000E8, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::GreenChannel' has a wrong offset!");
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, BlueChannel) == 0x000188, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::BlueChannel' has a wrong offset!");
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, AlphaChannel) == 0x000228, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::AlphaChannel' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneNiagaraFloatParameterSectionTemplate) == 0x0000E8, "Wrong size on FMovieSceneNiagaraFloatParameterSectionTemplate");
static_assert(offsetof(FMovieSceneNiagaraFloatParameterSectionTemplate, FloatChannel) == 0x000048, "Member 'FMovieSceneNiagaraFloatParameterSectionTemplate::FloatChannel' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneNiagaraIntegerParameterSectionTemplate) == 0x0000D8, "Wrong size on FMovieSceneNiagaraIntegerParameterSectionTemplate");
static_assert(offsetof(FMovieSceneNiagaraIntegerParameterSectionTemplate, IntegerChannel) == 0x000048, "Member 'FMovieSceneNiagaraIntegerParameterSectionTemplate::IntegerChannel' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneNiagaraVectorParameterSectionTemplate) == 0x0002D0, "Wrong size on FMovieSceneNiagaraVectorParameterSectionTemplate");
static_assert(offsetof(FMovieSceneNiagaraVectorParameterSectionTemplate, VectorChannels) == 0x000048, "Member 'FMovieSceneNiagaraVectorParameterSectionTemplate::VectorChannels' has a wrong offset!");
static_assert(offsetof(FMovieSceneNiagaraVectorParameterSectionTemplate, ChannelsUsed) == 0x0002C8, "Member 'FMovieSceneNiagaraVectorParameterSectionTemplate::ChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(FNiagaraUserParameterBinding) == 0x000028, "Wrong size on FNiagaraUserParameterBinding");
...
static_assert(sizeof(FNiagaraVariableDataInterfaceBinding) == 0x000028, "Wrong size on FNiagaraVariableDataInterfaceBinding");
...
static_assert(sizeof(FNiagaraVariableAttributeBinding) == 0x000078, "Wrong size on FNiagaraVariableAttributeBinding");
...
static_assert(offsetof(FNiagaraVariableAttributeBinding, DataSetVariable) == 0x000028, "Member 'FNiagaraVariableAttributeBinding::DataSetVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableAttributeBinding, DefaultValueIfNonExistent) == 0x000050, "Member 'FNiagaraVariableAttributeBinding::DefaultValueIfNonExistent' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableInfo) == 0x000048, "Wrong size on FNiagaraVariableInfo");
static_assert(offsetof(FNiagaraVariableInfo, Variable) == 0x000000, "Member 'FNiagaraVariableInfo::Variable' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableInfo, Definition) == 0x000028, "Member 'FNiagaraVariableInfo::Definition' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableInfo, DataInterface) == 0x000040, "Member 'FNiagaraVariableInfo::DataInterface' has a wrong offset!");
...
public:
	...
	TArray<class UNiagaraSystem*>                 SystemSimsToDestroy;                               // 0x0020(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_30[0x8];                                       // 0x0030(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNiagaraSystemUpdateContext) == 0x000008, "Wrong alignment on FNiagaraSystemUpdateContext");
static_assert(sizeof(FNiagaraSystemUpdateContext) == 0x000038, "Wrong size on FNiagaraSystemUpdateContext");
...
static_assert(offsetof(FNiagaraSystemUpdateContext, SystemSimsToDestroy) == 0x000020, "Member 'FNiagaraSystemUpdateContext::SystemSimsToDestroy' has a wrong offset!");
...
public:
	...
	TMap<class FName, class FName>                FunctionSpecifiers;                                // 0x0038(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraFunctionSignature) == 0x000008, "Wrong alignment on FNiagaraFunctionSignature");
static_assert(sizeof(FNiagaraFunctionSignature) == 0x000088, "Wrong size on FNiagaraFunctionSignature");
...
static_assert(offsetof(FNiagaraFunctionSignature, FunctionSpecifiers) == 0x000038, "Member 'FNiagaraFunctionSignature::FunctionSpecifiers' has a wrong offset!");
...
static_assert(sizeof(FNiagaraTypeLayoutInfo) == 0x000040, "Wrong size on FNiagaraTypeLayoutInfo");
...
static_assert(sizeof(FNiagaraVariableLayoutInfo) == 0x000048, "Wrong size on FNiagaraVariableLayoutInfo");
...
static_assert(offsetof(FNiagaraDataSetCompiledData, SimTarget) == 0x000038, "Member 'FNiagaraDataSetCompiledData::SimTarget' has a wrong offset!");
...
static_assert(sizeof(FNiagaraPlatformSet) == 0x000020, "Wrong size on FNiagaraPlatformSet");
...
static_assert(sizeof(FNiagaraEmitterScalabilitySettings) == 0x000028, "Wrong size on FNiagaraEmitterScalabilitySettings");
...
static_assert(offsetof(FNiagaraEmitterScalabilitySettings, SpawnCountScale) == 0x000024, "Member 'FNiagaraEmitterScalabilitySettings::SpawnCountScale' has a wrong offset!");
...
static_assert(sizeof(FNiagaraEmitterScalabilityOverride) == 0x000030, "Wrong size on FNiagaraEmitterScalabilityOverride");
...
static_assert(sizeof(FNiagaraSystemScalabilitySettings) == 0x000030, "Wrong size on FNiagaraSystemScalabilitySettings");
...
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxDistance) == 0x000024, "Member 'FNiagaraSystemScalabilitySettings::MaxDistance' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxInstances) == 0x000028, "Member 'FNiagaraSystemScalabilitySettings::MaxInstances' has a wrong offset!");
static_assert(offsetof(FNiagaraSystemScalabilitySettings, MaxTimeWithoutRender) == 0x00002C, "Member 'FNiagaraSystemScalabilitySettings::MaxTimeWithoutRender' has a wrong offset!");
...
static_assert(sizeof(FNiagaraSystemScalabilityOverride) == 0x000038, "Wrong size on FNiagaraSystemScalabilityOverride");
...
static_assert(sizeof(FNiagaraMeshMaterialOverride) == 0x000030, "Wrong size on FNiagaraMeshMaterialOverride");
...
static_assert(sizeof(FNiagaraVMExecutableData) == 0x000118, "Wrong size on FNiagaraVMExecutableData");
...
static_assert(offsetof(FNiagaraVMExecutableData, ReadDataSets) == 0x0000D0, "Member 'FNiagaraVMExecutableData::ReadDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, WriteDataSets) == 0x0000E0, "Member 'FNiagaraVMExecutableData::WriteDataSets' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, StatScopes) == 0x0000F0, "Member 'FNiagaraVMExecutableData::StatScopes' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, DIParamInfo) == 0x000100, "Member 'FNiagaraVMExecutableData::DIParamInfo' has a wrong offset!");
static_assert(offsetof(FNiagaraVMExecutableData, LastCompileStatus) == 0x000110, "Member 'FNiagaraVMExecutableData::LastCompileStatus' has a wrong offset!");
...
static_assert(sizeof(FNiagaraEmitterCompiledData) == 0x000140, "Wrong size on FNiagaraEmitterCompiledData");
...
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterInterpSpawnStartDTVar) == 0x000038, "Member 'FNiagaraEmitterCompiledData::EmitterInterpSpawnStartDTVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterSpawnGroupVar) == 0x000060, "Member 'FNiagaraEmitterCompiledData::EmitterSpawnGroupVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterAgeVar) == 0x000088, "Member 'FNiagaraEmitterCompiledData::EmitterAgeVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterRandomSeedVar) == 0x0000B0, "Member 'FNiagaraEmitterCompiledData::EmitterRandomSeedVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, EmitterTotalSpawnedParticlesVar) == 0x0000D8, "Member 'FNiagaraEmitterCompiledData::EmitterTotalSpawnedParticlesVar' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterCompiledData, DataSetCompiledData) == 0x000100, "Member 'FNiagaraEmitterCompiledData::DataSetCompiledData' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPathIntInput
// 0x0018 (0x0018 - 0x0000)
struct FNiagaraFastPathIntInput final
{
public:
	ENiagaraFastPathInputType                     Type;                                              // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Local;                                             // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RangeMin;                                          // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RangeMax;                                          // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   UserParameterName;                                 // 0x0010(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraFastPathIntInput) == 0x000004, "Wrong alignment on FNiagaraFastPathIntInput");
static_assert(sizeof(FNiagaraFastPathIntInput) == 0x000018, "Wrong size on FNiagaraFastPathIntInput");
static_assert(offsetof(FNiagaraFastPathIntInput, Type) == 0x000000, "Member 'FNiagaraFastPathIntInput::Type' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathIntInput, Local) == 0x000004, "Member 'FNiagaraFastPathIntInput::Local' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathIntInput, RangeMin) == 0x000008, "Member 'FNiagaraFastPathIntInput::RangeMin' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathIntInput, RangeMax) == 0x00000C, "Member 'FNiagaraFastPathIntInput::RangeMax' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathIntInput, UserParameterName) == 0x000010, "Member 'FNiagaraFastPathIntInput::UserParameterName' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPathFloatInput
// 0x0018 (0x0018 - 0x0000)
struct FNiagaraFastPathFloatInput final
{
public:
	ENiagaraFastPathInputType                     Type;                                              // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FNiagaraFastPathFloatInput) == 0x000004, "Wrong alignment on FNiagaraFastPathFloatInput");
static_assert(sizeof(FNiagaraFastPathFloatInput) == 0x000018, "Wrong size on FNiagaraFastPathFloatInput");
static_assert(offsetof(FNiagaraFastPathFloatInput, Type) == 0x000000, "Member 'FNiagaraFastPathFloatInput::Type' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathFloatInput, Local) == 0x000004, "Member 'FNiagaraFastPathFloatInput::Local' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathFloatInput, RangeMin) == 0x000008, "Member 'FNiagaraFastPathFloatInput::RangeMin' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathFloatInput, RangeMax) == 0x00000C, "Member 'FNiagaraFastPathFloatInput::RangeMax' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathFloatInput, UserParameterName) == 0x000010, "Member 'FNiagaraFastPathFloatInput::UserParameterName' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_SpawnBurstInstantaneous
// 0x0034 (0x0034 - 0x0000)
struct FNiagaraFastPath_Module_SpawnBurstInstantaneous final
{
public:
	...
	int32                                         SpawnGroup;                                        // 0x0030(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraFastPath_Module_SpawnBurstInstantaneous) == 0x000004, "Wrong alignment on FNiagaraFastPath_Module_SpawnBurstInstantaneous");
static_assert(sizeof(FNiagaraFastPath_Module_SpawnBurstInstantaneous) == 0x000034, "Wrong size on FNiagaraFastPath_Module_SpawnBurstInstantaneous");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnBurstInstantaneous, SpawnCount) == 0x000000, "Member 'FNiagaraFastPath_Module_SpawnBurstInstantaneous::SpawnCount' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnBurstInstantaneous, SpawnTime) == 0x000018, "Member 'FNiagaraFastPath_Module_SpawnBurstInstantaneous::SpawnTime' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnBurstInstantaneous, SpawnGroup) == 0x000030, "Member 'FNiagaraFastPath_Module_SpawnBurstInstantaneous::SpawnGroup' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_SpawnPerUnit
// 0x002C (0x002C - 0x0000)
struct FNiagaraFastPath_Module_SpawnPerUnit final
{
public:
	...
	int32                                         SpawnGroup;                                        // 0x0028(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraFastPath_Module_SpawnPerUnit) == 0x000004, "Wrong alignment on FNiagaraFastPath_Module_SpawnPerUnit");
static_assert(sizeof(FNiagaraFastPath_Module_SpawnPerUnit) == 0x00002C, "Wrong size on FNiagaraFastPath_Module_SpawnPerUnit");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnPerUnit, SpawnPerUnit) == 0x000000, "Member 'FNiagaraFastPath_Module_SpawnPerUnit::SpawnPerUnit' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnPerUnit, bUseMovementTolerance) == 0x000018, "Member 'FNiagaraFastPath_Module_SpawnPerUnit::bUseMovementTolerance' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnPerUnit, MovementTolerance) == 0x00001C, "Member 'FNiagaraFastPath_Module_SpawnPerUnit::MovementTolerance' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnPerUnit, bUseMaxMovementThreshold) == 0x000020, "Member 'FNiagaraFastPath_Module_SpawnPerUnit::bUseMaxMovementThreshold' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnPerUnit, MaxMovementThreshold) == 0x000024, "Member 'FNiagaraFastPath_Module_SpawnPerUnit::MaxMovementThreshold' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnPerUnit, SpawnGroup) == 0x000028, "Member 'FNiagaraFastPath_Module_SpawnPerUnit::SpawnGroup' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_SpawnRate
// 0x001C (0x001C - 0x0000)
struct FNiagaraFastPath_Module_SpawnRate final
{
public:
	struct FNiagaraFastPathFloatInput             SpawnRate;                                         // 0x0000(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         SpawnGroup;                                        // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraFastPath_Module_SpawnRate) == 0x000004, "Wrong alignment on FNiagaraFastPath_Module_SpawnRate");
static_assert(sizeof(FNiagaraFastPath_Module_SpawnRate) == 0x00001C, "Wrong size on FNiagaraFastPath_Module_SpawnRate");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnRate, SpawnRate) == 0x000000, "Member 'FNiagaraFastPath_Module_SpawnRate::SpawnRate' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SpawnRate, SpawnGroup) == 0x000018, "Member 'FNiagaraFastPath_Module_SpawnRate::SpawnGroup' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_EmitterLifeCycle
// 0x0010 (0x0010 - 0x0000)
struct FNiagaraFastPath_Module_EmitterLifeCycle final
{
public:
	...
	int32                                         MaxLoopCount;                                      // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FNiagaraFastPath_Module_EmitterLifeCycle) == 0x000004, "Wrong alignment on FNiagaraFastPath_Module_EmitterLifeCycle");
static_assert(sizeof(FNiagaraFastPath_Module_EmitterLifeCycle) == 0x000010, "Wrong size on FNiagaraFastPath_Module_EmitterLifeCycle");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, bAutoComplete) == 0x000000, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::bAutoComplete' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, bCompleteOnInactive) == 0x000001, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::bCompleteOnInactive' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, bDelayFirstLoopOnly) == 0x000002, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::bDelayFirstLoopOnly' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, bDurationRecalcEachLoop) == 0x000003, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::bDurationRecalcEachLoop' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, MaxLoopCount) == 0x000004, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::MaxLoopCount' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, NextLoopDelay) == 0x000008, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::NextLoopDelay' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterLifeCycle, NextLoopDuration) == 0x00000C, "Member 'FNiagaraFastPath_Module_EmitterLifeCycle::NextLoopDuration' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_EmitterScalability
// 0x002C (0x002C - 0x0000)
struct FNiagaraFastPath_Module_EmitterScalability final
{
public:
	...
	ENiagaraExecutionState                        MaxCulledState;                                    // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ENiagaraExecutionState                        MinCulledState;                                    // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FNiagaraFastPath_Module_EmitterScalability) == 0x000004, "Wrong alignment on FNiagaraFastPath_Module_EmitterScalability");
static_assert(sizeof(FNiagaraFastPath_Module_EmitterScalability) == 0x00002C, "Wrong size on FNiagaraFastPath_Module_EmitterScalability");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, bUseEmitterScalability) == 0x000000, "Member 'FNiagaraFastPath_Module_EmitterScalability::bUseEmitterScalability' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, bUseMaxDistance) == 0x000001, "Member 'FNiagaraFastPath_Module_EmitterScalability::bUseMaxDistance' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, MaxCulledState) == 0x000004, "Member 'FNiagaraFastPath_Module_EmitterScalability::MaxCulledState' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, MaxDistance) == 0x000008, "Member 'FNiagaraFastPath_Module_EmitterScalability::MaxDistance' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, bUseMinDistance) == 0x00000C, "Member 'FNiagaraFastPath_Module_EmitterScalability::bUseMinDistance' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, MinCulledState) == 0x000010, "Member 'FNiagaraFastPath_Module_EmitterScalability::MinCulledState' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, MinDistance) == 0x000014, "Member 'FNiagaraFastPath_Module_EmitterScalability::MinDistance' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, bApplySpawnCountScale) == 0x000018, "Member 'FNiagaraFastPath_Module_EmitterScalability::bApplySpawnCountScale' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, SpawnCountScale) == 0x00001C, "Member 'FNiagaraFastPath_Module_EmitterScalability::SpawnCountScale' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, bApplySpawnCountScaleByDistanceFraction) == 0x000020, "Member 'FNiagaraFastPath_Module_EmitterScalability::bApplySpawnCountScaleByDistanceFraction' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, ScaleForMinFraction) == 0x000024, "Member 'FNiagaraFastPath_Module_EmitterScalability::ScaleForMinFraction' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_EmitterScalability, ScaleForMaxFraction) == 0x000028, "Member 'FNiagaraFastPath_Module_EmitterScalability::ScaleForMaxFraction' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_SystemLifeCycle
// 0x0001 (0x0001 - 0x0000)
struct FNiagaraFastPath_Module_SystemLifeCycle final
{
public:
...
static_assert(alignof(FNiagaraFastPath_Module_SystemLifeCycle) == 0x000001, "Wrong alignment on FNiagaraFastPath_Module_SystemLifeCycle");
static_assert(sizeof(FNiagaraFastPath_Module_SystemLifeCycle) == 0x000001, "Wrong size on FNiagaraFastPath_Module_SystemLifeCycle");
static_assert(offsetof(FNiagaraFastPath_Module_SystemLifeCycle, bCompleteOnInactive) == 0x000000, "Member 'FNiagaraFastPath_Module_SystemLifeCycle::bCompleteOnInactive' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPath_Module_SystemScalability
// 0x0010 (0x0010 - 0x0000)
struct FNiagaraFastPath_Module_SystemScalability final
{
public:
	...
	ENiagaraExecutionState                        CulledState;                                       // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FNiagaraFastPath_Module_SystemScalability) == 0x000004, "Wrong alignment on FNiagaraFastPath_Module_SystemScalability");
static_assert(sizeof(FNiagaraFastPath_Module_SystemScalability) == 0x000010, "Wrong size on FNiagaraFastPath_Module_SystemScalability");
static_assert(offsetof(FNiagaraFastPath_Module_SystemScalability, bUseSystemScalability) == 0x000000, "Member 'FNiagaraFastPath_Module_SystemScalability::bUseSystemScalability' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SystemScalability, CulledState) == 0x000004, "Member 'FNiagaraFastPath_Module_SystemScalability::CulledState' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SystemScalability, bEnableVisibilityCulling) == 0x000008, "Member 'FNiagaraFastPath_Module_SystemScalability::bEnableVisibilityCulling' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPath_Module_SystemScalability, VisibilityCullDelay) == 0x00000C, "Member 'FNiagaraFastPath_Module_SystemScalability::VisibilityCullDelay' has a wrong offset!");

// ScriptStruct Niagara.NiagaraFastPathAttributeNames
// 0x0040 (0x0040 - 0x0000)
struct FNiagaraFastPathAttributeNames final
{
public:
	TArray<class FName>                           System;                                            // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           SystemFullNames;                                   // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           Emitter;                                           // 0x0020(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           EmitterFullNames;                                  // 0x0030(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraFastPathAttributeNames) == 0x000008, "Wrong alignment on FNiagaraFastPathAttributeNames");
static_assert(sizeof(FNiagaraFastPathAttributeNames) == 0x000040, "Wrong size on FNiagaraFastPathAttributeNames");
static_assert(offsetof(FNiagaraFastPathAttributeNames, System) == 0x000000, "Member 'FNiagaraFastPathAttributeNames::System' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathAttributeNames, SystemFullNames) == 0x000010, "Member 'FNiagaraFastPathAttributeNames::SystemFullNames' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathAttributeNames, Emitter) == 0x000020, "Member 'FNiagaraFastPathAttributeNames::Emitter' has a wrong offset!");
static_assert(offsetof(FNiagaraFastPathAttributeNames, EmitterFullNames) == 0x000030, "Member 'FNiagaraFastPathAttributeNames::EmitterFullNames' has a wrong offset!");
...
{
public:
	TMap<struct FNiagaraVariable, struct FNiagaraVariable> UserParameterRedirects;                            // 0x0078(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
