...
// Package: S12_Elevator_ToBuffcatRoom
...
class S12_Elevator_ToBuffcatRoom::USequenceDirector_C final : public ULevelSequenceDirector
{
public:
...
public:
	...
	void SequenceEvent__ENTRYPOINTSequenceDirector_1(class AFrontend_EventLevel_Camera_C* Camera_Root_Movement);
	void SequenceEvent__ENTRYPOINTSequenceDirector_2(class AFrontend_EventLevel_Camera_C* Camera_Root_Movement);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BlueprintGeneratedClass S12_Elevator_ToBuffcatRoom.SequenceDirector_C", true, "SequenceDirector_C">();
	}
	static class S12_Elevator_ToBuffcatRoom::USequenceDirector_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<S12_Elevator_ToBuffcatRoom::USequenceDirector_C>();
	}
};
static_assert(alignof(S12_Elevator_ToBuffcatRoom::USequenceDirector_C) == 0x000008, "Wrong alignment on S12_Elevator_ToBuffcatRoom::USequenceDirector_C");
static_assert(sizeof(S12_Elevator_ToBuffcatRoom::USequenceDirector_C) == 0x000038, "Wrong size on S12_Elevator_ToBuffcatRoom::USequenceDirector_C");
static_assert(offsetof(S12_Elevator_ToBuffcatRoom::USequenceDirector_C, UberGraphFrame) == 0x000030, "Member 'S12_Elevator_ToBuffcatRoom::USequenceDirector_C::UberGraphFrame' has a wrong offset!");
