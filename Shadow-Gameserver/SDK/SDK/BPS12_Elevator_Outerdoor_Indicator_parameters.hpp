...
{
public:
	struct FHenchmenData                          Param_HenchmenData;                                // 0x0000(0x00F8)(BlueprintVisible, BlueprintReadOnly, Parm)
	class AFortPlayerController*                  Param_Owner;                                       // 0x00F8(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BPS12_Elevator_Outerdoor_Indicator_C_Set_Henchmen_State, Param_HenchmenData) == 0x000000, "Member 'BPS12_Elevator_Outerdoor_Indicator_C_Set_Henchmen_State::Param_HenchmenData' has a wrong offset!");
static_assert(offsetof(BPS12_Elevator_Outerdoor_Indicator_C_Set_Henchmen_State, Param_Owner) == 0x0000F8, "Member 'BPS12_Elevator_Outerdoor_Indicator_C_Set_Henchmen_State::Param_Owner' has a wrong offset!");
