...
static_assert(sizeof(UGameFrameworkComponent) == 0x0000B0, "Wrong size on UGameFrameworkComponent");
...
static_assert(sizeof(UPlayerStateComponent) == 0x0000B0, "Wrong size on UPlayerStateComponent");
...
static_assert(sizeof(UControllerComponent) == 0x0000B0, "Wrong size on UControllerComponent");
...
static_assert(sizeof(UGameFrameworkComponentManager) == 0x000168, "Wrong size on UGameFrameworkComponentManager");
...
static_assert(sizeof(UGameStateComponent) == 0x0000B0, "Wrong size on UGameStateComponent");
...
static_assert(sizeof(UPawnComponent) == 0x0000B0, "Wrong size on UPawnComponent");
