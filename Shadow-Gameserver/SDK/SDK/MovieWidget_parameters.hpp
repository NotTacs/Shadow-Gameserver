...
public:
	...
	bool                                          CallFunc_HasPlayerForSource_ReturnValue;           // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_SetMediaSource_ReturnValue;               // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_SetMediaSource_ReturnValue_1;             // 0x0081(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(MovieWidget_C_Init) == 0x000008, "Wrong alignment on MovieWidget_C_Init");
static_assert(sizeof(MovieWidget_C_Init) == 0x000088, "Wrong size on MovieWidget_C_Init");
static_assert(offsetof(MovieWidget_C_Init, InMediaPlayer) == 0x000000, "Member 'MovieWidget_C_Init::InMediaPlayer' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, InMediaSource) == 0x000008, "Member 'MovieWidget_C_Init::InMediaSource' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, InMediaSoundWave) == 0x000010, "Member 'MovieWidget_C_Init::InMediaSoundWave' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, AudioTrack) == 0x000018, "Member 'MovieWidget_C_Init::AudioTrack' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, K2Node_MakeStruct_MediaPlayerTrackOptions) == 0x00001C, "Member 'MovieWidget_C_Init::K2Node_MakeStruct_MediaPlayerTrackOptions' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, CallFunc_HasPlayerForSource_ReturnValue) == 0x000038, "Member 'MovieWidget_C_Init::CallFunc_HasPlayerForSource_ReturnValue' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, K2Node_MakeStruct_MediaPlayerOptions) == 0x000040, "Member 'MovieWidget_C_Init::K2Node_MakeStruct_MediaPlayerOptions' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, K2Node_CreateDelegate_OutputDelegate) == 0x000070, "Member 'MovieWidget_C_Init::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, CallFunc_SetMediaSource_ReturnValue) == 0x000080, "Member 'MovieWidget_C_Init::CallFunc_SetMediaSource_ReturnValue' has a wrong offset!");
static_assert(offsetof(MovieWidget_C_Init, CallFunc_SetMediaSource_ReturnValue_1) == 0x000081, "Member 'MovieWidget_C_Init::CallFunc_SetMediaSource_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(MovieWidget_C_SetDelayedContentValues, Temp_byte_Variable_1) == 0x000002, "Member 'MovieWidget_C_SetDelayedContentValues::Temp_byte_Variable_1' has a wrong offset!");
