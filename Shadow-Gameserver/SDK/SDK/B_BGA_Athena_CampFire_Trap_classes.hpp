...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_B_BGA_Athena_CampFire_Trap_C;       // 0x0968(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AB_BGA_Athena_CampFire_Trap_C) == 0x000970, "Wrong size on AB_BGA_Athena_CampFire_Trap_C");
static_assert(offsetof(AB_BGA_Athena_CampFire_Trap_C, UberGraphFrame_B_BGA_Athena_CampFire_Trap_C) == 0x000968, "Member 'AB_BGA_Athena_CampFire_Trap_C::UberGraphFrame_B_BGA_Athena_CampFire_Trap_C' has a wrong offset!");
