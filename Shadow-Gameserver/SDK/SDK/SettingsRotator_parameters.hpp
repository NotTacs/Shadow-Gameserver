...
static_assert(offsetof(SettingsRotator_C_BP_OnOptionSelected, Param_Index) == 0x000000, "Member 'SettingsRotator_C_BP_OnOptionSelected::Param_Index' has a wrong offset!");
