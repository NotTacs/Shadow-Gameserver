...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08254300;
	constexpr int32 AppendString      = 0x02CC9FF0;
	constexpr int32 GNames            = 0x0823BCC0;
	constexpr int32 GWorld            = 0x083426C0;
	constexpr int32 ProcessEvent      = 0x02EBF890;
