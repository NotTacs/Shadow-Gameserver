...
public:
	...
	class UFortWaterInteractionComponent*         FortWaterInteraction;                              // 0x07A0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         RepStartMoving;                                    // 0x07C8(0x0004)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, RepNotify, NoDestructor, AdvancedDisplay, HasGetValueTypeHash)
	struct FGameplayTag                           GC_HitPlayer;                                      // 0x07CC(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           GC_HitWorld;                                       // 0x07D4(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           GC_Throw;                                          // 0x07DC(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           GC_EnterWater;                                     // 0x07E4(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           GC_Pickup;                                         // 0x07EC(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           GC_Death;                                          // 0x07F4(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          PlayDeathGC;                                       // 0x07FC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          RepHideActor;                                      // 0x07FD(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, RepNotify, NoDestructor, AdvancedDisplay)
	bool                                          SetHideActorOnDeath;                               // 0x07FE(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          IsDestructable;                                    // 0x07FF(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	struct FGameplayTag                           GC_GenericDeath;                                   // 0x0800(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, AdvancedDisplay, HasGetValueTypeHash)
	float                                         WorldStopSlop;                                     // 0x0808(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          AttachToWallsAndCeilings;                          // 0x080C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_80D[0x3];                                      // 0x080D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<ELinkToDirection, struct FVector>        Map_DirectionToRelativeVector;                     // 0x0810(0x0050)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, AdvancedDisplay)
	ELinkToDirection                              DirectionToAttach;                                 // 0x0860(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash)
	uint8                                         Pad_861[0x7];                                      // 0x0861(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 EmptyAttachLinkActor;                              // 0x0868(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash)
...
static_assert(offsetof(ABLGA_BattleLab_Parent_C, UberGraphFrame) == 0x000798, "Member 'ABLGA_BattleLab_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortWaterInteraction) == 0x0007A0, "Member 'ABLGA_BattleLab_Parent_C::FortWaterInteraction' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortLinkToActor) == 0x0007A8, "Member 'ABLGA_BattleLab_Parent_C::FortLinkToActor' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortHeldObject) == 0x0007B0, "Member 'ABLGA_BattleLab_Parent_C::FortHeldObject' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortProjectileMovement) == 0x0007B8, "Member 'ABLGA_BattleLab_Parent_C::FortProjectileMovement' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, Capsule) == 0x0007C0, "Member 'ABLGA_BattleLab_Parent_C::Capsule' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, RepStartMoving) == 0x0007C8, "Member 'ABLGA_BattleLab_Parent_C::RepStartMoving' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_HitPlayer) == 0x0007CC, "Member 'ABLGA_BattleLab_Parent_C::GC_HitPlayer' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_HitWorld) == 0x0007D4, "Member 'ABLGA_BattleLab_Parent_C::GC_HitWorld' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_Throw) == 0x0007DC, "Member 'ABLGA_BattleLab_Parent_C::GC_Throw' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_EnterWater) == 0x0007E4, "Member 'ABLGA_BattleLab_Parent_C::GC_EnterWater' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_Pickup) == 0x0007EC, "Member 'ABLGA_BattleLab_Parent_C::GC_Pickup' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_Death) == 0x0007F4, "Member 'ABLGA_BattleLab_Parent_C::GC_Death' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, PlayDeathGC) == 0x0007FC, "Member 'ABLGA_BattleLab_Parent_C::PlayDeathGC' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, RepHideActor) == 0x0007FD, "Member 'ABLGA_BattleLab_Parent_C::RepHideActor' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, SetHideActorOnDeath) == 0x0007FE, "Member 'ABLGA_BattleLab_Parent_C::SetHideActorOnDeath' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, IsDestructable) == 0x0007FF, "Member 'ABLGA_BattleLab_Parent_C::IsDestructable' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_GenericDeath) == 0x000800, "Member 'ABLGA_BattleLab_Parent_C::GC_GenericDeath' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, WorldStopSlop) == 0x000808, "Member 'ABLGA_BattleLab_Parent_C::WorldStopSlop' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, AttachToWallsAndCeilings) == 0x00080C, "Member 'ABLGA_BattleLab_Parent_C::AttachToWallsAndCeilings' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, Map_DirectionToRelativeVector) == 0x000810, "Member 'ABLGA_BattleLab_Parent_C::Map_DirectionToRelativeVector' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, DirectionToAttach) == 0x000860, "Member 'ABLGA_BattleLab_Parent_C::DirectionToAttach' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, EmptyAttachLinkActor) == 0x000868, "Member 'ABLGA_BattleLab_Parent_C::EmptyAttachLinkActor' has a wrong offset!");
