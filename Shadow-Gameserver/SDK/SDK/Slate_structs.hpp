...
public:
	...
	TMap<class FName, struct FCustomizedToolMenuEntry> Entries;                                           // 0x0008(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FCustomizedToolMenuSection> Sections;                                          // 0x0058(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FCustomizedToolMenuNameArray> EntryOrder;                                        // 0x00A8(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
