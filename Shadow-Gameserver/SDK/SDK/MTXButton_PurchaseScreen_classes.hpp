...
static_assert(sizeof(UMTXButton_PurchaseScreen_C) == 0x000BB0, "Wrong size on UMTXButton_PurchaseScreen_C");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, UberGraphFrame) == 0x000B78, "Member 'UMTXButton_PurchaseScreen_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, Hover_Grow) == 0x000B80, "Member 'UMTXButton_PurchaseScreen_C::Hover_Grow' has a wrong offset!");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, Hover_Bounce) == 0x000B88, "Member 'UMTXButton_PurchaseScreen_C::Hover_Bounce' has a wrong offset!");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, Hover) == 0x000B90, "Member 'UMTXButton_PurchaseScreen_C::Hover' has a wrong offset!");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, ButtonBacking) == 0x000B98, "Member 'UMTXButton_PurchaseScreen_C::ButtonBacking' has a wrong offset!");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, Image_Vbucks) == 0x000BA0, "Member 'UMTXButton_PurchaseScreen_C::Image_Vbucks' has a wrong offset!");
static_assert(offsetof(UMTXButton_PurchaseScreen_C, VariableSize) == 0x000BA8, "Member 'UMTXButton_PurchaseScreen_C::VariableSize' has a wrong offset!");
