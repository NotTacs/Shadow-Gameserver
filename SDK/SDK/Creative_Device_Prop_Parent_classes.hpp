...
public:
	...
	class UCreative_Enabled_Component_C*          EnabledComponent;                                  // 0x0BB0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         ActivateOnGamePhase;                               // 0x0BC8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         EnabledIndex;                                      // 0x0BCC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             On_Device_Activated;                               // 0x0BD0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class AController*                            Instigating_Controller;                            // 0x0BE0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bIsVisible;                                        // 0x0BE8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_BE9[0x7];                                      // 0x0BE9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             On_Device_Initialized;                             // 0x0BF0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	float                                         Knob_Health;                                       // 0x0C00(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ACreative_Device_Prop_Parent_C, UberGraphFrame) == 0x000BA0, "Member 'ACreative_Device_Prop_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, VisibleInGameComponent) == 0x000BA8, "Member 'ACreative_Device_Prop_Parent_C::VisibleInGameComponent' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, EnabledComponent) == 0x000BB0, "Member 'ACreative_Device_Prop_Parent_C::EnabledComponent' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, FortMinigameProgress) == 0x000BB8, "Member 'ACreative_Device_Prop_Parent_C::FortMinigameProgress' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, ToyOptionsComponent) == 0x000BC0, "Member 'ACreative_Device_Prop_Parent_C::ToyOptionsComponent' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, ActivateOnGamePhase) == 0x000BC8, "Member 'ACreative_Device_Prop_Parent_C::ActivateOnGamePhase' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, EnabledIndex) == 0x000BCC, "Member 'ACreative_Device_Prop_Parent_C::EnabledIndex' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, On_Device_Activated) == 0x000BD0, "Member 'ACreative_Device_Prop_Parent_C::On_Device_Activated' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, Instigating_Controller) == 0x000BE0, "Member 'ACreative_Device_Prop_Parent_C::Instigating_Controller' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, bIsVisible) == 0x000BE8, "Member 'ACreative_Device_Prop_Parent_C::bIsVisible' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, On_Device_Initialized) == 0x000BF0, "Member 'ACreative_Device_Prop_Parent_C::On_Device_Initialized' has a wrong offset!");
static_assert(offsetof(ACreative_Device_Prop_Parent_C, Knob_Health) == 0x000C00, "Member 'ACreative_Device_Prop_Parent_C::Knob_Health' has a wrong offset!");
