...
static_assert(alignof(BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature) == 0x000004, "Wrong alignment on BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature");
static_assert(sizeof(BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature) == 0x000014, "Wrong size on BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature");
static_assert(offsetof(BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature, Color_A) == 0x000000, "Member 'BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature::Color_A' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature, UseDefaultScheme) == 0x000010, "Member 'BP_FrontendBackPlate_C_RequestLobbyColorChanges__DelegateSignature::UseDefaultScheme' has a wrong offset!");
...
static_assert(offsetof(BP_FrontendBackPlate_C_ExecuteUbergraph_BP_FrontendBackPlate, Temp_bool_Variable_1) == 0x000018, "Member 'BP_FrontendBackPlate_C_ExecuteUbergraph_BP_FrontendBackPlate::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_ExecuteUbergraph_BP_FrontendBackPlate, Temp_bool_Variable_2) == 0x000019, "Member 'BP_FrontendBackPlate_C_ExecuteUbergraph_BP_FrontendBackPlate::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_ExecuteUbergraph_BP_FrontendBackPlate, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x00001C, "Member 'BP_FrontendBackPlate_C_ExecuteUbergraph_BP_FrontendBackPlate::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
...
public:
	...
	TArray<class AActor*>                         CallFunc_GetAllActorsWithTag_OutActors;            // 0x0030(0x0010)(ZeroConstructor, ReferenceParm)
	...
	TArray<class AActor*>                         CallFunc_SortActorArray_OutSortedActors;           // 0x0048(0x0010)(ZeroConstructor, ReferenceParm)
...
static_assert(sizeof(BP_FrontendBackPlate_C_UserConstructionScript) == 0x000080, "Wrong size on BP_FrontendBackPlate_C_UserConstructionScript");
...
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_Conv_StringToName_ReturnValue_1) == 0x000028, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_Conv_StringToName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_GetAllActorsWithTag_OutActors) == 0x000030, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_GetAllActorsWithTag_OutActors' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000040, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_SortActorArray_OutSortedActors) == 0x000048, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_SortActorArray_OutSortedActors' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateUniqueMaterialName_UniqueString_2) == 0x000058, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateUniqueMaterialName_UniqueString_2' has a wrong offset!");
...
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_Conv_StringToName_ReturnValue_2) == 0x000070, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_Conv_StringToName_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue_2) == 0x000078, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, Param_PreBlurMaterial) == 0x000010, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::Param_PreBlurMaterial' has a wrong offset!");
...
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateUniqueMaterialName_UniqueString) == 0x000028, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateUniqueMaterialName_UniqueString' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateUniqueMaterialName_UniqueString_1) == 0x000038, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateUniqueMaterialName_UniqueString_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_Conv_StringToName_ReturnValue) == 0x000048, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_Conv_StringToName_ReturnValue_1) == 0x000050, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_Conv_StringToName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateUniqueMaterialName_UniqueString_2) == 0x000058, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateUniqueMaterialName_UniqueString_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_Conv_StringToName_ReturnValue_2) == 0x000068, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_Conv_StringToName_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000070, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, K2Node_Select_Default) == 0x000078, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, Temp_bool_Variable_2) == 0x000080, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::Temp_bool_Variable_2' has a wrong offset!");
...
static_assert(offsetof(BP_FrontendBackPlate_C_HasUIColorOverride, Param_HasUIColorOverride) == 0x000000, "Member 'BP_FrontendBackPlate_C_HasUIColorOverride::Param_HasUIColorOverride' has a wrong offset!");
...
static_assert(sizeof(BP_FrontendBackPlate_C_CreateUniqueMaterialName) == 0x000088, "Wrong size on BP_FrontendBackPlate_C_CreateUniqueMaterialName");
...
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_BreakVector_X) == 0x00003C, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_BreakVector_Y) == 0x000040, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_BreakVector_Z) == 0x000044, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_Add_FloatFloat_ReturnValue) == 0x000048, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_Add_FloatFloat_ReturnValue_1) == 0x00004C, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_Add_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000050, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_FTrunc_ReturnValue) == 0x000054, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_Conv_IntToString_ReturnValue) == 0x000058, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_Concat_StrStr_ReturnValue) == 0x000068, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_CreateUniqueMaterialName, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000078, "Member 'BP_FrontendBackPlate_C_CreateUniqueMaterialName::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
