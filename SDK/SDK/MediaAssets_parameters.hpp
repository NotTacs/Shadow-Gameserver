...
{
public:
	struct FSoundAttenuationSettings              OutAttenuationSettings;                            // 0x0000(0x0390)(Parm, OutParm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MediaSoundComponent_BP_GetAttenuationSettingsToApply) == 0x000398, "Wrong size on MediaSoundComponent_BP_GetAttenuationSettingsToApply");
...
static_assert(offsetof(MediaSoundComponent_BP_GetAttenuationSettingsToApply, ReturnValue) == 0x000390, "Member 'MediaSoundComponent_BP_GetAttenuationSettingsToApply::ReturnValue' has a wrong offset!");
