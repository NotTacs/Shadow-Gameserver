...
public:
	...
	void SetController(class ABP_TimeSynthController_Base_C* Param_TimeSynthController);
	void QueueTrackStart();
	void QueueTrackStop(bool Play_Outro);
	void CalculateTrackLengthBeats(TArray<struct FTimeSynth_TrackStemData>& Param_Clips, int32* Duration);
