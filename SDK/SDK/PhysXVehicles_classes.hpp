...
public:
	...
	uint8                                         BitPad_40_6 : 2;                                   // 0x0040(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_268[0x708];                                    // 0x0268(0x0708)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000980, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000970, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
...
static_assert(sizeof(AWheeledVehicle) == 0x000288, "Wrong size on AWheeledVehicle");
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x000278, "Member 'AWheeledVehicle::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x000280, "Member 'AWheeledVehicle::VehicleMovement' has a wrong offset!");
