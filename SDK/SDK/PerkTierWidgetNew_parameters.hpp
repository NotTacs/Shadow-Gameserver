...
static_assert(offsetof(PerkTierWidgetNew_C_InitializeSettings, Param_bUseLegacyFixedSizeIcons) == 0x000002, "Member 'PerkTierWidgetNew_C_InitializeSettings::Param_bUseLegacyFixedSizeIcons' has a wrong offset!");
static_assert(offsetof(PerkTierWidgetNew_C_InitializeSettings, Param_IconSize) == 0x000003, "Member 'PerkTierWidgetNew_C_InitializeSettings::Param_IconSize' has a wrong offset!");
...
static_assert(offsetof(PerkTierWidgetNew_C_OnGeneratePerk, PerkWidget) == 0x000098, "Member 'PerkTierWidgetNew_C_OnGeneratePerk::PerkWidget' has a wrong offset!");
...
static_assert(offsetof(PerkTierWidgetNew_C_ExecuteUbergraph_PerkTierWidgetNew, CallFunc_AddChild_ReturnValue_1) == 0x0000C8, "Member 'PerkTierWidgetNew_C_ExecuteUbergraph_PerkTierWidgetNew::CallFunc_AddChild_ReturnValue_1' has a wrong offset!");
