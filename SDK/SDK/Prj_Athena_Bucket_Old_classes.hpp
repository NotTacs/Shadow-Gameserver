...
static_assert(sizeof(APrj_Athena_Bucket_Old_C) == 0x000940, "Wrong size on APrj_Athena_Bucket_Old_C");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, UberGraphFrame_Prj_Athena_Bucket_Old_C) == 0x000908, "Member 'APrj_Athena_Bucket_Old_C::UberGraphFrame_Prj_Athena_Bucket_Old_C' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ItemToSpawn) == 0x000910, "Member 'APrj_Athena_Bucket_Old_C::ItemToSpawn' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, TurnOffFX) == 0x000918, "Member 'APrj_Athena_Bucket_Old_C::TurnOffFX' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, HitMarkerSound) == 0x000920, "Member 'APrj_Athena_Bucket_Old_C::HitMarkerSound' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ThrowIndicator_SoundRef) == 0x000928, "Member 'APrj_Athena_Bucket_Old_C::ThrowIndicator_SoundRef' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, ShouldSpawnItem) == 0x000930, "Member 'APrj_Athena_Bucket_Old_C::ShouldSpawnItem' has a wrong offset!");
static_assert(offsetof(APrj_Athena_Bucket_Old_C, Splash_Sound_0) == 0x000938, "Member 'APrj_Athena_Bucket_Old_C::Splash_Sound_0' has a wrong offset!");
