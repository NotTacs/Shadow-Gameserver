...
static_assert(offsetof(SwimmingAnimLayerInterface_C_SwimmingDiveJumpingLayer, Param_SwimmingDiveJumpingLayer) == 0x000018, "Member 'SwimmingAnimLayerInterface_C_SwimmingDiveJumpingLayer::Param_SwimmingDiveJumpingLayer' has a wrong offset!");
