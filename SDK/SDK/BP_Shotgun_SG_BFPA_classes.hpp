...
static_assert(sizeof(UBP_Shotgun_SG_BFPA_C) == 0x000310, "Wrong size on UBP_Shotgun_SG_BFPA_C");
...
static_assert(offsetof(UBP_Shotgun_SG_BFPA_C, AnimGraphNode_Root) == 0x000278, "Member 'UBP_Shotgun_SG_BFPA_C::AnimGraphNode_Root' has a wrong offset!");
static_assert(offsetof(UBP_Shotgun_SG_BFPA_C, AnimGraphNode_Slot) == 0x0002A8, "Member 'UBP_Shotgun_SG_BFPA_C::AnimGraphNode_Slot' has a wrong offset!");
static_assert(offsetof(UBP_Shotgun_SG_BFPA_C, AnimGraphNode_LocalRefPose) == 0x0002F0, "Member 'UBP_Shotgun_SG_BFPA_C::AnimGraphNode_LocalRefPose' has a wrong offset!");
