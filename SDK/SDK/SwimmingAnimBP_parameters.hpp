...
static_assert(offsetof(SwimmingAnimBP_C_SwimmingDiveJumpingLayer, Param_SwimmingDiveJumpingLayer) == 0x000018, "Member 'SwimmingAnimBP_C_SwimmingDiveJumpingLayer::Param_SwimmingDiveJumpingLayer' has a wrong offset!");
