...
static_assert(sizeof(UReplicationGraph) == 0x0004A0, "Wrong size on UReplicationGraph");
...
static_assert(sizeof(UNetReplicationGraphConnection) == 0x000240, "Wrong size on UNetReplicationGraphConnection");
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x000228, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000218, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x000220, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
