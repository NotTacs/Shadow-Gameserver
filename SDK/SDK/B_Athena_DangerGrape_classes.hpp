...
public:
	...
	struct FScalableFloat                         LeashRadius;                                       // 0x0260(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FName                                   BB_Key_Destination;                                // 0x0280(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                         DistanceFromPlayerToMoveDecoy;                     // 0x0288(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                  T_QuestAbsorbDamage;                               // 0x02A8(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UFortQuestItemDefinition*               Quest_Item;                                        // 0x02C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                   Quest_Backend_Name;                                // 0x02D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AB_Athena_DangerGrape_C) == 0x0002E0, "Wrong size on AB_Athena_DangerGrape_C");
static_assert(offsetof(AB_Athena_DangerGrape_C, UberGraphFrame) == 0x000218, "Member 'AB_Athena_DangerGrape_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, DefaultSceneRoot) == 0x000220, "Member 'AB_Athena_DangerGrape_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, BotData) == 0x000228, "Member 'AB_Athena_DangerGrape_C::BotData' has a wrong offset!");
...
static_assert(offsetof(AB_Athena_DangerGrape_C, BB_Key_Destination) == 0x000280, "Member 'AB_Athena_DangerGrape_C::BB_Key_Destination' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, DistanceFromPlayerToMoveDecoy) == 0x000288, "Member 'AB_Athena_DangerGrape_C::DistanceFromPlayerToMoveDecoy' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, T_QuestAbsorbDamage) == 0x0002A8, "Member 'AB_Athena_DangerGrape_C::T_QuestAbsorbDamage' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, Quest_Item) == 0x0002C8, "Member 'AB_Athena_DangerGrape_C::Quest_Item' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, Quest_Backend_Name) == 0x0002D0, "Member 'AB_Athena_DangerGrape_C::Quest_Backend_Name' has a wrong offset!");
static_assert(offsetof(AB_Athena_DangerGrape_C, Damage) == 0x0002D8, "Member 'AB_Athena_DangerGrape_C::Damage' has a wrong offset!");
