...
{
public:
	bool                                          Param_IsSuper;                                     // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(PunchCard_C_SetSuperStyle, Param_IsSuper) == 0x000000, "Member 'PunchCard_C_SetSuperStyle::Param_IsSuper' has a wrong offset!");
