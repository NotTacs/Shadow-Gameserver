...
public:
	...
	class AActor*                                 HeldObject;                                        // 0x0BD8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortHeldObjectComponent*               HeldObjectComponent;                               // 0x0BF0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 CookOverrideCamera;                                // 0x0BF8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_HeldObject_Throw_Component_C) == 0x000C00, "Wrong size on UGA_HeldObject_Throw_Component_C");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, UberGraphFrame) == 0x000A30, "Member 'UGA_HeldObject_Throw_Component_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, PlayerPawn) == 0x000A38, "Member 'UGA_HeldObject_Throw_Component_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, AbilityKeyPressed) == 0x000A40, "Member 'UGA_HeldObject_Throw_Component_C::AbilityKeyPressed' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, InThrowWindup) == 0x000A41, "Member 'UGA_HeldObject_Throw_Component_C::InThrowWindup' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, AdditionalThrowAngle) == 0x000A44, "Member 'UGA_HeldObject_Throw_Component_C::AdditionalThrowAngle' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, MaxTossPitch) == 0x000A48, "Member 'UGA_HeldObject_Throw_Component_C::MaxTossPitch' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, GrenadeTargetingOriginOffset) == 0x000A4C, "Member 'UGA_HeldObject_Throw_Component_C::GrenadeTargetingOriginOffset' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, GrenadeTargetingOriginOffset_Crouched) == 0x000A58, "Member 'UGA_HeldObject_Throw_Component_C::GrenadeTargetingOriginOffset_Crouched' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, SpawnedProjectile) == 0x000A68, "Member 'UGA_HeldObject_Throw_Component_C::SpawnedProjectile' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, Proj_ThrownProjectile) == 0x000A70, "Member 'UGA_HeldObject_Throw_Component_C::Proj_ThrownProjectile' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, ExplosionEffectContainerSpec) == 0x000A78, "Member 'UGA_HeldObject_Throw_Component_C::ExplosionEffectContainerSpec' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, ProjectileSpeed) == 0x000B30, "Member 'UGA_HeldObject_Throw_Component_C::ProjectileSpeed' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, ProjectileGravityScale) == 0x000B50, "Member 'UGA_HeldObject_Throw_Component_C::ProjectileGravityScale' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, TrajectoryUpdateInterval) == 0x000B70, "Member 'UGA_HeldObject_Throw_Component_C::TrajectoryUpdateInterval' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, EC_DefaultExplosion) == 0x000B74, "Member 'UGA_HeldObject_Throw_Component_C::EC_DefaultExplosion' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, CookMonage) == 0x000B80, "Member 'UGA_HeldObject_Throw_Component_C::CookMonage' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, ThrowMontage) == 0x000B88, "Member 'UGA_HeldObject_Throw_Component_C::ThrowMontage' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, GC_OnThrow) == 0x000B90, "Member 'UGA_HeldObject_Throw_Component_C::GC_OnThrow' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, TrajectoryIndicator) == 0x000B98, "Member 'UGA_HeldObject_Throw_Component_C::TrajectoryIndicator' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, TrajectoryIndicatorClass) == 0x000BA0, "Member 'UGA_HeldObject_Throw_Component_C::TrajectoryIndicatorClass' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, DummyProjectile) == 0x000BA8, "Member 'UGA_HeldObject_Throw_Component_C::DummyProjectile' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, DummyMaxSpeed) == 0x000BB0, "Member 'UGA_HeldObject_Throw_Component_C::DummyMaxSpeed' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, DummyGravity) == 0x000BB4, "Member 'UGA_HeldObject_Throw_Component_C::DummyGravity' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, DummyExtent) == 0x000BB8, "Member 'UGA_HeldObject_Throw_Component_C::DummyExtent' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, DummyTimeStep) == 0x000BBC, "Member 'UGA_HeldObject_Throw_Component_C::DummyTimeStep' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, GE_InWindup) == 0x000BC0, "Member 'UGA_HeldObject_Throw_Component_C::GE_InWindup' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, Handle_GE_InWindup) == 0x000BC8, "Member 'UGA_HeldObject_Throw_Component_C::Handle_GE_InWindup' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, SpawnedOnEquip) == 0x000BD0, "Member 'UGA_HeldObject_Throw_Component_C::SpawnedOnEquip' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, HeldObject) == 0x000BD8, "Member 'UGA_HeldObject_Throw_Component_C::HeldObject' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, ProjectileTrajectorySocketed) == 0x000BE0, "Member 'UGA_HeldObject_Throw_Component_C::ProjectileTrajectorySocketed' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, TrajectoryIndicatorSocketedClass) == 0x000BE8, "Member 'UGA_HeldObject_Throw_Component_C::TrajectoryIndicatorSocketedClass' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, HeldObjectComponent) == 0x000BF0, "Member 'UGA_HeldObject_Throw_Component_C::HeldObjectComponent' has a wrong offset!");
static_assert(offsetof(UGA_HeldObject_Throw_Component_C, CookOverrideCamera) == 0x000BF8, "Member 'UGA_HeldObject_Throw_Component_C::CookOverrideCamera' has a wrong offset!");
