...
public:
	...
	uint8                                         Pad_6E8[0x1E8];                                    // 0x06E8(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaSoundComponent) == 0x0008D0, "Wrong size on UMediaSoundComponent");
...
public:
	...
	bool                                          EnableGenMips;                                     // 0x00E4(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         NumMips;                                           // 0x00E5(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          NewStyleOutput;                                    // 0x00E6(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMediaTextureOutputFormat                     OutputFormat;                                      // 0x00E7(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMediaTexture) == 0x0001A0, "Wrong size on UMediaTexture");
...
static_assert(offsetof(UMediaTexture, AutoClear) == 0x0000D2, "Member 'UMediaTexture::AutoClear' has a wrong offset!");
static_assert(offsetof(UMediaTexture, ClearColor) == 0x0000D4, "Member 'UMediaTexture::ClearColor' has a wrong offset!");
static_assert(offsetof(UMediaTexture, EnableGenMips) == 0x0000E4, "Member 'UMediaTexture::EnableGenMips' has a wrong offset!");
static_assert(offsetof(UMediaTexture, NumMips) == 0x0000E5, "Member 'UMediaTexture::NumMips' has a wrong offset!");
static_assert(offsetof(UMediaTexture, NewStyleOutput) == 0x0000E6, "Member 'UMediaTexture::NewStyleOutput' has a wrong offset!");
static_assert(offsetof(UMediaTexture, OutputFormat) == 0x0000E7, "Member 'UMediaTexture::OutputFormat' has a wrong offset!");
