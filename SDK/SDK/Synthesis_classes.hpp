...
public:
	...
	uint8                                         Pad_6C4[0x69C];                                    // 0x06C4(0x069C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularSynthComponent) == 0x000D60, "Wrong size on UModularSynthComponent");
...
public:
	...
	struct FSourceEffectFilterSettings            Settings;                                          // 0x0088(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USourceEffectFilterPreset) == 0x0000A8, "Wrong size on USourceEffectFilterPreset");
static_assert(offsetof(USourceEffectFilterPreset, Settings) == 0x000088, "Member 'USourceEffectFilterPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectMidSideSpreaderPreset) == 0x000080, "Wrong size on USourceEffectMidSideSpreaderPreset");
static_assert(offsetof(USourceEffectMidSideSpreaderPreset, Settings) == 0x000074, "Member 'USourceEffectMidSideSpreaderPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USourceEffectPannerPreset) == 0x000078, "Wrong size on USourceEffectPannerPreset");
static_assert(offsetof(USourceEffectPannerPreset, Settings) == 0x000070, "Member 'USourceEffectPannerPreset::Settings' has a wrong offset!");
...
public:
	uint8                                         Pad_40[0x48];                                      // 0x0040(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSourceEffectRingModulationSettings    Settings;                                          // 0x0088(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USourceEffectRingModulationPreset) == 0x0000A8, "Wrong size on USourceEffectRingModulationPreset");
static_assert(offsetof(USourceEffectRingModulationPreset, Settings) == 0x000088, "Member 'USourceEffectRingModulationPreset::Settings' has a wrong offset!");
