...
{	
	...
	inline void (*FFree)(void* Array) = decltype(FFree)(uintptr_t(GetModuleHandle(0)) + 0x2b31fa0);
	inline void* (*realloc)(void*, int, int) = decltype(realloc)(uintptr_t(GetModuleHandle(0)) + 0x2b409c0);
	...
	public:
		...
		{
			Data = (ArrayElementType*)realloc(Data, (MaxElements = 1 + NumElements) * sizeof(ArrayElementType), 0);
